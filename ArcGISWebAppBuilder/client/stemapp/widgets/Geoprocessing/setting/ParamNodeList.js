...
function(declare, lang, stringUtil, aspect, on, domClass, domStyle, dom, Evented, Source,
  ...
  return declare([_WidgetBase, Evented], {
    ...
    postCreate: function(){
      ...
      if(this.useResultMapServer === true && this.direction === 'output'){
    ...
    hideOutputInResultMap: function() {
      this.dndObj.getAllNodes().forEach(function(node){
        var item = this.dndObj.getItem(node.id);
        if(item.data.dataType === 'GPFeatureRecordSetLayer' ||
