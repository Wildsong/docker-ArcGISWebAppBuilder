...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, on, Evented, html, lang,
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    templateString: '<div>' +
      ...
      '<div style="margin-top: 15px;" data-dojo-attach-point="clearShapeCbx"' +
      'data-dojo-props="checked:true" data-dojo-type="jimu/dijit/CheckBox"></div>' +
    ...
    reset: function(resetSearchDistance){
      var clearShape = this.clearShapeCbx.getValue();
      if(clearShape){
        this.drawBox.reset();
