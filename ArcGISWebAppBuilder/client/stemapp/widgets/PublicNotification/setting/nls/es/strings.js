...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Permite a los usuarios comprobar la selección final de la capa destinataria seleccionada"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Agregar título de columna (solo para CSV)",
    "zoomScale": "Escala de zoom",
    "reviewCheckboxLabel": "Mostrar el botón Revisar en el widget"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Valores separados por comas (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Configure al menos un origen de búsqueda",
    "noSearchSourceFeaureLayerConfigured": "Configure al menos una capa de entidades como un origen de búsqueda para utilizar herramientas de dibujo de selección"
  },
  "querySourceSetting": {
    "sourceSetting": "Configuración de origen de búsqueda",
    "instruction": "Agregue y configure servicios de geocodificación o capas de entidades como fuentes de búsqueda. Estos orígenes especificados determinan qué se puede buscar dentro del cuadro de búsqueda.",
    ...
    "locatorError": "El localizador debe admitir la ubicación de una sola línea."
  }
});