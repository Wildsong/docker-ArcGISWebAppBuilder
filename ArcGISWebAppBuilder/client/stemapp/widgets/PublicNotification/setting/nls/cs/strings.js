...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Umožní uživatelům zkontrolovat finální výběr na vybrané vrstvě adresátů"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Přidat název sloupce (pouze pro hodnoty oddělené čárkou)",
    "zoomScale": "Měřítko přiblížení",
    "reviewCheckboxLabel": "Zobrazit tlačítko pro kontrolu ve widgetu"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Hodnoty oddělené čárkou (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Nastavte alespoň jeden zdroj vyhledávání",
    "noSearchSourceFeaureLayerConfigured": "Nakonfigurujte alespoň jednu vrstvu prvků jako zdroj vyhledávání pro použití nástrojů pro kreslení pro výběr"
  },
  "querySourceSetting": {
