...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Lehetővé teszi a kiválasztott címzettek rétegen a végleges kijelölések áttekintését"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Adja meg az oszlop címét (csak CSV esetén)",
    "zoomScale": "Zoom-méretarány",
    "reviewCheckboxLabel": "Áttekintés gomb megjelenítése a widgetben"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Vesszővel tagolt értékek (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Konfiguráljon legalább egy keresési forrást",
    "noSearchSourceFeaureLayerConfigured": "A kiválasztó rajzeszköz keresési forrásaként legalább egy vektoros réteget konfiguráljon."
  },
  "querySourceSetting": {
    "sourceSetting": "Keresési forrás beállításai",
    "instruction": "Geokódoló szolgáltatások vagy vektoros rétegek hozzáadása és konfigurálása keresési forrásként. Ezek a megadott források határozzák meg azt, hogy mi kereshető a keresőmezőben.",
    ...
    "locatorWarning": "A geokódoló szolgáltatás ezen verziója nem élvez támogatást. A widget csak a 10.1-es és újabb verziójú geokódoló szolgáltatást támogatja.",
    ...
    "searchFields": "Mezők keresése",
    "displayField": "Mező megjelenítése",
    "exactMatch": "Pontos találat",
    ...
    "panTo": "Mozgatás",
    "zoomToScale": "Nagyítás a méretarányra",
    "locatorError": "A keresőnek támogatnia kell az egyvonalas keresést."
  }
});