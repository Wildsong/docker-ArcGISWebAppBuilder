...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Permite aos utilizadores rever a seleção final na layer de destino selecionada"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Adicionar título de coluna (apenas para CSV)",
    "zoomScale": "Escala de zoom",
    "reviewCheckboxLabel": "Mostrar botão rever no widget"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Valores separados por vírgulas (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourceFeaureLayerConfigured": "Configure pelo menos uma camada de elemento como fonte de pesquisa para usar ferramentas de desenho de seleção"
  },
  "querySourceSetting": {
    "sourceSetting": "Pesquisar definições de origem",
    "instruction": "Adicionar e configurar serviços de geocodificação ou camadas de elementos como fontes de pesquisa. Estas fontes especificadas determinar o que é pesquisável dentro da caixa de pesquisa.",
    ...
    "locatorError": "O localizador deve oferecer suporte para localização de linha única."
  }
});