...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Sallii käyttäjien tarkistaa valitun vastaanottajan karttatason lopullisen valinnan"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Lisää sarakeotsikko (vain CSV-tiedostot)",
    "zoomScale": "Tarkennustaso",
    "reviewCheckboxLabel": "Näytä Tarkista-painike pienoisohjelmassa"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Pilkuin erotetut arvot (CSV-tiedosto)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Määritä vähintään yksi haun lähde",
    "noSearchSourceFeaureLayerConfigured": "Määritä vähintään yksi kohdekarttataso hakulähteeksi valikoiman piirtotyökalujen käyttöä varten"
  },
  "querySourceSetting": {
    "sourceSetting": "Haun lähteen asetukset",
    "instruction": "Lisää ja määritä geokoodauspalveluja haun lähteiksi. Nämä määritetyt lähteet määrittävät, mitä hakuruudussa voi hakea.",
    ...
    "locatorError": "Paikantimen on tuettava yksirivistä paikannusta."
  }
});