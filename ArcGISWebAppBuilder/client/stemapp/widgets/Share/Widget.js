...
define([
  ...
  function(declare, lang, BaseWidget, portalUrlUtils, shareUtils,
    ShareLink, jimuUtils,LoadingIndicator, Message) {
    ...
    return declare([BaseWidget], {
      ...
      startup: function() {
        ...
        shareUtils.getItemShareInfo(this.appConfig.portalUrl).then(lang.hitch(this, function(result) {
          ...
          //reset first focusable node
          jimuUtils.initFirstFocusNode(this.domNode, this.shareLink._linkUrlTextBox.textbox);
          jimuUtils.initLastFocusNode(this.domNode, this.shareLink.MoreOptions);

          this.openAtStartAysn = true;
          if(jimuUtils.isAutoFocusFirstNodeWidget(this)){
            this.shareLink._linkUrlTextBox.textbox.focus();
          }
      ...
      destroy: function () {
        if (this.shareLink && this.shareLink.destroy) {
          this.shareLink.destroy();
        }
        this.inherited(arguments);
      },
      // _hide: function() {
