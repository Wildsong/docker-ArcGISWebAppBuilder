define({
  ...
  "projectionLat": "Zem. šířka/délka",
  "projectionMap": "Kartografické zobrazení mapy",
  "messages": "Zprávy",
  "error": {
    "fetchingCSV": "Došlo k chybě při získávání položek z úložiště CSV: ${0}",
    "fileIssue": "Soubor se nepodařilo zpracovat.",
    "notCSVFile": "V tuto chvíli jsou podporovány pouze textové soubory oddělené čárkami (.csv).",
    "invalidCoord": "Pole umístění jsou neplatná. Zkontrolujte soubor CSV.",
    "tooManyRecords": "Omlouváme se, v tuto chvíli nelze pracovat s více než ${0} záznamy.",
    "CSVNoRecords": "Soubor neobsahuje žádné záznamy.",
    "CSVEmptyFile": "Soubor je prázdný."
  },
  "results": {
