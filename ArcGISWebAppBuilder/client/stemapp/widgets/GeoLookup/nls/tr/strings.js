define({
  ...
  "description": "Görselleştirmek ve harita verilerini eklemek için buraya göz atın veya bir <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'> elektronik tablo </a> sürükleyin.",
  "selectCSV": "CSV Seç",
  ...
  "projectionChoice": "CSV, birim:",
  "projectionLat": "Enlem/Boylam",
  "projectionMap": "Harita Projeksiyonu",
  "messages": "İletiler",
  "error": {
    ...
    "invalidCoord": "Konum alanları geçersiz. Lütfen CSV dosyasını kontrol edin.",
    "tooManyRecords": "Üzgünüz, şu an için ${0} kayıttan fazlası seçilemez.",
    "CSVNoRecords": "Dosyada herhangi bir kayıt yok.",
    "CSVEmptyFile": "Dosyada içerik yok."
  },
  "results": {
