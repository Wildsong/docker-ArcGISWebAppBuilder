define({
  ...
  "showReadyToUseLayers": "Mostrar camadas prontas a usar do ArcGIS Online Living Atlas do mundo.",
  ...
  "findCentroids": "Encontrar Centróides",
  "findCentroidsUsage": "Encontra o centro representativo (centróide) para cada elemento de múltiplos pontos, de linha ou de área de entrada.",
  ...
  "findPointClusters": "Encontrar Clusters de Ponto",
  "findPointClustersUsage": "Esta ferramenta deteta áreas em que os pontos se encontram concentrados e onde são separados por áreas vazias ou dispersas.",
  ...
  "geocodeLocations": "Geocodificar Locais a partir de tabela",
  "geocodeLocationsUsage": "Uma forma conveniente de geocodificar tabelas amplas e ficheiros de endereços em pontos.",
  ...
  "summarizeCenterAndDispersion": "Resumir Centro e Dispersão",
  "summarizeCenterAndDispersionUsage": "Utilize elementos de ponto para calcular o elemento central, centro médio, centro mediano, ou elipse (distribuição).",
  ...
  "joinFeatures": "Ligar Elementos",
  "joinFeaturesUsage": "A ferramenta Ligar Elementos irá transferir atributos de uma camada ou tabela para outra com base em relações espaciais e de atributos. Opcionalmente, podem ser calculadas as estatísticas referentes aos elementos ligados.",
  "includeRouteLayer": "Incluir camadas de rotas",
  "findOutliers": "Encontrar Valores Atípicos",
  "findOutliersUsage": "A ferramenta Encontrar Valores Atípicos permite determinar se existem valores atípicos com relevância estatística no padrão espacial dos seus dados."
});