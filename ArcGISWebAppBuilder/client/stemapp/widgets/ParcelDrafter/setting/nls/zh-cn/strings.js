...
define({
  ...
  "parcelLineLayer": {
    ...
    "startOrRotationSymbolLabel": "开始和旋转点符号",
    "startOrRotationSymbolHintText": "提示：用于显示开始和旋转点符号。",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "选择字段以存储坐标几何信息",
    ...
    "honorSettingRbLabel": "Web 地图弹出窗口设置",
    "customSettingsRbLabel": "自定义设置",
    "display": "显示画面",
    "edit": "编辑",
    "editpageName": "名称",
    "actions": "操作",
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "请为每个坐标几何信息选择不同的字段。"
  }
});