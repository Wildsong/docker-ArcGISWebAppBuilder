...
define({
  ...
  "parcelLineLayer": {
    ...
    "attributeSettingTabLabel": "Paramètres des attributs",
    ...
    "startOrRotationSymbolLabel": "Symbole de point de début et de rotation",
    "startOrRotationSymbolHintText": "Astuce : utilisé pour afficher le symbole de point de début et de rotation.",
    "symbolPickerPreviewText": "Aperçu",
    "selectLineLayerLabel": "Sélectionner une couche de lignes"
  },
  "parcelPolygonLayer": {
    "selectPolygonLayerLabel": "Sélectionner une couche de polygones",
    "selectPolygonLayerHintText": "Astuce : utilisez la couche de polygones de parcelle sélectionnée",
    "selectFieldLegendLabel": "Sélectionner des champs pour le stockage des informations de géométrie des coordonnées",
    ...
    "selectPolygonLayerLabelPopUp": "Sélectionner un couche de polygones",
    "honorSettingRbLabel": "Paramètres de la fenêtre contextuelle de la carte Web",
    "customSettingsRbLabel": "Paramètres personnalisés",
    "display": "Affichage",
    "edit": "Modifier",
    "editpageName": "Nom",
    "actions": "Actions",
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "Sélectionner un champ distinct pour le stockage des informations de géométrie de chaque coordonnée."
  }
});