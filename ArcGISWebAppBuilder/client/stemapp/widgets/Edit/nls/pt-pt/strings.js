define({
  ...
  "layersAreInvisibleOrOutOfScaleRange": "As camadas são invisíveis ou encontram-se fora do intervalo de escala.",
  ...
  "duplicateValueWarning": " Não é possível introduzir um valor duplicado em ${fieldName} de ${tableName}. O valor duplicado é: ${value}"
});