...
define([
  ...
  function(
    ...
    BaseWidgetSetting, CheckBox, Message) {
    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      postCreate: function() {
        ...
        this.showFeatureCount = new CheckBox({
          label: this.nls.featureCountLabel
        }, this.chk_count_node);
        this.showFeatureCount.startup();
        ...
        this.displayCluster = new CheckBox({
          label: this.nls.displayCluster
        }, this.chk_cluster_node);
        this.displayCluster.startup();
      ...
      setConfig: function(config) {
        this.config = config;
        this.showFeatureCount.setValue( config.showFeatureCount);
        ...
        this.displayCluster.setValue(config.displayCluster);
        this.refreshInterval.set('value', config.refreshInterval);
      },
