...
define([
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    baseClass: 'jimu-widget-screening-query-source-setting',
    templateString: template,

    _layerDefinition: null, //to store layer definition object
    _fieldsCheckBox: null, //to store field checkbox object
    _layerId: null, //to store layer Id
    _suggestible: false, //to store flag to identify if layer is suggestible
    _clickSet: false, //to store flag to identify if set source node is clicked
    nls: null, //nls object to retrieve locale based strings
    appConfig: null, //to store app config object
    map: null, //to store map object
    tr: null, //to store current row object
    config: null, //to store config object
    fieldsPopup: null, //to store field popup information object
    ...
    postCreate: function () {
      ...
      this.own(on(this.setSourceBtnClickNode, 'click', lang.hitch(this, this._onSetSourceClick)));
      this.own(on(this.sourceName, 'Blur', lang.hitch(this, this._onSourceNameBlur)));
      this.own(on(this.placeholder, 'Blur', lang.hitch(this, this._onPlaceholderBlur)));
      this.own(on(this.fieldsSelectorNode, 'click', lang.hitch(this, this._onFieldsSelectorClick)));
    ...
    /**
     * This function sets the layer definition object
     * @param {object} definition: layer definition object
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function gets the layer definition object
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function sets the selected tr object for populating layer
     * @param {object} tr: layer grid row object
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function gets the selected tr object for populating layer
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function checks if source url, name and display field present in config
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function shows Validation Error Tip for source name and source url node
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
      * This function destroys all the objects when closing widget
      * @memberOf Screening/setting/QuerySourceSetting
      */
    destroy: function () {
      this.inherited(arguments);
    ...
    /**
     * This function resets the source name textbox when blur event fired
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function resets the placeholder when blur event fired
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function disables all invalid nodes to edit
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function enables all valid nodes to edit
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function sets all the layer information to corresponding fields
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * Gets the layer definition by making esri request to get all the related layer information
    ...
    /**
     * This function shows error message and hides the node if no error occurs
    ...
    /**
     * This function validates and returns the requested url
    ...
    /**
     * This function sets the layer fields to nodes
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function sets the options to fields dropdown
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function gets the search fields alias of selected layer
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function retrieves the search fields of selected layer
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function sets the search fields of selected layer
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function opens the Query Source Chooser on set source click
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function opens the Query Source Chooser
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function creates the Query Source Chooser on set source click
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function creates the Fields selector on Fields Selector click
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function validates and returns selected fields on Search Fields Ok click
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function checks if fields are searchable
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function shows the tips and max suggestions node
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function hides the tips and max suggestions node
     * @memberOf Screening/setting/QuerySourceSetting
     */
    ...
    /**
     * This function shows Validation Error Tip
     * @param {object} _dijit: node object to validate
     * @memberOf Screening/setting/QuerySourceSetting
     */
