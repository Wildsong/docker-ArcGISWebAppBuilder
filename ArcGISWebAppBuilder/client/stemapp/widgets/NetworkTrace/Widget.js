...
define([
  ...
  return declare([BaseWidget], {
    ...
    startup: function () {
      ...
      //handle keydown events to support 508
      this.handleKeyDownEvents();
    },

    handleKeyDownEvents: function () {
      this.own(on(this.btnFlag, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._onFlagButtonClick();
        }
      })));
      this.own(on(this.btnBarrier, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._onBarrierButtonClick();
        }
      })));
      this.own(on(this.btnClear, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._onClearButtonClick();
        }
      })));
      this.own(on(this.btnTrace, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._onTraceButtonClick();
        }
      })));
      this.own(on(this.inputLocTab, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._onInputLocTabClick();
          focusUtil.focus(this.btnFlag);
          focusUtil.focus(this.inputBackClick);
        }
      })));
      this.own(on(this.inputBackClick, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._clearSelectionOnBackBtnClk();
          this._hideFlagsList(true);
          focusUtil.focus(this.inputLocTab);
        }
      })));
      this.own(on(this.barrierLocTab, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._onBarrierLocTabClick();
        }
      })));
      this.own(on(this.barrierBackClick, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._clearSelectionOnBackBtnClk();
          this._hideBarrierList(true);
          focusUtil.focus(this.barrierLocTab);
        }
      })));
      this.own(on(this.skipLocationTab, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._onSkipLocationTabClick();
        }
      })));
      this.own(on(this.skipLocationBackClick, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._clearSelectionOnBackBtnClk();
          this._hideSkipLocationList(true);
          focusUtil.focus(this.skipLocationTab);
        }
      })));
      this.own(on(this.editProjectAttributes, 'keydown', lang.hitch(this, this._onEditProjectAttributesKeyPress)));
      this.own(on(this.projectSaveButton, 'keydown', lang.hitch(this, this._onProjectSaveButtonKeyPress)));
      this.own(on(this.exportToCsvMainScreenButton, 'keydown', lang.hitch(this, this._onExportToLayerButtonKeyPress)));
      this.own(on(this.exportBackNode, 'keydown', lang.hitch(this, this._onExportToCSVFormBackBtnKeyPress)));
      this.own(on(this.editProjectAttributeCancelButtonNode, 'keydown', lang.hitch(this,
        this._hideAttributeInspectorKeyPress)));
      this.own(on(this.editProjectAttributeOkButtonNode, 'keydown', lang.hitch(this, this._onOkButtonKeyPress)));
      this.own(on(this.exportToCsvFileMainButton, 'keydown', lang.hitch(this, this._onExportToCSVFormOkBtnKeyPress)));
      this.own(on(this.removeSkipAllButton, 'keydown', lang.hitch(this, this._onRemoveSkipAllButtonKeyPress)));
    },

    postCreate: function () {
      utils.initLastFocusNode(this.domNode, this.supports508Node);
      this.own(on(this.supports508Node, 'focus', lang.hitch(this, this._lastNodeFocused)));
    },
    ...
    _initializingJimuTabContainer: function () {
      ...
      this.own(on(this._tabContainer, "tabChanged", lang.hitch(this, function (selectedTabTitle) {
        if (selectedTabTitle === this.nls.inputTabTitle) {
          this._setFirstLastNodeOnMainScreen();
          if (!domClass.contains(this.inputTabSummaryTextContainer, "esriCTHidden")) {
            focusUtil.focus(this.inputTabSummaryTextContainer);
          } else {
            focusUtil.focus(this.btnFlag);
          }
        } else {
          this._setFirstLastNodeOnOutputScreen();
        }
      })));
    ...
    _setTheme: function (changedTheme) {
      ...
      if (this.appConfig.theme.name === "DashboardTheme") {
        utils.loadStyleLink(this.baseClass + 'dashboardOverrideCSS',
        ...
        if (this.appConfig.theme.styles && this.appConfig.theme.styles.length > 0) {
          if (this.appConfig.theme.styles[0] === "light" || changedTheme === "light") {
            if (changedTheme && changedTheme !== "light") {
              ...
              utils.loadStyleLink(this.baseClass + 'dashboardOverrideLightCSS',
    ...
    _validateConfigParams: function () {
      ...
      if (this.appConfig.geometryService) {
        ...
        isConfigParam = false;
        this._errorMessage(this.nls.geometryServiceURLNotFoundMSG);
      }
    ...
    _onFlagButtonClick: function () {
      if (!domClass.contains(this.btnFlag, "traceControlDisabledDiv")) {
        if (!this.flagBtnClicked) {
          ...
          domAttr.set(this.btnFlag, "aria-pressed", "true");
          ...
          if (this.barrierBtnClicked) {
            ...
            domAttr.set(this.btnBarrier, "aria-pressed", "false");
          }
    ...
    _onBarrierButtonClick: function () {
      if (!domClass.contains(this.btnBarrier,
        ...
        if (!this.barrierBtnClicked) {
          ...
          domAttr.set(this.btnBarrier, "aria-pressed", "true");
          //Checking the toolbar whether it is initialized or not
          if (this.toolbar === null) {
            this.toolbar = new Draw(this.map);
            this.toolbar.activate(Draw.POINT);
          ...
          if (this.flagBtnClicked) {
            ...
            domAttr.set(this.btnFlag, "aria-pressed", "false");
          }
          this.disableWebMapPopup();
        } else {
    ...
    _showLoadingIcon: function (isShowLoadingIcon) {
      ...
      if (isShowLoadingIcon) {
        ...
        if (typeof(widgetPanel) !== "undefined") {
    ...
    _onMapClick: function (mapPoint) {
      ...
      if (this.flagBtnClicked || this.barrierBtnClicked) {
        ...
        if (this.flagBtnClicked) {
          ...
          domAttr.set(this.btnTrace, "tabindex", 0);
    ...
    _createGraphic: function () {
      ...
      array.forEach(this.config.geoprocessing.inputs, function (input) {
        ...
        if (input.type === "Flag") {
          ...
          this.flagLabel.innerHTML = utils.sanitizeHTML(input.displayName);
          //Set aria-label to flag button
          domAttr.set(this.btnFlag, "aria-label", input.displayName + " " + this.btnFlag.title);
        }
        if (input.type === "Barrier") {
          ...
          this.barrierLabel.innerHTML = utils.sanitizeHTML(input.displayName);
          //Set aria-label to flag button
          domAttr.set(this.btnBarrier, "aria-label", input.displayName + " " + this.btnBarrier.title);
        }
        if (input.type === "Skip") {
    ...
    _createLayerResultPanel: function (output) {
      var layerNameContainer, resultBackContainerDiv, layerName, rightCaretIcon, resultContainer,
      ...
      resultBackContainerDiv = query(".esriCTResultContainerBack", this._widgetTopNode);
      ...
      layerNameContainer = domConstruct.create("div", {
        ...
        "aria-label": output.panelText + " " + output.toolTip,
        "tabindex": "0",
        "role": "button"
      });
      ...
      domAttr.set(checkboxObj.domNode, "tabindex", 2);
      domAttr.set(checkboxObj.domNode, "aria-label", output.panelText + " " + output.toolTip);

      this.own(on(checkboxObj, "change", lang.hitch(this, function (checked) {
        this._updateLayerVisibilty(output.paramName, checked);
      })));

      layerClickableDiv = domConstruct.create("div", {
        "class": "esriCTResultLayerNameParent",
        "title": output.panelText + " " + output.toolTip,
        "aria-label": output.panelText + " " + output.toolTip,
        "tabindex": "2",
        "role": "button"
      }, layerNameContainer);
      ...
      layerName = domConstruct.create("div", {
        ...
        "innerHTML": utils.sanitizeHTML(output.panelText),
      ...
      this.own(on(layerClickableDiv, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._clickOnLayerLabel(output.paramName);
          focusUtil.focus(resultContainerBack);
        } else if (evt.keyCode === keys.ESCAPE) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(layerNameContainer);
        } else if (evt.keyCode === keys.TAB) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(checkboxContainer);
        }
      })));


      this.own(on(checkboxContainer, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ESCAPE) {
          ...
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(layerClickableDiv);
        }
      })));

      this.own(on(layerNameContainer, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          focusUtil.focus(checkboxContainer);
        }
      })));
      ...
      resultContainerBack = domConstruct.create("div", {
        ...
        "resultType": output.paramName,
        "innerHTML": utils.sanitizeHTML("&lt;" + this.nls.backButtonValue),
        "title": "",
        "role": "button",
        "tabindex": 0,
        "aria-label": this.nls.backButtonValue
      }, resultContainerHeader);

      this.own(on(resultContainerBack, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._clickContentOfResultBackButton(output.paramName);
          focusUtil.focus(layerClickableDiv);
        }
      })));
    ...
    _displayFeatureOnLayerClick: function (paramName, layerClickableDiv, resultContainerBack) {
      this._clickEventHandlerArr.push(this.own(on.pausable(layerClickableDiv, "click", lang.hitch(this, function () {
        this._clickOnLayerLabel(paramName);
      }))));

      this._clickEventHandlerArr.push(this.own(on.pausable(resultContainerBack, "click", lang.hitch(this, function () {
        this._clickContentOfResultBackButton(paramName);
      }))));
    },

    _clickContentOfResultBackButton: function (paramName) {
      this._clearSelectionOnBackBtnClk();
      var resultMainDiv = this._getResultContainerObject(paramName);
      domClass.remove(this.saveAndExportParentContainer, "esriCTHidden");
      this._hideOutputFeatureList(resultMainDiv);
    },

    _clickOnLayerLabel: function (paramName) {
    ...
    _clearResults: function (projectId) {
      ...
      this._hideSkipLocationsOnMainScreen(true);
      this._hideOutputPanel();
      ...
      domAttr.set(this.btnTrace, "tabindex", -1);
      ...
      domAttr.set(this.exportToCsvMainScreenButton, "tabindex", -1);
    ...
    _populateResultsToggle: function (selectedGPParam) {
      var skipBtnTitle = "",
        ...
        process, skipedLocation, selectedGraphic, div, resultContainerDataDiv,
      ...
      if (selectedGPParam.bypassDetails.skipable) {
        ...
        //add layer id to skipableLayers, it will be used to show feature action
        if (!this.config.skipableLayers) {
          this.config.skipableLayers = [];
        }
        if (this.config.skipableLayers.indexOf(selectedGPParam.layer.id) < 0) {
          this.config.skipableLayers.push(selectedGPParam.layer.id);
        }
      }
      //add objectIDKey in the layer so that we can fetch oid while executing featureAction
      selectedGPParam.layer.oid = objectIDKey;
      array.forEach(selectedGPParam.results.features, lang.hitch(this,
        function (resultItem) {
          ...
          var btnControlDiv = domConstruct.create("div", {
          ...
          if (selectedGPParam.bypassDetails.skipable) {
            ...
            btnBypassDiv = domConstruct.create("div", {
              ...
              "title": skipBtnTitle,
              "aria-label": skipBtnTitle,
              "role": "button",
              "tabindex": "2"
            }, btnControlDiv);
            //set layerid & Oid in skipButton so that it can be used to execute featureAction
            domAttr.set(btnBypassDiv, "layerid", selectedGPParam.layer.id);
            domAttr.set(btnBypassDiv, "oid", objectIDValue);
          ...
          var zoomToHyperLink = domConstruct.create("div", {
            "class": "resultItemLabel",
            "innerHTML": this.editorXssFilter.sanitize(zoomToText),
            "aria-label": zoomToText,
            "role": "button"
          }, btnControlDiv);

          if (selectedGPParam.bypassDetails.skipable) {
            domAttr.set(btnControlDiv, "tabindex", "0");
            domAttr.set(btnControlDiv, "role", "group");
            domAttr.set(btnControlDiv, "aria-label", zoomToText);
            domAttr.set(zoomToHyperLink, "tabindex", "2");

            this.own(on(zoomToHyperLink, 'keydown', lang.hitch(this, function (evt) {
              if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
                zoomToHyperLink.click();
              } else if (evt.keyCode === keys.ESCAPE) {
                evt.stopPropagation();
                evt.preventDefault();
                focusUtil.focus(btnControlDiv);
              } else if (evt.keyCode === keys.TAB) {
                evt.stopPropagation();
                evt.preventDefault();
                focusUtil.focus(btnBypassDiv);
              }
            })));

            this.own(on(btnBypassDiv, 'keydown', lang.hitch(this, function (evt) {
              if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
                btnBypassDiv.click();
              } else if (evt.keyCode === keys.ESCAPE) {
                evt.stopPropagation();
                ...
                evt.stopPropagation();
                evt.preventDefault();
                focusUtil.focus(zoomToHyperLink);
              }
            })));

          } else {
            domAttr.set(btnControlDiv, "tabindex", "0");
            domAttr.set(btnControlDiv, "role", "button");
            domAttr.set(btnControlDiv, "aria-label", zoomToText);

          }
          this.own(on(btnControlDiv, 'keydown', lang.hitch(this, function (evt) {
            if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
              if (selectedGPParam.bypassDetails.skipable) {
                focusUtil.focus(btnBypassDiv);
              } else {
      ...
      if (selectedGPParam.type === "Result") {
        ...
        //update aria-label of result list item
        domAttr.set(layerName.parentElement.parentElement, "aria-label",
          selectedGPParam.panelText +
          " (" + (resultCount.Count + resultCount.SkipCount) + ")");
        //update aria-label of checkbox element
        domAttr.set(layerName.parentElement.parentElement.firstElementChild.firstElementChild,
          "aria-label", selectedGPParam.panelText +
          " (" + (resultCount.Count + resultCount.SkipCount) + ")");
        //update aria-label of layer name item
        domAttr.set(layerName.parentElement, "aria-label", selectedGPParam.panelText +
          " (" + (resultCount.Count + resultCount.SkipCount) + ")");
        //update the layer name count
        domAttr.set(layerName, "innerHTML", utils.sanitizeHTML(selectedGPParam.panelText +
          " (" + (resultCount.Count + resultCount.SkipCount) + ")"));
        countLabel = this._getResultContainerLabelObject(selectedGPParam);
        //update the count label in result details panel
        domAttr.set(countLabel, "innerHTML", utils.sanitizeHTML(selectedGPParam.panelText +
          " (" + (resultCount.Count + resultCount.SkipCount) + ")"));
      }
      outputLayerObj = {};
    ...
    _convertSummaryExpressionIntoValue: function () {
      ...
      if (summaryExpressionValueResultText && summaryExpressionValueResultText !== "") {
        this.resultLayersInformationContainer.innerHTML = this.editorXssFilter.sanitize(summaryExpressionValueResultText);
        domAttr.set(this.resultLayersInformationContainer, "aria-label",
          utils.stripHTML(summaryExpressionValueResultText));
    ...
    _resetInputOutputTabParentContainer: function () {
      ...
      resetHeightObj.considerSaveAndExport = true;
      resetHeightObj.considerLoadProject = true;
      resetHeightObj.considerInputSummaryText = true;
      this._resetHeight(resetHeightObj);
    },
    ...
    _setResultInfoTemplate: function (item, param, skipBtnTitle,
      ...
      var infoTemplateObj, headerText, infoContent, tableDiv,
        btnBypassDiv, attrRow, attrKey, attrValue, attrTable, layerInstance, field,
      ...
      domConstruct.create("div", {
        "class": "attrHeader",
        "innerHTML": utils.sanitizeHTML(headerText)
      }, infoContent);
      domConstruct.create("div", {
        "class": "attrSeparator"
      }, infoContent);
      ...
      //Check if save to layer is configured and then get the layer instance
      if (param.saveToLayer) {
        layerInstance = this._layerInfosObj.getLayerInfoById(param.saveToLayer).layerObject;
      }
      ...
      for (attrKey in item.attributes) {
        if (item.attributes.hasOwnProperty(attrKey)) {
          ...
          attrNameCol = domConstruct.create("td", {
            "innerHTML": utils.sanitizeHTML(this._getFieldNameColValue(attrKey, outputParameterFields)),
            "class": "attrName"
          }, attrRow);
          //Parse the date and domain values for valid layer
          if (layerInstance) {
            field = layerInstance.getField(attrKey);
            //If domain field is preset, set the code instead of value
            if (field && field.domain && field.domain.type === "codedValue") {
              attrValue = this._getCodedValue(field.domain, attrValue);
            }
            //Format the date value as per the popup configuration
            if (field && field.type === "esriFieldTypeDate") {
              array.some(layerInstance.infoTemplate.info.fieldInfos, lang.hitch(this,
                function (fieldInfo) {
                  if (fieldInfo.fieldName === attrKey) {
                    attrValue = utils.localizeDateByFieldInfo(attrValue, fieldInfo);
                    return true;
                  }
                }));
            }
      ...
      if (param.bypassDetails.skipable) {
        ...
        this._clickEventHandlerArr.push(this.own(on.pausable(btnBypassDiv, "click",
          lang.hitch(this, function () {
            this._onSkipLocationIconClick(resultItem, true, btnBypassDiv);
          }))));
      }
     ...
     /**
     * Get coded domain name based on the coded domain value
     */
    _getCodedValue: function (domain, v) {
    ...
    _addInputLocation: function (graphic, type) {
      ...
      domAttr.set(this.lblInputLoc, "innerHTML", utils.sanitizeHTML(this.nls.lblInputLocTab + " (" + this._flagCount + ")"));
      domAttr.set(this.flagCountLabel, "innerHTML", utils.sanitizeHTML(this.nls.lblInputLocTab + " (" + this._flagCount + ")"));
      domAttr.set(this.inputLocTab, "aria-label", utils.sanitizeHTML(this.nls.lblInputLocTab + " (" + this._flagCount + ")"));

      inputFlagDiv = domConstruct.create("div", {
        "class": "esriCTFlagsBarriersSkipLocationsMainDiv",
        "aria-label": this.nls.lblInputLocation + this._inputFlag,
        "tabindex": "0",
        "role": "button"
      });
      ...
      flagsLabelContainer = domConstruct.create("div", {
        ...
        "innerHTML": utils.sanitizeHTML(this.nls.lblInputLocation + this._inputFlag),
        "aria-label": utils.sanitizeHTML(this.nls.lblInputLocation + this._inputFlag),
        "tabindex": "2",
        "role": "button"
      }, inputFlagDiv);
      inputFlagCloseDiv = domConstruct.create("div", {
        "class": "esriCTInputFlagCloseDiv",
        "aria-label": this.nls.closeButtonLabel + "  " + this.nls.lblInputLocation + this._inputFlag,
        "tabindex": "2",
        "role": "button"
      }, inputFlagDiv);
      domConstruct.place(inputFlagDiv, this.flagLocContent);
      this.own(on(inputFlagDiv, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          focusUtil.focus(flagsLabelContainer);
        }
      })));
      ...
      this._clickEventHandlerArr.push(this.own(on.pausable(inputFlagCloseDiv, "click", lang.hitch(this,
        function (evt) {
          this._removeSelectedLocation(evt);
        }))));

      this.own(on(inputFlagCloseDiv, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._removeSelectedLocation(evt);
        } else if (evt.keyCode === keys.ESCAPE) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(inputFlagDiv);
        } else if (evt.keyCode === keys.TAB) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(flagsLabelContainer);
      ...
      this.own(on(flagsLabelContainer, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          if (this.map && this.map.infoWindow) {
            this.map.infoWindow.hide();
          }
          ...
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(inputFlagCloseDiv);
        } else if (evt.keyCode === keys.ESCAPE) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(inputFlagDiv);
    ...
    _removeSelectedLocation: function (evt) {
      ...
      this._flagCount--;
      domAttr.set(this.lblInputLoc, "innerHTML",
      utils.sanitizeHTML(this.nls.lblInputLocTab + " (" + this._flagCount + ")"));
      domAttr.set(this.flagCountLabel, "innerHTML",
      utils.sanitizeHTML(this.nls.lblInputLocTab + " (" + this._flagCount + ")"));
      domAttr.set(this.inputLocTab, "aria-label",
      utils.sanitizeHTML(this.nls.lblInputLocTab + " (" + this._flagCount + ")"));
      ...
      if (this.flagLocContent.children.length === 0) {
        ...
        focusUtil.focus(
          query(".esriCTFlagsBarriersSkipLocationsMainDiv", this.flagLocContent)[0]);
      }
    },
    ...
    _addBarrierLocation: function (graphic, type) {
      ...
      domAttr.set(this.lblBlockLoc, "innerHTML", utils.sanitizeHTML(this.nls.lblBlockLocTab +
        " (" + this._barrierCount + ")"));
      domAttr.set(this.barrierCountLabel, "innerHTML", utils.sanitizeHTML(this.nls.lblBlockLocTab +
        " (" + this._barrierCount + ")"));
      domAttr.set(this.barrierLocTab, "aria-label", utils.sanitizeHTML(this.nls.lblBlockLocTab +
        " (" + this._barrierCount + ")"));
      blockDiv = domConstruct.create("div", {
        "class": "esriCTFlagsBarriersSkipLocationsMainDiv",
        "aria-label": this.nls.lblBlockLocation + this._inputBlock,
        "tabindex": "0",
        "role": "button"
      });
      ...
      blockLabelContainer = domConstruct.create("div", {
        "class": "esriCTFlagsBarriersSkipLocationsLabelContainer",
        "innerHTML": utils.sanitizeHTML(this.nls.lblBlockLocation + this._inputBlock),
        "aria-label": utils.sanitizeHTML(this.nls.lblBlockLocation + this._inputBlock),
        "tabindex": "2",
        "role": "button"
      }, blockDiv);
      blockCloseDiv = domConstruct.create("div", {
        "class": "esriCTInputFlagCloseDiv",
        "aria-label": this.nls.closeButtonLabel + "  " + this.nls.lblBlockLocation + this._inputBlock,
        "tabindex": "2",
        "role": "button"
      }, blockDiv);
      domConstruct.place(blockDiv, this.barrierLocContent);

      this.own(on(blockDiv, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          focusUtil.focus(blockLabelContainer);
        }
      })));

      this._clickEventHandlerArr.push(this.own(on.pausable(blockCloseDiv, "click",
        lang.hitch(this, this._onBlockCloseDivClicked))));
      this.own(on(blockCloseDiv, "keydown", lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          this._onBlockCloseDivClicked(evt);
        } else if (evt.keyCode === keys.ESCAPE) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(blockDiv);
        } else if (evt.keyCode === keys.TAB) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(blockLabelContainer);
      ...
      this.own(on(blockLabelContainer, "keydown", lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          if (this.map && this.map.infoWindow) {
            this.map.infoWindow.hide();
          }
    ...
    _onBlockCloseDivClicked: function (evt) {
      ...
      this._onClickCloseRemoveGraphics(evt);
      this._barrierCount--;
      domAttr.set(this.lblBlockLoc, "innerHTML",
      utils.sanitizeHTML(this.nls.lblBlockLocTab + " (" + this._barrierCount + ")"));
      domAttr.set(this.barrierCountLabel, "innerHTML",
      utils.sanitizeHTML(this.nls.lblBlockLocTab + " (" + this._barrierCount + ")"));
      domAttr.set(this.barrierLocTab, "aria-label",
      utils.sanitizeHTML(this.nls.lblBlockLocTab + " (" + this._barrierCount + ")"));
      if (this.barrierLocContent.children.length === 0) {
        ...
        focusUtil.focus(
          query(".esriCTFlagsBarriersSkipLocationsMainDiv", this.barrierLocContent)[0]);
      }
    },
    ...
    _onRemoveSkipAllButtonKeyPress: function (evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
        this._onRemoveSkipAllButtonClick();
      }
    },
    ...
    _addSkipLocation: function (type, skippedFeatureUniqueId) {
      ...
      domAttr.set(this.lblSkipLoc, "innerHTML", utils.sanitizeHTML(this.nls.lblSkipLocTab +
        " (" + this._skipLocationCount + ")"));
      domAttr.set(this.skipLocationCountLabel, "innerHTML", utils.sanitizeHTML(this.nls.lblSkipLocTab +
        " (" + this._skipLocationCount + ")"));
      domAttr.set(this.skipLocationTab, "aria-label", utils.sanitizeHTML(this.nls.lblSkipLocTab +
        " (" + this._skipLocationCount + ")"));
      skipLocationDiv = domConstruct.create("div", {
        "class": "esriCTFlagsBarriersSkipLocationsMainDiv",
        "aria-label": this.nls.lblSkipLocation + this._inputSkip,
        "tabindex": "0",
        "role": "button"
      });
      ...
      skipLocationsLabelContainer = domConstruct.create("div", {
        "class": "esriCTFlagsBarriersSkipLocationsLabelContainer",
        "innerHTML": utils.sanitizeHTML(this.nls.lblSkipLocation + this._inputSkip),
        "aria-label": utils.sanitizeHTML(this.nls.lblSkipLocation + this._inputSkip),
        "tabindex": "2",
        "role": "button"
      }, skipLocationDiv);
      skipLocationCloseDiv = domConstruct.create("div", {
        "class": "esriCTRemoveSkipLocationIcon",
        "aria-label": utils.sanitizeHTML(this.nls.closeButtonLabel + "  " + this.nls.lblSkipLocation + this._inputSkip),
        "tabindex": "2",
        "role": "button"
      }, skipLocationDiv);
      domConstruct.place(skipLocationDiv, this.skipLocationsListContainer);
      this.own(on(skipLocationDiv, "keydown", lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          focusUtil.focus(skipLocationsLabelContainer);
        }
      })));
      ...
      this.own(on(skipLocationCloseDiv, "keydown", lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          //skip location which wanted to be delete is selected then
          //remove its highlighting and clear graphics layer
          if (domClass.contains(evt.currentTarget.parentNode, "esriCTHighlightedGraphic")) {
          ...
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(skipLocationDiv);
        } else if (evt.keyCode === keys.TAB) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(skipLocationsLabelContainer);
      ...
      this.own(on(skipLocationsLabelContainer, "keydown", lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          if (this.map && this.map.infoWindow) {
            this.map.infoWindow.hide();
          }
          ...
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(skipLocationCloseDiv);
        } else if (evt.keyCode === keys.ESCAPE) {
          evt.stopPropagation();
          evt.preventDefault();
          focusUtil.focus(skipLocationDiv);
    ...
    _updateSkipLocation: function () {
      this._skipLocationCount--;
      domAttr.set(this.lblSkipLoc, "innerHTML",
      utils.sanitizeHTML(this.nls.lblSkipLocTab + " (" + this._skipLocationCount + ")"));
      domAttr.set(this.skipLocationCountLabel, "innerHTML",
      utils.sanitizeHTML(this.nls.lblSkipLocTab + " (" + this._skipLocationCount + ")"));
      domAttr.set(this.skipLocationTab, "aria-label",
      utils.sanitizeHTML(this.nls.lblSkipLocTab + " (" + this._skipLocationCount + ")"));
      if (this.skipLocationsListContainer.children.length === 0) {
        //When removing skip location from features list, it is not required to display main screen
        //and not required to set first last node on main screen. so if input tab is opened and
        //this function is called it means user is removing skip location from skipped location tab
        //in this case set the flag to true or else it will be false
        var displayMainScreen = false;
        if (this._tabContainer) {
          if (this._tabContainer.viewStack.getSelectedLabel() === this.nls.inputTabTitle) {
            displayMainScreen = true;
          }
        }
        this._hideSkipLocationList(displayMainScreen);
        this._hideSkipLocationsOnMainScreen(displayMainScreen);
      } else {
        focusUtil.focus(
          query(".esriCTFlagsBarriersSkipLocationsMainDiv", this.skipLocationsListContainer)[0]);
      }
    },
    ...
    _addSkipAllLocationButton: function (resultContainer) {
      ...
      var skipAllButton = domConstruct.create("div", {
        "innerHTML": utils.sanitizeHTML(this.nls.skipAllLocationButtonLabel),
        "aria-label": utils.sanitizeHTML(this.nls.skipAllLocationButtonLabel),
        "role": "button",
        "tabindex": "0",
      ...
      this._clickEventHandlerArr.push(this.own(on.pausable(skipAllButton, "click", lang.hitch(this, function (evt) {
        //on skip all button click show confirmation dialog, and on yes clicked skip all the locations
        var skipLocationsArr = query(".resultItemButtonSkipIcon", evt.currentTarget.parentNode.parentNode);
        var confirmSkipAllPopup = new Popup({
          titleLabel: this.nls.skipAllLocationButtonLabel,
          width: 420,
          maxHeight: 200,
          autoHeight: true,
          content: this.nls.confirmSkipAllLocationsMessage,
          ...
          "buttons": [{
            ...
            onClick: lang.hitch(this, function () {
              ...
              array.forEach(skipLocationsArr, lang.hitch(this, function (skipLocation) {
                //skip only those locations which are not already skipped
                if (!domClass.contains(skipLocation, "alreadySkippedLocation")) {
                  skipLocation.click();
                }
              }));
              this._skipAllLocationButtonClicked = false;
              confirmSkipAllPopup.close();
            })
          }, {
            label: this.nls.no,
      ...
      this.own(on(skipAllButton, 'keydown', lang.hitch(this, function (evt) {
        if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
          skipAllButton.click();
        }
      })));
    ...
    _fetchUrlParameters: function () {
      var url, urlObject, isProjectFound, selectOption, loadDropdownOptions, wkid, defArray;
      defArray = [];
      ...
      if (urlObject.query) {
        if (urlObject.query.hasOwnProperty("project")) {
          ...
          if (urlObject.query.hasOwnProperty("wkid")) {
            wkid = urlObject.query.wkid;
            wkid = parseInt(wkid, 10);
            //if url wkid is same as map spatial ref set it to null
            //so that projection operation will be avoided
            if (this.map.spatialReference && this.map.spatialReference.wkid &&
              this.map.spatialReference.wkid === wkid) {
              wkid = null;
            }
          }
          //place flag and barier inputs on map if available
          if (urlObject.query.hasOwnProperty("flags")) {
            defArray.push(this._placeUrlInputs(urlObject.query.flags, "flags", wkid));
          }
          if (urlObject.query.hasOwnProperty("barriers")) {
            defArray.push(this._placeUrlInputs(urlObject.query.barriers, "barriers", wkid));
          }
          //after all the points are placed on map process for run trace
          var defList = new DeferredList(defArray);
          defList.then(lang.hitch(this, function () {
     ...
     */
    _placeUrlInputs: function (inputString, type, wkid) {
      ...
      if (placeInputsOnMap) {
        ...
        //if wkid is valid project points in to map spatial ref
        if (wkid) {
          var geometryArray = [];
          //create all geometries array for projection
          array.forEach(inputsArr, function (input) {
            geometryArray.push(new Point(input[0], input[1], new SpatialReference(parseInt(wkid, 10))));
          });
          //set project params
          var projectParams = new ProjectParameters();
          projectParams.geometries = geometryArray;
          projectParams.outSR = this.map.spatialReference;
          //project the points in to map spatial ref
          this.geometryService.project(projectParams, lang.hitch(this, function (projectedGeometries) {
            var projectedInputsArr = [];
            array.forEach(projectedGeometries, function (pGeometry) {
              projectedInputsArr.push([pGeometry.x, pGeometry.y]);
            });
            //after projection add those inpust on map and resolve the deferred
            this._addInputsOnMap(projectedInputsArr, type);
            def.resolve(true);
          }));
        } else {
          setTimeout(lang.hitch(this, function () {
    ...
    _addLoadProjectDropdown: function () {
      this._loadProjectDropdown = new Select({
        ...
        "aria-label": this.nls.selectProject
      });
        ...
        on.pausable(this._loadProjectDropdown, "change",
          lang.hitch(this, function (evt) {
            ...
            if (evt !== "newproject") {
              ...
              domAttr.set(this.editProjectAttributes, "tabindex", -1);
    ...
    _loadExistingProject: function (projectId) {
      ...
      domAttr.set(this.editProjectAttributes, "tabindex", 0);
      this._clearResults(true);
    ...
    _resetHeight: function (resetHeightObj) {
      var node, considerSaveAndExport, considerLoadProject, considerSkipAll, skipAllButton,
        resetFlagBarrierSkipLocationMainPage, resetHeightOutputPanel, considerInputSummaryText;
      ...
      considerInputSummaryText = resetHeightObj.considerInputSummaryText;
      ...
      if (considerInputSummaryText !== '' &&
        considerInputSummaryText !== null &&
        considerInputSummaryText !== undefined) {
        var inputTabSummaryTextContainerHeight = domStyle.getComputedStyle(this.inputTabSummaryTextContainer).height;
        inputTabSummaryTextContainerHeight = parseFloat(inputTabSummaryTextContainerHeight);
        if (inputTabSummaryTextContainerHeight.toString() !== "NaN") {
          newHeight = newHeight - inputTabSummaryTextContainerHeight;
        }
      }
      domStyle.set(node, "height", newHeight + "px");
    },
    ...
    _createNewProjectPopup: function () {
      ...
      projectNameLabel = domConstruct.create("div", {
        innerHTML: utils.sanitizeHTML(this.nls.projectNameLabel),
    ...
    _onProjectSaveButtonKeyPress: function (evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
        this._onProjectSaveButtonClick();
      }
    },
    ...
    _onEditProjectAttributesKeyPress: function (evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
        this._showLoadingIcon(true);
        this._isProjectFiltered();
      }
    ...
    _onOkButtonKeyPress: function (evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
    ...
    _hideAttributeInspectorKeyPress: function (evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
        this._clearAttributeInspectorData();
        domClass.add(this.editAttributeContainer, "esriCTHidden");
        this._displayEntireMainScreen();
    ...
    _add508SupportToATI: function () {
      var firstEditableNode, attTable;
        ...
        if (attTable) {
          array.forEach(attTable, lang.hitch(this, function (row) {
            ...
            if (rowInfo) {
              ...
              if (!firstEditableNode && !rowInfo[0].disabled) {
                firstEditableNode = rowInfo[0].focusNode;
              }
              //if row has time dijit it will hace two childs
      ...
      //set first editable node in attribute inspector
      if (!firstEditableNode) {
        firstEditableNode = this.editProjectAttributeOkButtonNode;
      }
      //set first editable node as widgets first focus node of the widget
      this._setWidgetFirstFocusNode(firstEditableNode);
      //set cancel button as last focus node of the widget
      this._currentLastNode = this.editProjectAttributeCancelButtonNode;
      focusUtil.focus(firstEditableNode);
    },
    ...
    _createFieldInfos: function () {
      ...
      array.forEach(allFieldsInfo, lang.hitch(this, function (field) {
        ...
        //consider name field irrespecitve of its visibility, so that user can add project name
        if ((field.visible &&
          ...
          field.fieldName === this._polygonLayerFields.name) {
    ...
    _onSkipLocationIconClick: function (resultItem, manual, btnBypassDiv) {
      var skippedFeatureUniqueId, skipLocationInfo, undoSkip;
      if (this._skipLocationGraphicsLayer !== null) {
        if (btnBypassDiv) {
          //Based on class applied to skip button identify if location is skipped or not
          //Also toggle class to show skipped or not and raise the flag to know the action
          //if it is skipping or unskiping the location
          if (!domClass.contains(btnBypassDiv, "alreadySkippedLocation")) {
            domClass.add(btnBypassDiv, "alreadySkippedLocation");
            undoSkip = false;
          } else {
            domClass.remove(btnBypassDiv, "alreadySkippedLocation");
            undoSkip = true;
          }
        }
        ...
        if (skipLocationInfo.isFeatureSkipped) {
          //unskip the selected location
          if (undoSkip) {
            var skippedRow = query("[skippedFeatureUniqueId='" + skipLocationInfo.skippedFeatureUniqueId + "']",
              this.skipLocationsListContainer);
            var removeskipLocationButton = query(".esriCTRemoveSkipLocationIcon", skippedRow[0])[0];
            removeskipLocationButton.click();
          } else {
            if (btnBypassDiv) {
              domAttr.set(btnBypassDiv, "skippedFeatureUniqueId",
                skipLocationInfo.skippedFeatureUniqueId);
    ...
    _addFeaturesDeferred: function (paramName) {
      var selectedProjectGuid, graphicsArr, graphicsLayer, featureLayer, deferred,
        featureLayerFieldsObj, gp_results_fields;
      ...
      array.forEach(featureLayer.fields, lang.hitch(this, function (field) {
        featureLayerFieldsObj[field.name.toLowerCase()] = {
          'type': field.type,
          'name': field.name
        };
      }));

      var out_param = this._gpServiceOutputParameterObj[paramName];
      for (var prop1 in out_param) {
        gp_results_fields[prop1.toLowerCase()] = {
          'type': out_param[prop1],
          'name': prop1
        };
      }
      ...
      array.forEach(graphicsLayer.graphics, lang.hitch(this, function (graphic) {
        ...
        for (var attribute in graphic.attributes) {
          ...
          var gp_matching_key, gp_matching_Type, layer_matching_key, layer_field_type;
          //gp_matching_key = Object.keys(out_param).find(key => key.toLowerCase() === attribute.toLowerCase());
          //layer_matching_key = Object.keys(featureLayerFieldsObj).find(key => key.toLowerCase() === attribute.toLowerCase());
          gp_matching_key = null;
          gp_matching_Type = null;
          layer_matching_key = null;
          layer_field_type = null;

          if (gp_results_fields.hasOwnProperty(attribute.toLowerCase())) {
            gp_matching_key = gp_results_fields[attribute.toLowerCase()]['name'];
            gp_matching_Type = gp_results_fields[attribute.toLowerCase()]['type'];
          }

          if (featureLayerFieldsObj.hasOwnProperty(attribute.toLowerCase())) {
            layer_matching_key = featureLayerFieldsObj[attribute.toLowerCase()]['name'];
            layer_field_type = featureLayerFieldsObj[attribute.toLowerCase()]['type'];
          }

          if (gp_matching_key &&
            layer_matching_key &&
            gp_matching_Type === layer_field_type &&
            graphic.attributes[attribute] && graphic.attributes[attribute].toString() !== '') {
            attr[layer_matching_key] = graphic.attributes[attribute];
          }
        }
    ...
    _showGPResults: function (result) {
      ...
      if (this.resultsCnt === this.config.geoprocessing.outputs.length) {
        ...
        domAttr.set(this.exportToCsvMainScreenButton, "tabindex", 0);
        this._showLoadingIcon(false);
    ...
    _createEditProjectPopup: function () {
      ...
      var saveChangesMsgText = esriLang.substitute({
        loadProjectDropdownlabel: loadProjectDropdownlabel
      }, this.nls.saveChangesMsg);
      saveChangesMsg = domConstruct.create("div", {
        "innerHTML": utils.sanitizeHTML(saveChangesMsgText),
        "aria-label": utils.stripHTML(saveChangesMsgText),
        "style": { "margin": "2px" },
        "role": "presentation",
        "tabindex": 0
    ...
    _onExportToCSVFormOkBtnKeyPress: function (evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
        this._onExportToCSVFormOkBtnClick();
      }
    },
    ...
    _onExportToCSVFormBackBtnKeyPress: function (evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
        this._onExportToCSVFormBackBtnClick();
      }
    },
    ...
    _onExportToLayerButtonClick: function () {
      if (!domClass.contains(this.exportToCsvMainScreenButton, "jimu-state-disabled")) {
        ...
        domAttr.set(this.exportToCsvFileMainButton, "tabindex", 0);
        this._clearSelectionOnBackBtnClk();
    ...
    _onExportToLayerButtonKeyPress: function (evt) {
      if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
        this._onExportToLayerButtonClick();
      }
      focusUtil.focus(this.exportBackNode);
    },
    ...
    _displayExportToCSVParamList: function () {
      ...
      //set First focus node on export to csv screen
      focusUtil.focus(this.exportBackNode);
      this._setFirstLastNodeOnExportToCSVParamList();
    },
    ...
    _createExportToCSVRow: function (exportToCSVObj, isSelectAll) {
      ...
      if (isSelectAll) {
        ...
        if (!canDownloadMultipleFiles) {
          ...
          domAttr.set(this.exportToCsvFileMainButton, "tabindex", -1);
        }
      } else {
    ...
    _hideSkipLocationsOnMainScreen: function (updateFirstLastNode) {
      domClass.add(this.skipLocationTab, "esriCTHidden");
      if (updateFirstLastNode) {
        this._setFirstLastNodeOnMainScreen();
      }
      this._disableProjectSaveButton();
    },
    ...
    _setWidgetFirstFocusNode: function (firstNode) {
      if (this._firstNodeEventHandler) {
        this._firstNodeEventHandler.remove();
      }
      this._firstNodeEventHandler = this.own(on(firstNode, 'keydown', lang.hitch(this, '_firstNodeKeyDown')))[0];
      utils.initFirstFocusNode(this.domNode, firstNode);
    },

    _firstNodeKeyDown: function (e) {
      if (e.keyCode === keys.TAB && e.shiftKey) {
        this._backToLastNodeFlag = true;
      }
    },

    _lastNodeFocused: function () {
      if (this._backToLastNodeFlag) {
        var lastExpandedLayerNode = this._currentLastNode;
    ...
    _setFirstLastNodeOnMainScreen: function () {
      ...
      var firstNode;
      if (this._isWidgetLoadedInProjectMode) {
        firstNode = this._loadProjectDropdown.focusNode;
        this._loadProjectDropdown.focus();
      } else {
        firstNode = this.btnFlag;
        focusUtil.focus(firstNode);
      }
      this._setWidgetFirstFocusNode(firstNode);
      //set current last node in the widget
      if (this.exportToCsvMainScreenButton &&
        !domClass.contains(this.exportToCsvMainScreenButton, "jimu-state-disabled") &&
        !domClass.contains(this.exportButtonContainer, "esriCTHidden")) {
        this._currentLastNode = this.exportToCsvMainScreenButton;
      } else if (this.projectSaveButton &&
        !domClass.contains(this.projectSaveButton, "jimu-state-disabled") &&
        !domClass.contains(this.saveButtonContainer, "esriCTHidden")) {
        this._currentLastNode = this.projectSaveButton;
      } else if (this.skipLocationTab &&
        !domClass.contains(this.skipLocationTab, "esriCTHidden")) {
        this._currentLastNode = this.skipLocationTab;
      } else if (this.barrierLocTab &&
        !domClass.contains(this.barrierLocTab, "esriCTHidden")) {
        this._currentLastNode = this.barrierLocTab;
      } else if (this.inputLocTab &&
        !domClass.contains(this.inputLocTab, "esriCTHidden")) {
        this._currentLastNode = this.inputLocTab;
      } else {
        this._currentLastNode = this.btnClear;
      }
    },

    _setFirstLastNodeOnFlagListScreen: function () {
      //First node on main screen will be an input list back button
      var listItems, firstNode;
      firstNode = this.inputBackClick;
      //utils.initFirstFocusNode(this.domNode, firstNode);
      this._setWidgetFirstFocusNode(firstNode);
      focusUtil.focus(firstNode);
      //set last focus node on input flag list screen
      if (this.exportToCsvMainScreenButton &&
        !domClass.contains(this.exportToCsvMainScreenButton, "jimu-state-disabled") &&
        !domClass.contains(this.exportButtonContainer, "esriCTHidden")) {
        this._currentLastNode = this.exportToCsvMainScreenButton;
        ...
        listItems = query(".esriCTFlagsBarriersSkipLocationsMainDiv", this.flagLocContent);
        if (listItems && listItems.length > 0) {
          this._currentLastNode = listItems[listItems.length - 1];
        }
      }
    },

    _setFirstLastNodeOnBarrierListScreen: function () {
      //First node on main screen will be an barrier list back button
      var listItems, firstNode;
      firstNode = this.barrierBackClick;
      this._setWidgetFirstFocusNode(firstNode);
      focusUtil.focus(firstNode);

      //set last focus node on barrier list screen
      if (this.exportToCsvMainScreenButton &&
        !domClass.contains(this.exportToCsvMainScreenButton, "jimu-state-disabled") &&
        !domClass.contains(this.exportButtonContainer, "esriCTHidden")) {
        this._currentLastNode = this.exportToCsvMainScreenButton;
        ...
        listItems = query(".esriCTFlagsBarriersSkipLocationsMainDiv", this.barrierLocContent);
        if (listItems && listItems.length > 0) {
          this._currentLastNode = listItems[listItems.length - 1];
        }
      }
    ...
    _setFirstLastNodeOnSkipListScreen: function () {
      //First node on main screen will be an skip list back button
      var listItems, firstNode;
      firstNode = this.skipLocationBackClick;
      this._setWidgetFirstFocusNode(firstNode);
      focusUtil.focus(firstNode);

      //set last focus node on skip list screen
      if (this.exportToCsvMainScreenButton &&
        !domClass.contains(this.exportToCsvMainScreenButton, "jimu-state-disabled") &&
        !domClass.contains(this.exportButtonContainer, "esriCTHidden")) {
        this._currentLastNode = this.exportToCsvMainScreenButton;
        ...
        listItems = query(".esriCTFlagsBarriersSkipLocationsMainDiv", this.skipLocationsListContainer);
        if (listItems && listItems.length > 0) {
          this._currentLastNode = listItems[listItems.length - 1];
        }
      }
    ...
    _setFirstLastNodeOnExportToCSVParamList: function () {
      var listItems, firstNode;
      //set back button as the first node
      firstNode = this.exportBackNode;
      this._setWidgetFirstFocusNode(firstNode);

      //if ok button is enabled it will be the last node else
      //last check box will be the last widget node
      if (this.exportToCsvFileMainButton &&
        !domClass.contains(this.exportToCsvFileMainButton, "jimu-state-disabled")) {
        this._currentLastNode = this.exportToCsvFileMainButton;
      } else {
        listItems = query(".jimu-checkbox", this.exportToCSVFormContainer);
        this._currentLastNode = listItems[listItems.length - 1];
      }
    },

    _setFirstLastNodeOnOutputScreen: function () {
      var firstNode, listItems;
      listItems = query(".esriCTLayerNameContainer", this.resultsLayerNamesContainer);
      //set first node on output screen
      if (this._isWidgetLoadedInProjectMode) {
        firstNode = this._loadProjectDropdown.focusNode;
      } else if (!domClass.contains(this.resultLayersInformationContainer, "esriCTHidden")) {
        firstNode = this.resultLayersInformationContainer;
      } else if (listItems.length > 0 &&
        !domClass.contains(this.resultsLayerNamesContainer, "esriCTHidden")) {
        firstNode = listItems[0];
      } else {
        firstNode = this.supports508Node;
      }
      this._setWidgetFirstFocusNode(firstNode);
      //set focus to infonode if visible else to first item in the list
      if (!domClass.contains(this.resultLayersInformationContainer, "esriCTHidden")) {
        focusUtil.focus(this.resultLayersInformationContainer);
      } else {
        focusUtil.focus(listItems[0]);
      }

      //set last focus node on output list screen
      if (this.exportToCsvMainScreenButton &&
        !domClass.contains(this.exportToCsvMainScreenButton, "jimu-state-disabled") &&
        !domClass.contains(this.exportButtonContainer, "esriCTHidden")) {
        this._currentLastNode = this.exportToCsvMainScreenButton;
        ...
        this._currentLastNode = this.supports508Node;
      }
    },

    _setFirstLastNodeOnOutputResultScreen: function (resultMainDiv) {
      var listItems, firstNode;
      //set back button as first focus node
      firstNode = query(".esriCTResultContainerBack", resultMainDiv)[0];
      this._setWidgetFirstFocusNode(firstNode);
      focusUtil.focus(firstNode);

      //set last focus node on features list
      listItems = query(".resultItemSubDiv", resultMainDiv);
      if (listItems && listItems.length > 0) {
        this._currentLastNode = listItems[listItems.length - 1];
      }
    },

    /** Code to support 508 End **/

    _displayFlagsList: function () {
      this._hideMainScreen();
      domClass.remove(this.inputLocDiv, "esriCTHidden");
      this._setFirstLastNodeOnFlagListScreen();
    },
    ...
    _displayBarrierList: function () {
      ...
      this._setFirstLastNodeOnBarrierListScreen();
    },
    ...
    _displaySkipLocationList: function () {
      ...
      this._setFirstLastNodeOnSkipListScreen();
    },
    ...
    _displayMainScreen: function () {
      ...
      domClass.remove(this.inputOutputTabParentContainer, "esriCTHidden");
      domClass.remove(this.saveAndExportParentContainer, "esriCTHidden");
      //based on selected tab set the first last node of main/output tab screen
      if (this._tabContainer) {
        if (this._tabContainer.viewStack.getSelectedLabel() === this.nls.inputTabTitle) {
          this._setFirstLastNodeOnMainScreen();
        } else {
    ...
    _displayOutputFeatureList: function (resultMainDiv) {
      ...
      this._setFirstLastNodeOnOutputResultScreen(resultMainDiv);
    },
    ...
    /**
     * On Unskip feature action
     */
    unSkipFromTrace: function (features, layer) {
      var oid = features[0].attributes[layer.oid];
      var skipButton = query("[layerid=" + layer.id + "][oid=" + oid + "]", this.domNode);
      if (skipButton && skipButton.length > 0) {
        skipButton = skipButton[0];
      }
      if (domClass.contains(skipButton, "alreadySkippedLocation")) {
        skipButton.click();
        this._errorMessage(this.nls.removedFromSkipLocations);
      } else {
    ...
    /**
     * On Skip feature action
     */
    skipFromTrace: function (features, layer) {
      var oid = features[0].attributes[layer.oid];
      var skipButton = query("[layerid=" + layer.id + "][oid=" + oid + "]", this.domNode);
      if (skipButton && skipButton.length > 0) {
        skipButton = skipButton[0];
      ...
      if (!domClass.contains(skipButton, "alreadySkippedLocation")) {
        skipButton.click();
        this._errorMessage(this.nls.locationSkipped);
      } else {
        this._errorMessage(this.nls.locationAlreadySkippedMessage);
      }
    },
    ...
    /**
     * This function is used to set the width of span inside the project name dropdown
     * so that ellipsis would occur for long names
     */
    _setProjectDropdownNameWidth: function () {
      if (this.loadProjectDropdownContainer !== '' &&
        this.loadProjectDropdownContainer !== null &&
        this.loadProjectDropdownContainer !== undefined) {
        var loadProjectDropdownContainer = domStyle.getComputedStyle(this.loadProjectDropdownContainer);
        if (loadProjectDropdownContainer !== '' &&
          loadProjectDropdownContainer !== null &&
          loadProjectDropdownContainer !== undefined) {
          var loadProjectDropdownContainerWidth = loadProjectDropdownContainer.width;
          var projectNameSpanWidth = parseFloat(loadProjectDropdownContainerWidth);
          // 56 - consists width of dijitArrowButtonContainer which needs to be deducted
          projectNameSpanWidth = projectNameSpanWidth - 56;
          var projectNameSpan = query('.dijitSelectLabel', this.loadProjectDropdownContainer);
          if (projectNameSpan !== '' && projectNameSpan !== null && projectNameSpan !== undefined) {
            if (projectNameSpan.length > 0) {
              domStyle.set(projectNameSpan[0], "width", projectNameSpanWidth + "px");
              this._setProjectDropdownTooltip(projectNameSpan[0]);
            }
          }
        }
      }
    ...
    /**
     * This function is used to displat tooltip when user hovers the project name in dropdown
     */
    _setProjectDropdownTooltip: function (projectNameSpan) {
      var projectName = domAttr.get(projectNameSpan, "innerHTML");
      domAttr.set(projectNameSpan, "title", projectName);
    },

    /**
     * This function is used to set the input tab summary text
     */
    _setInputTabSummaryText: function () {
      if (this.inputTabSummaryTextContainer !== '' &&
        this.inputTabSummaryTextContainer !== null &&
        this.inputTabSummaryTextContainer !== undefined) {
        if (this.config.hasOwnProperty('inputSummaryText')) {
          if (this.config.inputSummaryText !== '' &&
            this.config.inputSummaryText !== null &&
            this.config.inputSummaryText !== undefined) {
            domClass.add(this.inputTabSummaryTextContainer, 'esriCTInputTabSummaryTextContainer');
            domClass.remove(this.inputTabSummaryTextContainer, 'esriCTHidden');
            domAttr.set(this.inputTabSummaryTextContainer, "innerHTML",
              this.editorXssFilter.sanitize(this.config.inputSummaryText));
            domAttr.set(this.inputTabSummaryTextContainer, "aria-label", utils.stripHTML(this.config.inputSummaryText));
          }
        }
      }
    }
