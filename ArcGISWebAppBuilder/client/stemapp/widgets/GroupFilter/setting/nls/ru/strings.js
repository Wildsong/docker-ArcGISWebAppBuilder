define({
  ...
  "inputs": {
    ...
    "hideDropDown": "Скрыть заголовок и фильтр выборки если настроена 1 группа",
    ...
    "optionLIKE": "СОДЕРЖИТ",
    "optionLIKESPECIFIC": "СОДЕРЖИТ ОПРЕДЕЛЕННОЕ ЗНАЧЕНИЕ(Я)",
    "optionNOTLIKESPECIFIC": "НЕ СОДЕРЖИТ ОПРЕДЕЛЕННОЕ ЗНАЧЕНИЕ(Я)",
