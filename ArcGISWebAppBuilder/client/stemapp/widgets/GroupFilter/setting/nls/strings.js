define({
  root: ({
    ...
    inputs : {
      ...
      hideDropDown: "Hide the header and  filter selection if only 1 group is configured",
      ...
      optionEND : "ENDS WITH",
      optionLIKE : "CONTAINS",
      optionLIKESPECIFIC: "CONTAINS SPECIFIC VALUE-S",
      optionNOTLIKESPECIFIC: "DOES NOT CONTAIN SPECIFIC VALUE-S",
