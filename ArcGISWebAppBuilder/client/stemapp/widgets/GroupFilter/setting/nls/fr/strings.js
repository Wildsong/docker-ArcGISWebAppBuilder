define({
  ...
  "inputs": {
    ...
    "sameLayerAll": "Respecter toutes les expressions",
    ...
    "webmapAppendModeTip": "Option permettant d’ajouter le jeu de filtres à un filtre de carte web existant.",
    "persistOnClose": "Conserver après la fermeture du widget",
    "selectGroup": "Sélectionner un groupe à filtrer",
    "hideDropDown": "Masquer l’en-tête et filtrer la sélection si un seul groupe est configuré",
    ...
    "optionLIKE": "CONTIENT",
    "optionLIKESPECIFIC": "CONTIENT UNE/DES VALEURS SPÉCIFIQUES",
    "optionNOTLIKESPECIFIC": "NE CONTIENT PAS UNE/DES VALEURS SPÉCIFIQUES",
