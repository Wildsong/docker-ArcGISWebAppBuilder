  ...
  return declare([BaseWidget, Evented, _WidgetsInTemplateMixin], {
    ...
    displayStatisticsDetail: function (statisticDetailDataArray) {
      ...
      if (statisticDetailDataArray.length === 0) {
        var noDetailStatisticAvailableDiv;
        noDetailStatisticAvailableDiv = domConstruct.create("div", {
          innerHTML: this.nls.detailStatistics.noDetailStatisticAvailable,
          "class": "esriCTNoDetailStatisticMessage",
          tabindex:"0",
          "role": "presentation",
          "aria-label": this.nls.detailStatistics.noDetailStatisticAvailable
        }, this.assetsListNode);
        focusUtils.focus(noDetailStatisticAvailableDiv);
      }
      else {
    ...
    _createStatisticsDetailUI: function (assetLabel, assetStatValue) {
      var assetWrapper, assetValueWrapper, assetValueTextBox;
    ...
    */
    ...
    setFirstAndLastNode: function() {
      jimuUtils.initFirstFocusNode(this.widgetDomNode, this.addNewStatisticsIcon);
      focusUtils.focus(this.addNewStatisticsIcon);
