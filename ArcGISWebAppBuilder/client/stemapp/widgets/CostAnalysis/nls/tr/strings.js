...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Etiket noktası alınırken hata oluştu. Yeniden deneyin",
    "errorAddingPointLabel": "Etiket noktası eklenirken hata oluştu. Yeniden deneyin"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Katman Onay Kutusu"
  },
  "statisticsType": {
    "countLabel": "Sayım",
    ...
    "areaLabel": "Alan",
    "lengthLabel": "Uzunluk",
    "expandCollapseAriaLabel": "'${displayTitle}' Sayı '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Detay Oluşturma Modu",
    "sketchToolTitle": "Yeni varlıkların taslağını çizin.",
    "selectToolTitle": "Varlıkları haritadaki mevcut detaydan kopyalayın.",
    "downloadCSVBtnTitle": "Raporu Dışa Aktar",
    "templatePickerTitle": "Yeni varlıklar oluşturmak için bir şablon seçin:"
  },
  "assetDetails": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Proje denklemlerini güncelle",
    "updateProjectCostSelectProjectTitle": "Tüm projeleri seç",
    "updateButtonTextForm": "Güncelle",
    "updateProjectCostSuccess": "Seçilen projelerin maliyet denklemleri güncellenir",
    "updateProjectCostError": "Seçilen projelerin maliyet denklemi güncellenemiyor",
    "updateProjectNoProject": "Proje bulunamadı"
  }
});