...
define({
  ...
  "createLoadProject": {
    ...
    "noAssetsToViewOnMap": "所选工程没有任何可以在地图上查看的资产。",
    ...
    "errorFetchingPointLabel": "获取标注点时出错。 请重试",
    "errorAddingPointLabel": "添加标签点时出错。 请重试"
  },
  "statisticsSettings": {
    "tabTitle": "统计数据设置",
  ...
  "statisticsType": {
    ...
    "areaLabel": "面积",
    "lengthLabel": "长度",
    "expandCollapseAriaLabel": "包含“${featureCount}”个要素的“${layerTitle}”"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "要素创建模式",
    "sketchToolTitle": "草绘新资产。",
    "selectToolTitle": "复制地图中现有要素的资产。",
    "downloadCSVBtnTitle": "导出报告",
    "templatePickerTitle": "选择用于创建新资产的模板："
  },
  "assetDetails": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "更新工程公式",
    "updateProjectCostSelectProjectTitle": "选择所有工程",
    "updateButtonTextForm": "更新",
    "updateProjectCostSuccess": "选定工程的成本公式已更新",
    "updateProjectCostError": "无法更新选定工程的成本公式",
    "updateProjectNoProject": "找不到工程"
  }
});