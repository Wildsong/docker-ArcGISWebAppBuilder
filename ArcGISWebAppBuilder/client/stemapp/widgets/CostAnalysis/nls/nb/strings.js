...
define({
  ...
  "createLoadProject": {
    ...
    "viewInMapLabel": "Forhåndsvisning",
    "loadLabel": "Last inn",
    "createLabel": "Opprett",
    ...
    "errorFetchingPointLabel": "Feil ved henting av etikettpunkt. Prøv på nytt",
    "errorAddingPointLabel": "Feil ved tillegging av etikettpunkt. Prøv på nytt"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Avmerkingsboks for lag"
  },
  "statisticsType": {
    "countLabel": "Antall",
    ...
    "areaLabel": "Areal",
    "lengthLabel": "Lengde",
    "expandCollapseAriaLabel": "'${displayTitle}' antall '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Modus for oppretting av geoobjekt",
    "sketchToolTitle": "Skisser nye ressurser.",
    "selectToolTitle": "Kopier ressurser fra eksisterende geoobjekt i kartet.",
    "downloadCSVBtnTitle": "Eksporter rapport",
    "templatePickerTitle": "Velg en mal for å opprette nye ressurser:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Legg til"
  },
  "copyFeatures": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Oppdater prosjektets beregninger",
    "updateProjectCostSelectProjectTitle": "Velg alle prosjekter",
    "updateButtonTextForm": "Oppdater",
    "updateProjectCostSuccess": "Kostnadsberegningene i de valgte prosjektene er oppdatert",
    "updateProjectCostError": "Kan ikke oppdatere kostnadsberegning for valgte prosjekter",
    "updateProjectNoProject": "Finner ingen prosjekter"
  }
});