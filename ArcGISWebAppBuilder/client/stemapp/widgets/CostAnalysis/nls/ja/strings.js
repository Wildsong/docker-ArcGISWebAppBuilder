...
define({
  ...
  "createLoadProject": {
    ...
    "viewInMapLabel": "プレビュー",
    "loadLabel": "読み込み",
    "createLabel": "作成",
    "deleteProjectConfirmationMsg": "プロジェクトを削除しますか？",
    "noAssetsToViewOnMap": "選択したプロジェクトには、マップ上に表示する対象物がありません。",
    ...
    "errorFetchingPointLabel": "ラベル ポイントの取得中にエラーが発生しました。 もう一度試してください",
    "errorAddingPointLabel": "ラベル ポイントの追加中にエラーが発生しました。 もう一度試してください"
  },
  "statisticsSettings": {
    "tabTitle": "統計情報の設定",
  ...
  "statisticsType": {
    ...
    "areaLabel": "ポリゴン",
    "lengthLabel": "ライン",
    "expandCollapseAriaLabel": "'${displayTitle}' の数: '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "フィーチャ作成モード",
    "sketchToolTitle": "新しい対象物をスケッチします。",
    "selectToolTitle": "マップ内の既存のフィーチャから対象物をコピーします。",
    "downloadCSVBtnTitle": "レポートのエクスポート",
    "templatePickerTitle": "新しい対象物を作成するためのテンプレートを選択:"
  },
  "assetDetails": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "プロジェクトの方程式の更新",
    "updateProjectCostSelectProjectTitle": "すべてのプロジェクトを選択",
    "updateButtonTextForm": "アップデート",
    "updateProjectCostSuccess": "選択したプロジェクトのコスト方程式が更新されます",
    "updateProjectCostError": "選択したプロジェクトのコスト方程式を更新できません",
    "updateProjectNoProject": "プロジェクトが見つかりません"
  }
});