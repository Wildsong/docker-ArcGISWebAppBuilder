...
define([
  ...
  return declare([BaseWidget, Evented, _WidgetsInTemplateMixin], {
    ...
    updateLayerSettingsTable: function (currentLayer) {
      ...
      //If attribute settings are configured then clear all
      //the field mapping attributes once the project layer is updated
      this._clearSelectedLayerFields(currentLayer.currentSelectedLayerId);
    },

    /**
     * This function clear's attribute setting mapping
     * @memberOf setting/LayerSettings
     */
    _clearSelectedLayerFields: function () {
      var tableRows;
      ...
      array.forEach(tableRows, lang.hitch(this, function (tableRow) {
        tableRow.attributeSettingFields = [];
      }));
    },
