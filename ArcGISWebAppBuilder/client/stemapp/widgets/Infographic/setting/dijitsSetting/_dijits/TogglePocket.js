...
define([
  ...
  function(declare, lang, on, html, Evented, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, jimuUtils) {
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      _initUI: function() {
        if (this.titleLabel) {
          this.label.innerHTML = jimuUtils.sanitizeHTML(this.titleLabel);
        }
        if (this.content) {
