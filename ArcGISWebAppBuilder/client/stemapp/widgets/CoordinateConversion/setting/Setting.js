...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    getConfig: function () {
      ...
      array.forEach(
        data,
        lang.hitch(this, function (tData) {
    ...
    setConfig: function (config) {
      ...
      if (this.config.hasOwnProperty("inputFormat")) {
        this.inputFormatTextBox.set("value", this.config.inputFormat);
      } else {
        this.inputNotationDropdown.set("value", "YN XE");
      }
      if (
        this.config.hasOwnProperty("addSignPrefix") ||
