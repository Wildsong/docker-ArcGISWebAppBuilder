  ...
  var lf = dojoDeclare([drawFeedback], {
    ...
    */
    ...
    _onDblClickHandler: function (evt) {
      var geodesicGeometry, mapGeometry;
      ...
      geodesicGeometry = new esriPolyLine({
        paths: [
          [
      ...
      geodesicGeometry.geodesicLength = esriGeometryEngine.geodesicLength(geodesicGeometry, 9001);

      if (this._onMouseMoveHandler_connect) {
        dojoConnect.disconnect(this._onMouseMoveHandler_connect);
      }

      var unitlength = this.coordTool.convertMetersToUnits(geodesicGeometry.geodesicLength, this.lengthUnit);
      var ang = this.getAngle(this.startPoint, this.endPoint);
      ...
      var result = {
        ...
        geographicGeometry: geodesicGeometry
      };
      var tempMapGeometry = new esriPolyLine(mapGeometry.toJson());
      tempMapGeometry.result = result;
      this._drawEnd(tempMapGeometry);
    },
