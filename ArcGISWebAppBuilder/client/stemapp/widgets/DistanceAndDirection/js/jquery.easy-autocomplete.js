            ...
            (function () {
              ...
              $elements_container
                ...
                .on("loadElements.eac", function (event, listBuilders, phrase) {
                  ...
                  elementsList = [];
                  var counter = 0;
                  for (var bi = 0, listBuildersLength = listBuilders.length; bi < listBuildersLength; bi += 1) {

                    var listData = listBuilders[bi].data;

                    if (listData.length === 0) {
                      continue;
                    }

                    if (listBuilders[bi].header !== undefined &&
                      listBuilders[bi].header.length > 0) {
                      $listContainer.append("<div class='eac-category' >" +
                        listBuilders[bi].header + "</div>");
                    }

                    for (var i = 0, listDataLength = listData.length; i < listDataLength &&
                      counter < listBuilders[bi].maxListSize; i += 1) {
                      ...
                      (function () {
                        var j = i,
                          itemCounter = counter,
                          elementsValue = listBuilders[bi].getValue(listData[j]);
