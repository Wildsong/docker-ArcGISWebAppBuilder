  ...
  function (
    ...
    return dojoDeclare([jimuBaseWidgetSetting, dijitWidgetsInTemplateMixin], {
      ...
      getConfig: function () {
        ...
        var allTabsFalse = 0;
        var haveValidValues = true;
        dojoArray.forEach(feedbackData, function (tData) {
          // validate line width values
          if (!this._validateLineWidthValue(tData.lineWidth)) {
            haveValidValues = false;
          }
          if (tData.showTab) {
        ...
        if (!this._validateLabelTextSizeValue(labelData[0].textSize)) {
          return false;
        }
      ...
      /*
        Validates the line width values
      */
      _validateLineWidthValue: function (val) {
