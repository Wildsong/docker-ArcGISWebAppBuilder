...
define([
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    baseClass: 'jimu-widget-RelatedTableCharts-query-source-setting',
    ...
    postMixInProperties: function () {
      ...
      this.nls.loadingShelter = window.jimuNls.loadingShelter;
    },
    ...
    setConfig: function (config) {
      ...
      this.shelter.show(this.nls.loadingShelter.loading);
