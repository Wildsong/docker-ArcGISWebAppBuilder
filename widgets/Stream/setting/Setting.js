...
define([
  ...
  function(declare, lang, array, on, domStyle, domClass, _TemplatedMixin, _WidgetsInTemplateMixin,
      template, BaseWidgetSetting, utils, StreamSetting, SimpleTable) {
    return /** @alias module:widgets/Stream/setting/Setting */ declare([BaseWidgetSetting,
      ...
      postCreate: function() {
        ...
        this.streamList = new SimpleTable({
          autoHeight:false,
          selectable:true,
          fields:[{
            name:"name",
        ...
        domClass.add(this.streamList.domNode, 'stream-list-table');
        domStyle.set(this.streamList.domNode, 'height', '100%');
        this.own(on(this.streamList, 'row-select', lang.hitch(this, this._onStreamLayerSelected)));
        this.streamList.startup();
