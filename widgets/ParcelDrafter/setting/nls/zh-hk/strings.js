...
define({
  ...
  "parcelLineLayer": {
    ...
    "startOrRotationSymbolLabel": "啟動和旋轉點符號",
    "startOrRotationSymbolHintText": "提示: 用來顯示啟動和旋轉點符號。",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "選擇欄位以儲存座標幾何資訊",
    ...
    "honorSettingRbLabel": "Web 地圖快顯視窗設定",
    "customSettingsRbLabel": "自訂設定",
    "display": "顯示",
    "edit": "編輯",
    "editpageName": "名稱",
    "actions": "操作",
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "請為每個座標幾何資訊選擇不同的欄位。"
  }
});