...
define({
  ...
  "parcelLineLayer": {
    ...
    "attributeSettingTabLabel": "הגדרות מאפיינים",
    ...
    "startOrRotationSymbolLabel": "סמל נקודת התחלה וסיבוב",
    "startOrRotationSymbolHintText": "רמז: משמש להצגת הסמל של נקודת ההתחלה והסיבוב.",
    "symbolPickerPreviewText": "תצוגה מקדימה",
    "selectLineLayerLabel": "בחר שכבת קווים"
  },
  "parcelPolygonLayer": {
    "selectPolygonLayerLabel": "בחר שכבת פוליגונים",
    "selectPolygonLayerHintText": "רמז: השתמש בשכבת הפוליגון של החלקות שנבחרה",
    "selectFieldLegendLabel": "בחר שדות לשמירת פרטי גאומטריית הקואורדינטות",
    ...
    "selectPolygonLayerLabelPopUp": "בחר שכבת פוליגונים",
    "honorSettingRbLabel": "הגדרות חלון מוקפץ במפת ווב",
    "customSettingsRbLabel": "הגדרות מותאמות אישית",
    "display": "תצוגה",
    "edit": "ערוך",
    "editpageName": "שם",
    "actions": "פעולות",
    "editpageAlias": "כינוי",
    "titleLabel": "כותרת קטע"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "בחר שדה ייחודי לכל פרטי גאומטריית הקואורדינטות."
  }
});