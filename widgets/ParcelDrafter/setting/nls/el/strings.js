...
define({
  "setBtnLabel": "Ορισμός",
  "selectLabel": "Επιλογή",
  "selectLayerLabel": "Επιλογή θεματικών επιπέδων γεωτεμαχίου",
  ...
  "parcelLineLayer": {
    "selectLayerLabel": "Επιλογή συναφούς γραμμικού θεματικού επιπέδου",
    "layerSettingTabLabel": "Θεματικά επίπεδα γεωτεμαχίου",
    "attributeSettingTabLabel": "Ρυθμίσεις γνωρισμάτων",
    ...
    "startOrRotationSymbolLabel": "Σύμβολο σημείου αφετηρίας και περιστροφής",
    "startOrRotationSymbolHintText": "Υπόδειξη: Χρησιμεύει για την παρουσίαση συμβόλου σημείου αφετηρίας και περιστροφής.",
    "symbolPickerPreviewText": "Προεπισκόπηση",
    "selectLineLayerLabel": "Επιλογή γραμμικού θεματικού επιπέδου"
  },
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "Επιλογή πεδίων για την αποθήκευση πληροφοριών γεωμετρίας συντεταγμένων",
    ...
    "selectPolygonLayerLabelPopUp": "Επιλέξτε ένα πολυγωνικό θεματικό επίπεδο.",
    "honorSettingRbLabel": "Ρυθμίσεις αναδυόμενων παραθύρων web χάρτη",
    "customSettingsRbLabel": "Εξατομικευμένες ρυθμίσεις",
    "display": "Οθόνη",
    "edit": "Επεξεργασία",
    "editpageName": "Όνομα",
    "actions": "Ενέργειες",
    "editpageAlias": "Ψευδώνυμο",
    "titleLabel": "Τίτλος ενότητας"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "Επιλέξτε διακριτό πεδίο για τις πληροφορίες γεωμετρίας κάθε συντεταγμένης."
  }
});