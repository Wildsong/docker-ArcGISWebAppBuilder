...
define({
  ...
  "parcelLineLayer": {
    "selectLayerLabel": "تحديد طبقة الخط ذات الصلة",
    "layerSettingTabLabel": "طبقات قطعة الأرض",
    "attributeSettingTabLabel": "إعدادات السمة",
    ...
    "startOrRotationSymbolLabel": "ابدأ رمز النقطة وقم بتدويرها",
    "startOrRotationSymbolHintText": "تلميح: يستخدم لعرض بدء رمز النقطة وتدويرها.",
    "symbolPickerPreviewText": "معاينة",
    "selectLineLayerLabel": "تحديد طبقة الخط"
  },
  "parcelPolygonLayer": {
    "selectPolygonLayerLabel": "تحديد طبقة المضلع",
    "selectPolygonLayerHintText": "لمحة: استخدام تحديد طبقة المضلع الخاصة بقطعة الأرض",
    "selectFieldLegendLabel": "تحديد حقول لتخزين معلومات الأشكال الهندسية للإحداثيات",
    ...
    "selectPolygonLayerLabelPopUp": "تحديد طبقة مضلع",
    "honorSettingRbLabel": "إعدادات النوافذ المنبثقة لـ Webmap",
    "customSettingsRbLabel": "إعدادات مخصصة",
    "display": "العرض",
    "edit": "تحرير",
    "editpageName": "الاسم",
    "actions": "إجراءات",
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "يرجى تحديد حقل مميز لكل معلومات الأشكال الهندسية للإحداثيات."
  }
});