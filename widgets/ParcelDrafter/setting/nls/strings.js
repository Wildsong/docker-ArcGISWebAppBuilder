...
define({
  root: ({
    ...
    "parcelLineLayer": {
      ...
      "attributeSettingTabLabel": "Attribute Settings", // Shown as label in config UI for second tab.
      "advancedSettingTabLabel": "Advanced Settings", // shown as label in config UI for third tab.
    ...
    "parcelPolygonLayer": {
      ...
      "selectFieldLegendLabel": "Select fields to store coordinate geometry information", // shown as a label in config for select field legend.
      ...
      "honorSettingRbLabel": "Webmap Popup Settings", // Shown as a label in config for webmap popup settings radio button.
      "customSettingsRbLabel": "Custom Settings", // Shown as a label in config for custom settings radio button.
      "display": "Display", // shown as a label in config for display column in simple table.
      "edit": "Edit", // shown as a label in config for edit column in simple table.
      "editpageName": "Name", // shown as a label in config for name column in simple table.
      "actions": "Actions", // shown as a label in config for action column in simple table.
      "editpageAlias": "Alias", // shown as a label in config for alias column in simple table.
      "titleLabel": "Section Title" // Shown as a label in config.
    },
    ...
    "errorMsg": {
      ...
      "selectDistinctPolygonFields": "Please select distinct field for each coordinate geometry information." //Shown as error if same field is configured for multiple properties of polygon layer
    }
