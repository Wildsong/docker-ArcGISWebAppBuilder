...
define([],
  function () {
    ...
    mo.planSettingsOptions = {
      ...
      "distanceAndLengthUnits": ["uSSurveyFeet", "feet", "meters"],
      "areaUnits": ["squareUSSurveyFeet", "squareFeet", "acres", "squareMeters"],
    ...
    */
    mo.categorizeLengthFormat = function (length, distanceAndLengthUnits) {
      ...
      // 46 FTUS|FTUs|FTuS|FTus|FtUS|FtUs|FtuS|Ftus|fTUS|fTUs|fTuS|fTus|ftUS|ftUs|ftuS|ftus
      formatRegExArr.push(/^(((\-?)((0?|([1-9]\d*))(\.\d+)?))(FTUS|FTUs|FTuS|FTus|FtUS|FtUs|FtuS|Ftus|fTUS|fTUs|fTuS|fTus|ftUS|ftUs|ftuS|ftus))$/);
    ...
    mo.getLengthOfRequiredFormat = function (res, i, distanceAndLengthUnits) {
      ...
      switch (i) {
        ...
        case 2:
          ...
          break;
        case 3:
          lengthObj = mo.getLengthObjForFormat3(res);
          break;
      }
      return lengthObj;
    };
