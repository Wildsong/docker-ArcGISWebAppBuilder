...
define({
  ...
  "createLoadProject": {
    ...
    "viewInMapLabel": "Förhandsgranska",
    "loadLabel": "Ladda",
    "createLabel": "Skapa",
    ...
    "errorFetchingPointLabel": "Ett fel uppstod när etikettpunkten hämtades. Försök igen",
    "errorAddingPointLabel": "Ett fel uppstod när etikettpunkten lades till. Försök igen"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Kryssrutan Lager"
  },
  "statisticsType": {
    "countLabel": "Antal",
  ...
  "workBench": {
    ...
    "featureModeText": "Läge för skapande av geoobjekt",
    "sketchToolTitle": "Skissa nya resurser.",
    "selectToolTitle": "Kopiera resurser från ett befintligt geoobjekt i kartan.",
    "downloadCSVBtnTitle": "Exportera rapport",
    "templatePickerTitle": "Välj en mall för att skapa nya resurser:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Lägg till"
  },
  "copyFeatures": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Uppdatera projektekvationer",
    "updateProjectCostSelectProjectTitle": "Välj alla projekt",
    "updateButtonTextForm": "Uppdatera",
    "updateProjectCostSuccess": "Kostnadsekvationer för de valda projekten är uppdaterade",
    "updateProjectCostError": "Det gick inte att uppdatera kostnadsekvationen för de valda projekten",
    "updateProjectNoProject": "Inget projekt hittades"
  }
});