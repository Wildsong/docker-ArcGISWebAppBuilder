...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Errore durante il recupero del punto etichetta. Riprovare",
    "errorAddingPointLabel": "Errore durante l'aggiunta del punto etichetta. Riprovare"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Casella di spunta del layer"
  },
  "statisticsType": {
    ...
    "expandCollapseAriaLabel": "'${displayTitle}' Conteggio '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Modalità di creazione feature",
    "sketchToolTitle": "Disegna nuove risorse.",
    "selectToolTitle": "Copiare risorse da feature esistente nella mappa.",
    "downloadCSVBtnTitle": "Esporta report",
    "templatePickerTitle": "Selezionare un modello per creare nuove risorse:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Aggiungi"
  },
  "copyFeatures": {
    "title": "Copia Feature",
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Aggiorna equazioni del progetto",
    "updateProjectCostSelectProjectTitle": "Seleziona tutti i progetti",
    "updateButtonTextForm": "Aggiorna",
    "updateProjectCostSuccess": "Le equazioni di costi dei progetti selezionati sono aggiornate",
    "updateProjectCostError": "Impossibile aggiornare le equazioni di costi dei progetti selezionati",
    "updateProjectNoProject": "Nessun progetto trovato"
  }
});