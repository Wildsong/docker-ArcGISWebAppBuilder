...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "שגיאה בעת אחזור נקודת תווית. נסה שוב",
    "errorAddingPointLabel": "שגיאה בעת הוספת נקודת תווית. נסה שוב"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "תיבת סימון של שכבה"
  },
  "statisticsType": {
    "countLabel": "מונה",
    "averageLabel": "ממוצע",
    ...
    "areaLabel": "שטח",
    "lengthLabel": "אורך",
    "expandCollapseAriaLabel": "ספירת '${displayTitle}' '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "מצב יצירת ישויות",
    "sketchToolTitle": "שרטט נכסים חדשים.",
    "selectToolTitle": "העתק נכסים מיישות קיימת במפה.",
    "downloadCSVBtnTitle": "ייצוא דו\"ח",
    "templatePickerTitle": "בחר תבנית כדי ליצור נכסים חדשים."
  },
  "assetDetails": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "עדכן משוואות של הפרויקט",
    "updateProjectCostSelectProjectTitle": "בחירה בכל הפרויקטים",
    "updateButtonTextForm": "עדכון",
    "updateProjectCostSuccess": "משוואות המחיר של הפרויקטים שנבחרו עודכנו",
    "updateProjectCostError": "לא ניתן לעדכן את משוואת המחיר של הפרויקטים שנבחרו",
    "updateProjectNoProject": "לא נמצא פרויקט"
  }
});