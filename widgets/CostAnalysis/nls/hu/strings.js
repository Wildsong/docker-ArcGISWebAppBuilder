...
define({
  ...
  "createLoadProject": {
    ...
    "viewInMapLabel": "Előnézet",
    "loadLabel": "Betöltés",
    "createLabel": "Létrehozás",
    "deleteProjectConfirmationMsg": "Biztosan törli a projektet?",
    "noAssetsToViewOnMap": "A kiválasztott projektben nincs a térképen megtekinthető eszköz.",
    ...
    "errorFetchingPointLabel": "Hiba történt a feliratpont lekérése közben. Próbálja meg újra",
    "errorAddingPointLabel": "Hiba történt a feliratpont hozzáadása közben. Próbálja meg újra"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Réteg jelölőnégyzete"
  },
  "statisticsType": {
    "countLabel": "Szám",
    "averageLabel": "Átlag",
    ...
    "areaLabel": "Terület",
    "lengthLabel": "Hossz",
    "expandCollapseAriaLabel": "'${displayTitle}' szám: '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Vektoroselem-létrehozási mód",
    "sketchToolTitle": "Új eszközök vázlatának készítése.",
    "selectToolTitle": "Eszközök másolása a térképen már meglévő vektoros elemből.",
    "downloadCSVBtnTitle": "Jelentés exportálása",
    "templatePickerTitle": "Válasszon sablont új eszközök készítéséhez:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Hozzáadás"
  },
  "copyFeatures": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Projekt egyenleteinek frissítése",
    "updateProjectCostSelectProjectTitle": "Összes projekt kiválasztása",
    "updateButtonTextForm": "Frissítés",
    "updateProjectCostSuccess": "Megtörtént a kiválasztott projektek költségegyenleteinek kiválasztása",
    "updateProjectCostError": "Nem sikerült frissíteni a kiválasztott projektek költségegyenleteit",
    "updateProjectNoProject": "Nem találhatók projektek"
  }
});