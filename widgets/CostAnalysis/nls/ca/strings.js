...
define({
  ...
  "createLoadProject": {
    ...
    "viewInMapLabel": "Visualització prèvia",
    "loadLabel": "Carrega",
    "createLabel": "Crea",
    ...
    "errorFetchingPointLabel": "Error en recuperar el punt d'etiqueta. Torneu-ho a provar",
    "errorAddingPointLabel": "Error en afegir el punt d'etiqueta. Torneu-ho a provar"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Casella de selecció de Capa"
  },
  "statisticsType": {
    "countLabel": "Recompte",
    ...
    "expandCollapseAriaLabel": "Recompte de '${displayTitle}': '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Mode de creació d'entitats",
    "sketchToolTitle": "Esbosseu actius nous.",
    "selectToolTitle": "Copieu actius d'una entitat del mapa.",
    "downloadCSVBtnTitle": "Exporta l'informe",
    "templatePickerTitle": "Seleccioneu una plantilla per crear actius nous."
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Afegeix"
  },
  "copyFeatures": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Actualitza les equacions del projecte",
    "updateProjectCostSelectProjectTitle": "Seleccioneu tots els projectes",
    "updateButtonTextForm": "Actualitza",
    "updateProjectCostSuccess": "Les equacions de costos dels projectes seleccionats s'han actualitzat",
    "updateProjectCostError": "No es pot actualitzar l'equació de costos dels projectes seleccionats",
    "updateProjectNoProject": "No s'ha trobat cap projecte"
  }
});