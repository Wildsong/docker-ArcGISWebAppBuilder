...
///////////////////////////////////////////////////////////////////////////
define({
  "_widgetLabel": "การวิเคราะห์ต้นทุน",
  ...
  "createLoadProject": {
    ...
    "viewInMapLabel": "ภาพตัวอย่าง",
    "loadLabel": "โหลด",
    "createLabel": "สร้าง",
    "deleteProjectConfirmationMsg": "คุณแน่ใจหรือว่าต้องการลบโครงการ",
    "noAssetsToViewOnMap": "โปรเจคที่เลือกไม่มีแอสเซ็ทใดๆ ให้ดูบนแผนที่",
    ...
    "errorFetchingPointLabel": "เกิดข้อผิดพลาดขณะดึงข้อมูลจุดป้ายกำกับ กรุณาลองอีกครั้ง",
    "errorAddingPointLabel": "เกิดข้อผิดพลาดขณะเพิ่มจุดป้ายกำกับ กรุณาลองอีกครั้ง"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "ช่องทำเครื่องหมายชั้นข้อมูล"
  },
  "statisticsType": {
    "countLabel": "นับ",
    "averageLabel": "เฉลี่ย",
    ...
    "areaLabel": "พื้นที่",
    "lengthLabel": "ความยาว",
    "expandCollapseAriaLabel": "'${displayTitle}' จำนวน '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "โหมดสร้างฟีเจอร์",
    "sketchToolTitle": "วาดแอสเซ็ทใหม่",
    "selectToolTitle": "คัดลอกแอสเซ็ทจากฟีเจอร์ที่มีอยู่ในแผนที่",
    "downloadCSVBtnTitle": "ส่งออกรายงาน",
    "templatePickerTitle": "เลือกเทมเพลตเพื่อสร้างแอสเซ็ทใหม่:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "เพิ่ม"
  },
  "copyFeatures": {
    "title": "คัดลอกฟีเจอร์",
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "อัปเดตสมการโปรเจค",
    "updateProjectCostSelectProjectTitle": "เลือกโปรเจคทั้งหมด",
    "updateButtonTextForm": "อัปเดต",
    "updateProjectCostSuccess": "สมการต้นทุนของโปรเจคที่เลือก",
    "updateProjectCostError": "ไม่สามารถสมการต้นทุนของโปรเจคที่เลือกได้",
    "updateProjectNoProject": "ไม่พบโปรเจค"
  }
});