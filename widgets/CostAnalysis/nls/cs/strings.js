...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Během získávání definičního bodu došlo k chybě. Zkuste to prosím znovu",
    "errorAddingPointLabel": "Během přidávání definičního bodu došlo k chybě. Zkuste to prosím znovu"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Zaškrtávací políčko vrstvy"
  },
  "statisticsType": {
    "countLabel": "Počet",
    "averageLabel": "Průměr",
    ...
    "areaLabel": "Plocha",
    "lengthLabel": "Délka",
    "expandCollapseAriaLabel": "'${displayTitle}' s '${featureCount}'"
  },
  "costingInfo": {
    "noEditableLayersAvailable": "U vrstev je nutné na kartě nastavení vrstvy zaškrtnout možnost editace"
  },
  "workBench": {
    "refresh": "Obnovit",
    ...
    "featureModeText": "Režim vytváření prvků",
    "sketchToolTitle": "Vytvořit skicu nových prostředků",
    "selectToolTitle": "Kopírovat prostředky ze stávajícího prvku na mapě.",
    "downloadCSVBtnTitle": "Exportovat zprávu",
    "templatePickerTitle": "Zvolte šablonu, podle které chcete vytvářet prostředky:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Přidat"
  },
  "copyFeatures": {
    ...
    "selectFeatureToCopyMessage": "Vybere prvky ke zkopírování.",
    "copyFeatureUpdateGeometryError": "Nelze aktualizovat geometrii vybraných prvků"
  },
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Aktualizovat rovnice projektu",
    "updateProjectCostSelectProjectTitle": "Vybrat všechny projekty",
    "updateButtonTextForm": "Aktualizovat",
    "updateProjectCostSuccess": "Nákladové rovnice vybraných projektů jsou aktualizovány",
    "updateProjectCostError": "Nebylo možné aktualizovat nákladovou rovnici vybraných projektů",
    "updateProjectNoProject": "Nebyl nalezen žádný projekt"
  }
});