define({
  ...
  "checkBoxLabel": "Vis rutenett når miniprogrammet er lukket",
  "checkBoxLabelDashboard": "Vis rutenett",
  "gzd": "ID for rutenettsone (GZD)",
  "gsid": "${number} meter identifisering av rutenettrute (GSID)",
  "grid10k": "${number} meter rutenettlinjer",
  "grid1k": "${number} meter rutenettlinjer",
