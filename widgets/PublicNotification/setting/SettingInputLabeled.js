...
define([
  ...
  return declare(SettingObject, {
    ...
    constructor: function (name, constrainToNumbers, widthClass, leftColWidthClass, rightColWidthClass,
      label, placeholder, hint, prefixDiv, suffixDiv, numberConstraints, disabled) {
      /*jshint unused:false*/
      ...
      if (prefixDiv || suffixDiv) {
        ...
        subcomponent = constrainToNumbers ?
          ...
          settingComponents.textInputCtl('variable-width inline-block', placeholder, disabled);
        ...
        subcomponent = constrainToNumbers ?
          ...
          settingComponents.textInputCtl('full-width inline-block', placeholder, disabled);
