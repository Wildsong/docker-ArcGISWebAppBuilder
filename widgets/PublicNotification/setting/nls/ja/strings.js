...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "ユーザーが選択した宛先レイヤーで最終的な選択を確認できるようにします"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "列タイトルの追加 (CSV の場合のみ)",
    "zoomScale": "ズーム縮尺",
    "reviewCheckboxLabel": "ウィジェットに確認ボタンを表示"
  },
  "buttons": {
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "少なくとも 1 つの検索ソースを構成してください",
    "noSearchSourceFeaureLayerConfigured": "選択描画ツールを使用するために、検索ソースとして少なくとも 1 つのフィーチャ レイヤーを構成してください。"
  },
  "querySourceSetting": {
    ...
    "locatorError": "ロケーターは一行の位置検索をサポートする必要があります。"
  }
});