...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Permet que els usuaris revisin la selecció final a la capa de destinatari seleccionada"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Afegiu el títol de la columna (només per a CSV)",
    "zoomScale": "Escala de zoom",
    "reviewCheckboxLabel": "Mostra el botó de revisió al widget"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Valors separats per comes (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Configureu com a mínim un origen de cerca",
    "noSearchSourceFeaureLayerConfigured": "Configureu com a mínim una capa d'entitats com a font de cerca per fer servir eines de dibuix de selecció."
  },
  "querySourceSetting": {
    ...
    "locatorError": "El localitzador ha d'admetre la localització d'una línia única."
  }
});