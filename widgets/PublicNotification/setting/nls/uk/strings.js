...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Дозволити користувачам переглядати остаточний вибір шару вибраних адресатів"
  },
  "propertyLabels": {
    ...
    "reviewCheckboxLabel": "Показати кнопку «Перегляд» у віджеті"
  },
  "buttons": {
  ...
  "problems": {
    ...
    "noSearchSourceFeaureLayerConfigured": "Налаштуйте щонайменше один шар об'єкту як джерело пошуку для використання інструментів малювання"
  },
  "querySourceSetting": {
