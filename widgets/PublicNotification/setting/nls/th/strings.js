...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "อนุญาตให้ผู้ตรวจสอบสอบการเลือกขั้นสุดท้ายบนชั้นข้อมูลที่อยู่ที่เลือก"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "เพิ่มชื่อคอลัมน์ (สำหรับ CSV เท่านั้น",
    "zoomScale": "การย่อ / ขยาย มาตราส่วน",
    "reviewCheckboxLabel": "แสดงปุ่มตรวจสอบในวิดเจ็ต"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "ค่าที่คั่นด้วยจุลภาค (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "โปรดกำหนดค่าอย่างน้อยหนึ่งแหล่งข้อมูลการค้นหา",
    "noSearchSourceFeaureLayerConfigured": "โปรดกำหนดค่าอย่างน้อยหนึ่งชั้นข้อมูลฟีเจอร์เป็นแหล่งที่มาการค้นหาเพื่อใช้งานเครื่องมือวาดภาพรายการที่เลือก"
  },
  "querySourceSetting": {
    "sourceSetting": "การตั้งค่าแหล่งการค้นหา",
    "instruction": "เพิ่มและกำหนดค่าบริการรหัสพิกัดทางภูมิศาสตร์ หรือชั้นข้อมูลฟีเจอร์ เป็นแหล่งการค้นหา แหล่งที่ระบุเหล่านี้ จะเป็นตัวกำหนดสิ่งที่สามารถค้นหาได้ภายในช่องค้นหา",
    "add": "เพิ่มแหล่งค้นหา",
    "addGeocoder": "เพิ่มพิกัดทางภูมิศาสตร์",
    "geocoder": "ตัวเข้ารหัสพิกัดทางภูมิศาสตร์",
    ...
    "zoomScale": "การย่อ / ขยาย มาตราส่วน",
    "locatorUrl": "URL พิกัดทางภูมิศาสตร์",
    "locatorName": "ชื่อพิกัดทางภูมิศาสตร์",
    ...
    "locatorError": "ตัวระบุตำแหน่งต้องรองรับการการระบุตำแหน่งเส้นเดียว"
  }
});