...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Ger användarna möjlighet att granska det slutgiltiga valet på det valda mottagarlagret"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Lägg till kolumnrubrik (endast för CSV)",
    "zoomScale": "Zoomningsskala",
    "reviewCheckboxLabel": "Visa granskningsknappen i widgeten"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Kommaavgränsade värden (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Konfigurera minst en sökkälla",
    "noSearchSourceFeaureLayerConfigured": "Konfigurera minst ett geoobjektlager som en sökkälla för att använda ritverktyg för markering"
  },
  "querySourceSetting": {
    "sourceSetting": "Sök källinställningar",
    "instruction": "Lägg till och konfigurera geokodtjänster eller geoobjektlager som sökkällor. Dessa angivna källor avgör vad som är sökbart i sökrutan.",
    ...
    "locatorError": "Lokaliseringsfilen måste stödja enradssökning."
  }
});