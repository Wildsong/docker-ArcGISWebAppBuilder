...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin, Evented], {
    baseClass: 'jimu-widget-screening-search-source-settings',
    ...
    /**
     * This function is to load configuration
     * @param{object} contains config
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * This function is to set configured values to respective components
     * @param{object} contains config
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * Set value of placeholder on blur
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * on row delete from source list table
     * @param{node} contains table row
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * on row selection of source list table
     * @param{node} contains table row
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * Set related configuration to widget configuration
     * @param{node} contains table row
     * @param{object} contains table source
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * Get related configuration from widget configuration
     * @param{node} contains table row
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * Remove related configuration from widget configuration
     * @param{node} contains table row
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * Create new locator source setting from menu item
     * @param{object} contains setting
     * @param{string} contains definition
     * @memberOf Screening/setting/SearchSourceSettings
     */
    _createNewLocatorSourceSettingFromMenuItem: function (setting, definition) {
      var locatorSetting = new LocatorSourceSetting({
        nls: lang.mixin(this.nls.searchSourceSetting, window.jimuNls.units),
        map: this.map
      });
    ...
    /**
     * Create new locator source setting from Source List
     * @param{object} contains setting
     * @param{string} contains definition
     * @param{node} contains relatedTr
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * Create new query source setting from menu item
     * @param{object} contains setting
     * @param{string} contains definition
     * @memberOf Screening/setting/SearchSourceSettings
     */
    ...
    /**
     * Create new query source setting from source list
     * @param{object} contains setting
     * @param{string} contains definition
     * @param{node} contains relatedTr
     * @memberOf Screening/setting/SearchSourceSettings
