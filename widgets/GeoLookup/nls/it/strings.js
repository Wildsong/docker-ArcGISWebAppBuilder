define({
  ...
  "description": "Accedere o trascinare un foglio di calcolo <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'> </a> qui per visualizzare e aggiungere dati mappa.",
  ...
  "projectionChoice": "In CSV",
  "projectionLat": "Lat/Lon",
  "projectionMap": "Proiezione mappa",
  "messages": "Messaggi",
  "error": {
    ...
    "invalidCoord": "Campi di posizione non validi. Controllare il file CSV.",
    "tooManyRecords": "Spiacenti, non più di ${0} record a questo punto.",
    "CSVNoRecords": "Il file non contiene alcun record.",
    "CSVEmptyFile": "Nessun contenuto nel file."
  },
  "results": {
