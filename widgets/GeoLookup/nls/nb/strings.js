define({
  ...
  "description": "Bla til eller dra et <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'> regneark</a> her for å visualisere, og legge til kartdata i det.",
  ...
  "projectionChoice": "CSV inn",
  "projectionLat": "Bredde/lengde",
  "projectionMap": "Kartprojeksjon",
  "messages": "Meldinger",
  "error": {
    ...
    "CSVNoRecords": "Filen inneholder ingen poster.",
    "CSVEmptyFile": "Ikke noe innhold i filen."
  },
  "results": {
