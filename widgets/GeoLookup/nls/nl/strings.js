define({
  ...
  "description": "Navigeer naar of sleep hier een <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'> spreadsheet </a> naartoe om deze te visualiseren en er kaartgegevens aan toe te voegen.",
  ...
  "projectionLat": "Breedte-/lengtegraad",
  "projectionMap": "Kaartprojectie",
  "messages": "Berichten",
  "error": {
    ...
    "invalidCoord": "De locatievelden zijn ongeldig. Kijk het CSV-bestand na.",
    "tooManyRecords": "Het spijt ons, er zijn op dit moment slechts ${0} items.",
    "CSVNoRecords": "Het bestand bevat geen gegevens.",
    "CSVEmptyFile": "Geen content in het bestand."
  },
  "results": {
