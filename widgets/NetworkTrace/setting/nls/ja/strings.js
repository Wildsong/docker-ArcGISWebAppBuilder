define({
  ...
  "projectSetting": {
    "title": "プロジェクトの設定",
    "note": "注意: プロジェクトの設定はオプションです。構成すると、ユーザーがネットワーク停止エリアと入力パラメーターを使用してプロジェクトを目的の Web マップ レイヤーに格納できます。 ユーザーは [出力] タブから他の出力パラメーターを格納できます。",
  ...
  "inputOutputTab": {
    ...
    "summaryTextTitle": "入力タブに表示するテキストを指定"
  },
  "summaryTab": {
    "title": "出力",
    ...
    "summaryTextTitle": "出力タブに表示するサマリー テキストを指定",
    "addSummaryItemsTitle": "サマリー アイテムの追加"
  },
  ...
  "hintText": {
    ...
    "inputTextHint": "ヒント: [サマリー アイテムの追加] ボタンを使用して、以下に条件式を作成します。",
