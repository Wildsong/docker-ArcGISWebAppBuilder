...
define([
  ...
  function (Deferred, EsriQuery, QueryTask, LayerInfos, Point, Polyline, Polygon, Graphic, FeatureSet, FilterManager) {
    var mo = {};
    ...
    mo.getQueryDef = function (layers, isInWebmap, layerInfosObj, mode, defs) {
      ...
      if (layerId && isInWebmap) {
        ...
        if (layerUrl) {
          ...
          var filter = FilterManager.getInstance().getFilterExp(layerId);
