  ...
  function (declare,
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      _initRadioButtons: function () {
        this.own(on(this.rdoAddress, 'change', lang.hitch(this, this._rdoAddressChanged)));
        this.own(on(this.rdoCoordinates, 'change', lang.hitch(this, this._rdoCoordinateChanged)));

        this.rdoAddress.set('checked', this.useAddress);
        if (this.useAddress) {
          this.lastFocusNode = this.rdoAddress.focusNode;
        }
      ...
      _updateAltIndexes: function () {
        ...
        if (this.pageContainer && !this._coordinatesView && !this._addressView) {
          ...
          var isUseAddress = this.rdoAddress.get('checked');
      ...
      _rdoCoordinateChanged: function (v) {
        ...
        if (v) {
          this.lastFocusNode = this.rdoCoordinates.focusNode;
          this.parent.updateFirstLastNode(false);
        }
        this.parent._locationMappingComplete = false;
      },
