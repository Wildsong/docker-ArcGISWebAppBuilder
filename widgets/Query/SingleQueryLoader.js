    ...
    var SingleTaskClass = declare(null, {
      ...
      doQuery_SupportOrderByAndPagination: function(where, geometry){
        ...
        defCount.then(lang.hitch(this, function(allCount){
          ...
          this.currentAttrs.query.foundedNum = 0;//reset foundedNum
          ...
          def.then(lang.hitch(this, function(response){
            ...
            this.currentAttrs.query.nextIndex += recordCount;
            this.currentAttrs.query.foundedNum += features.length;
      ...
      onResultsScroll_SupportOrderByAndPagination: function(){
        ...
        var foundedNum = this.currentAttrs.query.foundedNum;
