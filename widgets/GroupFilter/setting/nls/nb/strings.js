define({
  ...
  "inputs": {
    ...
    "sameLayerAll": "Finn alle uttrykk",
    "simpleMode": "Start i enkel visning",
    "simpleModeTip": "Alternativ for å forenkle det konfigurerte miniprogram-grensesnittet. Når avmerkingsboksen er merket av, fjernes rullegardinlisten for operatorer og knappene for å legge til kriterier fra grensesnittet.",
    ...
    "webmapAppendModeTip": "Alternativ for å legge til filtersettet til et eksisterende webkartfilter",
    "persistOnClose": "Behold etter at miniprogrammet er lukket",
    "selectGroup": "Velg en gruppe som skal filtreres",
    "hideDropDown": "Skjul overskriften og filtervalget hvis kun 1 gruppe er konfigurert",
    "optionsMode": "Skjul alternativer for miniprogram",
    "optionsModeTip": "Alternativ for å vise flere miniprogram-innstillinger. Hvis avmerkingsboksen er merket av, fjernes muligheten til å lagre og laste definerte filtre og beholde filteret når miniprogrammet er lukket fra grensesnittet.",
    "optionOR": "ELLER",
    "optionAND": "OG",
    "optionEQUAL": "LIK",
    ...
    "optionLIKESPECIFIC": "INNEHOLDER BESTEMT(E) VERDI(ER)",
    "optionNOTLIKESPECIFIC": "INNEHOLDER IKKE BESTEMT(E) VERDI(ER)",
