define({
  ...
  "ChartSetting": {
    ...
    "lineDataSeriesField": "值欄位",
    "labelField": "標籤欄位",
    "lineLabelSeriesField": "順序欄位",
    "chartColor": "圖表顏色",
    "singleColor": "單一顏色",
    ...
    "errMsgFieldByValue": "請選擇「按欄位值分類的顏色」值",
    "errMsgDataSeriesField": "請選擇值欄位",
    "settingTabTitle": "設定",
    "layoutTabTitle": "版面配置",
    ...
    "setValueFields": "設定值欄位",
    "layoutSeriesLabel": "數列",
    "ThemeSelector": {
  ...
  "searchSourceSetting": {
    ...
    "maxSuggestionErrorMessage": "請輸入有效的最大建議值。 值超出範圍或無效。",
    "maxResultsErrorMessage": "請輸入有效的最大結果值。 值超出範圍或無效。",
    "zoomScaleErrorMessage": "請輸入有效的縮放比例值。 值超出範圍或無效。",
    "minScaleErrorMessage": "請輸入有效的最小比例值。 值超出範圍或無效。",
    "radiusErrorMessage": "請輸入有效的半徑值。 值超出範圍或無效。"
  }
});