define({
  ...
  "ChartSetting": {
    ...
    "errMsgFieldByValue": "Selecione a cor por valor de campo",
    "errMsgDataSeriesField": "Selecione um campo de campo",
  ...
  "searchSourceSetting": {
    ...
    "maxSuggestionErrorMessage": "Insira valor de sugestões máximas válido. O valor está fora do intervalo ou inválido.",
    "maxResultsErrorMessage": "Insira valor de resultados máximos válido. O valor está fora do intervalo ou inválido.",
    "zoomScaleErrorMessage": "Insira valor de escala de zoom válido. O valor está fora do intervalo ou inválido.",
    "minScaleErrorMessage": "Insira valor de escala mínimo válido. O valor está fora do intervalo ou inválido.",
    "radiusErrorMessage": "Insira valor de raio válido. O valor está fora do intervalo ou inválido."
  }
});