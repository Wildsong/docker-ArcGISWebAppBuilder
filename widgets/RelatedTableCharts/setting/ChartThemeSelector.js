  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    postCreate: function () {
      ...
      if (this.themes && this.themes.length > 0) {
        ...
        // Hide theme selector clicked anywhere in the body
    ...
    _createThemeList: function () {
      ...
      require(requireTheme, lang.hitch(this, function () {
        array.forEach(this.themes, lang.hitch(this, function (
          ...
          rowChart = domConstruct.create("div", {
            "class": "esriCTThemeChart"
          }, row);
          rowLabel = domConstruct.create("div", {
    ...
    **/
    _createChart: function (theme, chartContiner) {
      ...
      chart.setTheme(lang.getObject("dojox.charting.themes." + theme));
      chart.addPlot("default", {
        type: "Pie",
        radius: 11,
        labels: false,
        radGrad: dojox.gfx.renderer === "vml" ? "fan" : "native" // jshint ignore:line
      });
