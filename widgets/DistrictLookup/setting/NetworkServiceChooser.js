  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    postCreate: function () {
      ...
      this.own(on(routeSearch, 'change', lang.hitch(this, function () {
        ...
        if (this.organizationRadio && this.organizationRadio.get('checked')) {
    ...
    * @memberOf widgets/DistrictLookup/settings/NetworkServiceChooser
    */
    ...
    */
    ...
    /**
    * This function used for calculation valid rout URL
    * @memberOf widgets/DistrictLookup/settings/NetworkServiceChooser
    */
