...
define([
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    postCreate: function () {
      ...
      //Create checkbox to group filters by layer name
      this.cbxExpandFiltersOnLoad = new CheckBox({
        'class': "esriCTFilterLabel",
        'label': this.nls.filterSetting.expandFiltersOnLoad || ""
      });
      this.cbxExpandFiltersOnLoad.placeAt(this.cbxExpandFiltersOnLoadNode);
      this.cbxExpandFiltersOnLoad.setValue(false);
      if (this.config) {
    ...
    setConfig: function (config) {
      ...
      if (config.hasOwnProperty('filterSettings')) {
        ...
        if (config.filterSettings.hasOwnProperty('expandFiltersOnLoad')) {
          this.cbxExpandFiltersOnLoad.setValue(config.filterSettings.expandFiltersOnLoad);
        }
    ...
    getConfig: function () {
      ...
      var config = {
        ...
        expandFiltersOnLoad: this.cbxExpandFiltersOnLoad.getValue(),
        filters: []
      };
