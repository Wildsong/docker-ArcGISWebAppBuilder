define({
  ...
  "noFilterTip": "Uten definert filteruttrykk viser denne spørringsoppgaven alle geoobjekter i den angitte datakilden.",
  ...
  "errors": {
    "layerNotFound": "Finner ikke laget ${0} med ID-en ${1} i kartet. Kartet kan ha blitt endret etter miniprogrammets godkjenning.",
