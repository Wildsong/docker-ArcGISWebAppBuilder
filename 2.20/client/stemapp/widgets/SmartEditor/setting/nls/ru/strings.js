define({
  "layersPage": {
    ...
    "buttonPositionsLabel": "Положение кнопок Сохранить, Удалить, Назад и Отмена",
    ...
    "autoSaveAttrUpdates": "Автоматически сохранять обновления атрибутов"
  },
  "editDescriptionPage": {
  ...
  "intersectionTolerance": {
    "intersectionTitle": "Допуск пересечения по умолчанию для всех объектов.",
    "pixelsToleranceTitle": "Допуск пересечения по умолчанию (значение пиксела) применяется только для точечных объектов."
  },
  "smartActionsPage": {
