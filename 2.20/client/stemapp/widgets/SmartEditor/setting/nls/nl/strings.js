define({
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Opmerking: velden van deze laag worden gebruikt om de expressiecriteria te definiëren. 'Lagen en velden om op toe te passen' toont alleen kaartlagen en tabellen waarvan de velden gedefinieerd zijn in de Expressie.",
  ...
  "attributeActionsPage": {
    ...
    "deleteGroupPopupMsg": "Als de groep wordt verwijderd, wordt de attribuutactie verwijderd uit alle geassocieerde velden.",
  ...
  "relativeDomains": {
    ...
    "selectedDomainFieldsHint": "Geselecteerde domeinveld(en): ${domainFields}",
