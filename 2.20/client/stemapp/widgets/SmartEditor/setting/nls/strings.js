define({
  root: ({
    ...
    smartActionsPage: {
      ...
      layerForExpressionNote: "Note: This layer's fields are used to define the expression criteria. 'Layers and fields to apply on' only displays layers and tables which have the field-s defined in the Expression.",
    ...
    attributeActionsPage: {
      ...
      deleteGroupPopupMsg: "Deleting group will result in removing the attribute action from all the associated Field(s).",
