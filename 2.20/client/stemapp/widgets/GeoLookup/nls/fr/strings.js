define({
  ...
  "description": "Accédez à une <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Téléchargez une feuille d’exemple' target='_blank'> feuille de calcul</a> ou faites-la glisser ici pour la visualiser et y ajouter des données cartographiques..",
  ...
  "downloadResults": "Télécharger",
  "plotOnly": "Tracer uniquement les points",
  "plottingRows": "Traçage des lignes",
  "projectionChoice": "CSV en",
  "projectionLat": "Lat/Lon",
  "projectionMap": "Projection cartographique",
  "messages": "Messages",
  "error": {
    "fetchingCSV": "Erreur de récupération des éléments depuis le stockage CSV : ${0}",
    "fileIssue": "Le fichier n'a pas pu être traité.",
    "notCSVFile": "Seuls les fichiers dont les valeurs sont délimitées par des virgules (.csv) sont actuellement pris en charge.",
    "invalidCoord": "Les champs de localisation ne sont pas valides. Vérifiez le fichier CSV.",
    "tooManyRecords": "Vous ne pouvez actuellement pas entrer plus de ${0} enregistrements.",
    "CSVNoRecords": "Le fichier ne contient pas d’enregistrements.",
    "CSVEmptyFile": "Aucun contenu dans le fichier."
  },
  "results": {
