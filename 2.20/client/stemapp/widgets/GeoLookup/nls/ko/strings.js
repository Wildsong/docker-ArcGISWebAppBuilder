define({
  "_widgetLabel": "지오룩업",
  "description": "<a href='./widgets/GeoLookup/data/sample.csv' tooltip='예시 시트 다운로드' target='_blank'>스프레드시트</a>로 이동하거나 여기로 드래그하여 맵 데이터를 시각화하고 추가할 수 있습니다.",
  "selectCSV": "CSV 선택",
  ...
  "error": {
    ...
    "notCSVFile": "지금은 CSV 파일만 지원됩니다.",
    "invalidCoord": "위치 필드가 유효하지 않습니다. CSV 파일을 확인하세요.",
    "tooManyRecords": "죄송합니다. 현재 ${0}개를 초과하는 레코드는 허용되지 않습니다.",
    "CSVNoRecords": "파일에 레코드가 포함되어 있지 않습니다.",
    "CSVEmptyFile": "파일에 콘텐츠가 없습니다."
  },
  "results": {
