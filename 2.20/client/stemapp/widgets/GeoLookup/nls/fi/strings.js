define({
  ...
  "description": "Siirry selaamalla tai vedä <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Lataa esimerkkitaulukko' target='_blank'>laskentataulukko</a> tähän kartta-aineiston visualisointia ja laskentataulukkoon liittämistä varten.",
  ...
  "projectionChoice": "CSV kohteessa",
  "projectionLat": "Lev/pit",
  "projectionMap": "Karttaprojektio",
  "messages": "Viestit",
  "error": {
    ...
    "invalidCoord": "Paikanninkentät eivät kelpaa. Tarkista CSV-tiedosto.",
    "tooManyRecords": "Tietueiden enimmäismäärä on tällä hetkellä ${0}.",
    "CSVNoRecords": "Tiedosto ei sisällä yhtään tietuetta.",
    "CSVEmptyFile": "Tiedosto ei sisällä mitään."
  },
  "results": {
