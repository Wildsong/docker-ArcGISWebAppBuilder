define({
  ...
  "description": "Duyệt đến hoặc Kéo một bảng tính <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'></a> vào đây để hiển thị và thêm dữ liệu bản đồ vào đó.",
  ...
  "error": {
    ...
    "invalidCoord": "Các trường vị trí không hợp lệ. Vui lòng kiểm tra tệp CSV.",
    "tooManyRecords": "Rất tiếc, hiện không được có nhiều hơn ${0} bản ghi.",
