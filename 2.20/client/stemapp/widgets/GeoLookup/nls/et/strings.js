define({
  ...
  "description": "Sirvi või lohista <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'> tabel </a> siia, et seda vaadata ja sellele kaardiandmeid lisada.",
  ...
  "projectionChoice": "CSV asukohas",
  "projectionLat": "Laius/pikkus",
  "projectionMap": "Kaardiprojektsioon",
  "messages": "Sõnumid",
  "error": {
    ...
    "invalidCoord": "Asukoha väljad on valed. Kontrollige CSV-faili.",
    "tooManyRecords": "Praegu saab kasutada kuni ${0} kirjet.",
    "CSVNoRecords": "Fail ei sisalda ühtki kirjet.",
    "CSVEmptyFile": "Failis pole sisu."
  },
  "results": {
