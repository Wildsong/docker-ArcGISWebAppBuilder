...
function(declare,
  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    startup : function() {
      ...
      this.tableLayerInfos.innerHTML = utils.sanitizeHTML(preloadString);
      this.layerList = [];
    ...
    saveAdv : function() {
      var val;
      var valSpl;
      val = utils.sanitizeHTML(this.advSettingsLatValues.get('value'));
      valSpl = val.split('\n');
      ...
      val = utils.sanitizeHTML(this.advSettingsLongValues.get('value'));
      valSpl = val.split('\n');
      ...
      this.config.intersectField = utils.sanitizeHTML(this.advSettingsIntersectField.get('value'));
      this.config.valueIn = utils.sanitizeHTML(this.advSettingsIntersectInValue.get('value'));
      this.config.valueOut = utils.sanitizeHTML(this.advSettingsIntersectOutValue.get('value'));
      this.config.cacheNumber = utils.sanitizeHTML(this.advSettingsCacheNumber.get('value'));
      this.config.maxRowCount = utils.sanitizeHTML(this.advSettingsMaxRowCount.get('value'));
      this.config.geometryServiceURL = utils.sanitizeHTML(this.advSettingsGeometryService.get('value'));
      this.advSettingsPage.hide();
    },
    ...
    showAdvSettings : function() {
      ...
      if(typeof(this.config.geometryServiceURL) !== 'undefined') {
        this.advSettingsGeometryService.set('value', this.config.geometryServiceURL);
      } else {
        this.advSettingsGeometryService.set('value', "https://utility.arcgisonline.com/ArcGIS/rest/services/Geometry/GeometryServer");
      }
    ...
    showOKError : function() {
      this.btnErrorMsg.innerHTML = utils.sanitizeHTML(this.nls.errorOnOk);
