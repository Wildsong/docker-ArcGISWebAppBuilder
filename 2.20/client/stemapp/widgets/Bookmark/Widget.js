...
define([
  ...
  function (declare, lang, array, html, BaseWidget, query, on, Deferred,
    ...
    var clazz = declare([BaseWidget], {
      ...
      _onDelete: function (obj) {
        var bookmarks = obj.bookmarks,
          nextBookmark = obj.nextBookmark;

        this.onBookmarksChange(bookmarks);

        this.a11y_initFocusNodes();
        this.a11y_focusAfterDelete(nextBookmark);//focus for 508
      },
