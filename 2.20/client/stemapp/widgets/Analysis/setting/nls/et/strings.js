define({
  ...
  "saveAsFeatureService": "Salvesta tulemus kasutajâa kontos",
  ...
  "createViewshedUsage": "Loob alad, mis onTeie määratud asukohtadest nähtavad.",
  ...
  "findCentroids": "Otsi tsentroidi",
  "findCentroidsUsage": "Otsib sisendi igale mitmikpunkt-, joon- või pindobjektile esindusliku keskme (tsentroidi).",
  ...
  "findPointClusters": "Otsi punktklastreid",
  "findPointClustersUsage": "See tööriist leiab alad, kus punktid on kontsentreeritud ja kus neid eraldavad tühjad või hõredad alad.",
  ...
  "geocodeLocations": "Geokodeeri asukohad tabelist",
  "geocodeLocationsUsage": "Käepärane viis, kuidas suured aadressitabelid ja -failid punktideks geokodeerida.",
  ...
  "summarizeCenterAndDispersion": "Keskmise ja dispersiooni summeerimine",
  "summarizeCenterAndDispersionUsage": "Kasutage punktobjekte, et arvutada keskme objekt, keskmine kese, mediaani kese või ellips (jaotus).",
  ...
  "joinFeatures": "Ühenda objektid",
  "joinFeaturesUsage": "Tööriist liida objektid kannab ruumiliste või atribuutide seoste põhjal ühe kihi või tabeli atribuudid üle teise kihti või tabelisse. Võimalik on arvutada liidetud objektide statistika.",
  "includeRouteLayer": "Kaasa marsruudikihid",
  "findOutliers": "Otsi võõrväärtusi",
  "findOutliersUsage": "Võõrväärtuste otsimise tööriistaga saab määrata, kas andmete ruumimustris on statistiliselt olulisi võõrväärtusi."
});