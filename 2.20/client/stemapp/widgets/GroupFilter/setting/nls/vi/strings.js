define({
  ...
  "inputs": {
    ...
    "sameLayerAll": "Trùng khớp tất cả biểu thức",
    ...
    "webmapAppendModeTip": "Tùy chọn để thêm tập hợp bộ lọc vào bộ lọc bản đồ web hiện tại.",
    "persistOnClose": "Tiếp tục Sau khi Đóng Tiện ích",
    "selectGroup": "Chọn Nhóm để Lọc",
    "hideDropDown": "Ẩn phần tiêu đề và lựa chọn bộ lọc nếu chỉ có 1 nhóm được cấu hình",
    ...
    "optionLIKE": "CHỨA",
    "optionLIKESPECIFIC": "CHỨA GIÁ TRỊ CỤ THỂ",
    "optionNOTLIKESPECIFIC": "KHÔNG CHỨA GIÁ TRỊ CỤ THỂ",
