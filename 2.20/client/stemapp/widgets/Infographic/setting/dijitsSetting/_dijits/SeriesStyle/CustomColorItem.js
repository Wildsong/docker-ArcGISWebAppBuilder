    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      setConfig: function(config) {
        ...
        if (typeof config.text !== 'undefined') {
          this.textDiv.innerHTML = jimuUtils.sanitizeHTML(config.text);
          this.textDiv.title = config.text;
        }
        if (typeof config.label !== 'undefined') {
          this.labelDiv.innerHTML = jimuUtils.sanitizeHTML(config.label);
      ...
      _onEditInputBlured: function() {
        ...
        if (this.labelDiv.innerHTML !== text) {
          this.labelDiv.innerHTML = jimuUtils.sanitizeHTML(text);
          this.onChange();
        }
      },
