...
define({
  ...
  "parcelLineLayer": {
    "selectLayerLabel": "เลือกชั้นข้อมูลเส้นที่เกี่ยวข้อง",
    "layerSettingTabLabel": "ชั้นข้อมูลแปลงที่ดิน",
    "attributeSettingTabLabel": "การตั้งค่าแอตทริบิวต์",
    "advancedSettingTabLabel": "การตั้งค่าระดับสูง",
    ...
    "startOrRotationSymbolLabel": "สัญลักษณ์จุดเริ่มและหมุน",
    "startOrRotationSymbolHintText": "เคล็ดลับ: ใช้เพื่อแสดงสัญลักษณ์จุดเริ่มและหมุน",
    "symbolPickerPreviewText": "ภาพตัวอย่าง",
    "selectLineLayerLabel": "เลือกชั้นข้อมูลเส้น"
  },
  "parcelPolygonLayer": {
    "selectPolygonLayerLabel": "เลือกชั้นข้อมูลโพลีกอน",
    "selectPolygonLayerHintText": "คำแนะนำ: ใช้ชั้นข้อมูลแปลงที่ดินที่เลือก",
    "selectFieldLegendLabel": "เลือกฟิลด์ที่จะจัดเก็บข้อมูลเรขาคณิตพิกัด",
    ...
    "selectPolygonLayerLabelPopUp": "เลือกชั้นข้อมูลโพลีกอน",
    "honorSettingRbLabel": "การตั้งค่าป็อปอัพเว็บแมป",
    "customSettingsRbLabel": "การตั้งค่าที่กำหนดเอง",
    "display": "แสดงผล",
    "edit": "แก้ไข",
    "editpageName": "ชื่อ",
    "actions": "การดำเนินการ",
    "editpageAlias": "ชื่อย่อ",
    "titleLabel": "ชื่อของส่วน"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "โปรดเลือกฟิลด์เฉพาะสำหรับแต่ละข้อมูลเรขาคณิตพิกัด"
  }
});