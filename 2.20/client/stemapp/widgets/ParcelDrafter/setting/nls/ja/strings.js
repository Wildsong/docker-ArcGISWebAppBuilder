...
define({
  ...
  "parcelLineLayer": {
    ...
    "startOrRotationSymbolLabel": "開始および回転ポイント シンボル",
    "startOrRotationSymbolHintText": "ヒント: 開始および回転ポイント シンボルの表示に使用されます。",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "座標のジオメトリ情報を格納するフィールドを選択します",
    ...
    "honorSettingRbLabel": "Web マップ ポップアップの設定",
    "customSettingsRbLabel": "カスタム設定",
    "display": "ディスプレイ",
    "edit": "編集",
    "editpageName": "名前",
    "actions": "アクション",
    "editpageAlias": "エイリアス",
    "titleLabel": "セクション タイトル"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "座標のジオメトリ情報ごとに個別のフィールドを選択してください。"
  }
});