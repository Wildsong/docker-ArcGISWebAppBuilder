...
define({
  ...
  "parcelLineLayer": {
    ...
    "attributeSettingTabLabel": "Attributinställningar",
    ...
    "startOrRotationSymbolLabel": "Symbol för start- och rotationspunkt",
    "startOrRotationSymbolHintText": "Tips: Används för att visa start- och rotationspunktssymbolen.",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "Välj fält för lagring av koordinatgeometriinformation",
    ...
    "honorSettingRbLabel": "Inställningar för webbkartans popupfönster",
    "customSettingsRbLabel": "Anpassade inställningar",
    "display": "Visa",
    "edit": "Redigera",
    "editpageName": "Namn",
    "actions": "Åtgärder",
    "editpageAlias": "Alias",
    "titleLabel": "Avsnittsrubrik"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "Välj distinkt fält för varje koordinatgeometriinformation."
  }
});