...
define({
  ...
  "selectLabel": "Chọn",
  "selectLayerLabel": "Chọn Lớp Lô thửa",
  ...
  "parcelLineLayer": {
    ...
    "layerSettingTabLabel": "Lớp Lô thửa",
    "attributeSettingTabLabel": "Cài đặt Thuộc tính",
    ...
    "startOrRotationSymbolLabel": "Ký hiệu Điểm bắt đầu và Điểm xoay",
    "startOrRotationSymbolHintText": "Gợi ý: Được dùng để hiển thị ký hiệu cho điểm bắt đầu và điểm xoay.",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "Chọn các trường để lưu trữ thông tin hình học tọa độ",
    ...
    "selectPolygonLayerLabelPopUp": "Chọn một Lớp Đa giác",
    "honorSettingRbLabel": "Cài đặt Popup bản đồ Web",
    "customSettingsRbLabel": "Thiết lập Tùy chỉnh",
    "display": "Hiển thị",
    "edit": "Chỉnh sửa",
    "editpageName": "Tên",
    "actions": "Các hành động",
    "editpageAlias": "Bí danh",
    "titleLabel": "Tiêu đề phần"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "Vui lòng chọn trường riêng biệt cho mỗi thông tin hình học tọa độ."
  }
});