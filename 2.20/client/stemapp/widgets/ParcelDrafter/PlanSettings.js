  ...
  function (
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
      ...
      startup: function () {
        ...
        if (!storedSettings) {
          storedSettings = {
            areaUnits: this.planSettingsOptions.areaUnits[1],
            ...
            distanceAndLengthUnits: this.planSettingsOptions.distanceAndLengthUnits[1]
          };
        }
      ...
      **/
      ...
      /**
      * This function used to set last focus node in plansettings page
      * code for accessibility
      * @memberOf widgets/ParcelDrafter/PlanSettings
      **/
      updateLastNodeInPlanSetting : function() {
        jimuUtils.initLastFocusNode(this.widgetDomNode, this.circularCurveParameters.domNode);
      }
    });
  });