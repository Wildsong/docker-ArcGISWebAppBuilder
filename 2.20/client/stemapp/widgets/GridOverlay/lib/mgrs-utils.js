...
define([
  ...
  return {
    ...
    handleZonePolygon: function (visibleGridZone, grid) {
      ...
      // Always show center labels in case of zones irrespective of scale
      grid._labelGraphics.push(visibleGridZone.getCenterLabel(true));
      return;
    },
