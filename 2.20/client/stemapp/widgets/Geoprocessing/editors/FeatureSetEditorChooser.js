...
function(declare, lang, html, on, template, _TemplatedMixin, _WidgetsInTemplateMixin,
  ...
  return declare([BaseEditor, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    postCreate: function(){
      ...
      this.layerOptionCheckbox = new CheckBox({
        checked: this.param.featureSetMode === 'layers' && this.param.useFeatureCollection,
        label: this.nls.useFeatureCollection,
        onChange: lang.hitch(this, this._layerOptionChanged)
      });
      this.layerOptionCheckbox.placeAt(this.layerOptionCheckboxDiv);
    ...
    getValue: function(){
      ...
      if(this.value.featureSetMode === 'layers'){
        this.value.useFeatureCollection = this.layerOptionCheckbox.getValue();
      }
      return this.value;
    },
    ...
    _onMapModeSelect: function(){
      ...
      html.setStyle(this.layerOptionSection, 'display', 'none');
    ...
    _onLayersModeSelect: function(){
      html.setStyle(this.symbolChooserSection, 'display', 'none');
      html.setStyle(this.urlOptionsDiv, 'display', 'none');
      html.setStyle(this.layerOptionSection, 'display', '');
