define({
  ...
  "ChartSetting": {
    ...
    "lineDataSeriesField": "Kolom nilai",
    "labelField": "Kolom label",
    "lineLabelSeriesField": "Kolom urutan",
    ...
    "errMsgFieldByValue": "Harap pilih warna menurut nilai kolom",
    "errMsgDataSeriesField": "Harap pilih kolom nilai",
    ...
    "setValueFields": "Atur Kolom Nilai",
    "layoutSeriesLabel": "Rangkaian",
    "ThemeSelector": {
  ...
  "searchSourceSetting": {
    ...
    "maxSuggestionErrorMessage": "Harap masukkan nilai saran maksimal. Nilainya berada di luar rentang atau tidak valid.",
    "maxResultsErrorMessage": "Harap masukkan nilai hasil maksimal. Nilainya berada di luar rentang atau tidak valid.",
    "zoomScaleErrorMessage": "Harap masukkan nilai skala zoom yang valid. Nilainya berada di luar rentang atau tidak valid.",
    "minScaleErrorMessage": "Harap masukkan nilai skala minimal yang valid. Nilainya berada di luar rentang atau tidak valid.",
    "radiusErrorMessage": "Harap masukkan nilai radius yang valid. Nilainya berada di luar rentang atau tidak valid."
  }
});