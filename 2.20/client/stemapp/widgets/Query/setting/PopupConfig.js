...
function(declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, template, lang, html, array, on,
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    postCreate:function(){
      ...
      this.own(on(this.portalRadio, 'change', lang.hitch(this, this._updateClassWhenRadioChanged)));
    ...
    onLayerChange: function(enableWebMapRadio){
      ...
      if(enableWebMapRadio){
        this.portalRadio.set('disabled', false);
      }else{
        this.portalRadio.set('disabled', true);
      }
      this._updateClassWhenRadioChanged();
    ...
    _setPopupInfoForUI: function(popupInfo){
      ...
      if(!this.portalRadio.disabled && popupInfo.readFromWebMap){
        this.customRadio.set('checked', false);
    ...
    _onBtnSetDisplayFieldsClicked: function(){
      var popup = new Popup({
        ...
        onClose: lang.hitch(this, function(){
          //reset current UI by previous config
          if(this.prevPortalFieldInfos){
            this._setCustomPopupInfoForUI(this.prevPortalFieldInfos);
          }
        ...
        buttons: [{
          ...
          onClick: lang.hitch(this, function(){
            ...
            this._updateDisplayFieldsTextBox(portalFieldInfos);
            this.prevPortalFieldInfos = null;
            popup.close();
          })
        }, {
      ...
      setTimeout(lang.hitch(this, function(){
        this.prevPortalFieldInfos = this._getPopupInfoByUI();
      }), 200);
    },
