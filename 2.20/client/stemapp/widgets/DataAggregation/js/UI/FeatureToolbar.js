    ...
    return declare([_WidgetBase, _TemplatedMixin, Evented], {
      ...
      _updateCancel: function (disabled) {
        ...
        if (this.cancelButton) {
          if (disabled) {
            domAttr.set(this.cancelButton, "tabindex", "-1");
          } else {
            domAttr.set(this.cancelButton, "tabindex", "0");
          }
        }
      },
      ...
      _updateLocate: function (disabled) {
        ...
        if (disabled) {
          domAttr.set(this.featureView.locateButton, "tabindex", "-1");
        } else {
          domAttr.set(this.featureView.locateButton, "tabindex", "0");
        }
      },
      ...
      _updateSync: function (disabled) {
        ...
        if (this.featureView.syncFields) {
          ...
          if (disabled) {
            domAttr.set(this.featureView.syncFields, "tabindex", "-1");
          } else {
            domAttr.set(this.featureView.syncFields, "tabindex", "0");
          }
        }
      },
