define({
  "page1": {
    ...
    "shapeTypeSelector": "Kattintson az engedélyezni kívánt eszközökre",
    "shapeType": {
      "point": "Pont",
      "line": "Vonal",
      "polyline": "Polyline",
  ...
  "page2": {
    ...
    "layersToolDesc": "Az első oldalon megadott kiválasztási módszer az alább felsorolt ​​rétegek kiválasztására és frissítésére lesz alkalmazva. Ha több réteget is bejelöl, csak a közös szerkeszthető mezők lesznek elérhetők a frissítéshez. A kiválasztási eszköztől függően további beállításokra is szükség lehet.",
    "layerTable": {
      "colUpdate": "Frissítés",
      "colLabel": "Réteg",
  ...
  "page3": {
    ...
    "commonFieldsDesc": "Csak a közös szerkeszthető mezők lesznek láthatók lent. Jelölje ki a frissíteni kívánt mezőket. Ha egy különböző rétegekből származó azonos mezőnek eltérő tartománya van, akkor csak egy tartomány kerül megjelenítésre és felhasználásra.",
  ...
  "errorOnOk": "Adja meg az összes paramétert a konfiguráció mentése előtt",
  "next": "Tovább",
  "back": "Vissza",
