...
define([
  ...
  return declare([BaseWidget], {
    ...
    _mainWidgetNode: null,

    //----------------------------------------------------------------------------------------------------------------//

    constructor: function(searchOptions, portalUrl, layerInfosObj, container, mainWidget) {
      this._mainWidgetNode = mainWidget;
    ...
    setFocus: function () {
      if (this._searchDijit) {
        ...
        this._mainWidgetNode.openAtStartAysn = true;
        if (jimuUtils.isAutoFocusFirstNodeWidget(this._mainWidgetNode)) {
