...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Memungkinkan pengguna untuk meninjau pilihan final pada layer penerima"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Tambahkan judul kolom (khusus untuk CSV)",
    "zoomScale": "Skala zoom",
    "reviewCheckboxLabel": "Tampilkan tombol tinjau di widget"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Nilai terpisah koma (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Konfigurasikan setidaknya satu sumber pencarian",
    "noSearchSourceFeaureLayerConfigured": "Harap konfigurasikan setidaknya satu feature layer sebagai sumber pencarian untuk menggunakan alat gambar pilihan"
  },
  "querySourceSetting": {
    "sourceSetting": "Pengaturan sumber pencarian",
    "instruction": "Tambah dan konfigurasikan layanan geocode atau feature layer sebagai sumber pencarian. Sumber yang ditentukan ini menentukan apa yang dapat dicari dalam kotak pencarian.",
    ...
    "locatorWarning": "Versi layanan geocoding ini tidak didukung. Widget mendukung layanan geocoding 10.1 dan di atasnya.",
    ...
    "panTo": "Geser hingga",
    "zoomToScale": "Perbesar/perkecil ke skala",
    "locatorError": "Penentu lokasi harus mendukung menetukan lokasi garis tunggal."
  }
});