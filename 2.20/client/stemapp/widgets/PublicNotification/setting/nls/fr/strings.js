...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Autoriser les utilisateurs à vérifier la sélection finale sur la couche de destinataires sélectionnée"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Ajouter un titre de colonne (pour CSV uniquement)",
    "zoomScale": "Echelle de zoom",
    "reviewCheckboxLabel": "Afficher le bouton de vérification dans le widget"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Valeurs séparées par des virgules (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Configurez au moins une source de recherche",
    "noSearchSourceFeaureLayerConfigured": "Configurez au moins une couche d’entités en tant que source de recherche pour l’utilisation des outils de dessin de sélection"
  },
  "querySourceSetting": {
    "sourceSetting": "Paramètres de source de recherche",
    "instruction": "Ajoutez et configurez des services de géocodage ou des couches d’entités en tant que sources de recherche. Ces sources spécifiées déterminent ce qui peut faire l’objet d’une recherche au sein de la zone de recherche.",
    ...
    "locatorError": "Le localisateur doit prendre en charge la localisation sur une seule ligne."
  }
});