...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "يسمح للمستخدمين بمراجعة التحديد النهائي بطبقة المرسل إليه المحددة"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "إضافة عنوان عمود (لملف CSV فقط)",
    "zoomScale": "تدرج التكبير/التصغير",
    "reviewCheckboxLabel": "عرض زر المراجعة في عنصر واجهة المستخدم"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "قيم مفصولة بفواصل (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "يرجى تكوين مصدر بحث واحد على الأقل",
    "noSearchSourceFeaureLayerConfigured": "يرجى تكوين طبقة معالم واحدة على الأقل كمصدر بحث لاستخدام أدوات رسم التحديد"
  },
  "querySourceSetting": {
    "sourceSetting": "البحث في إعدادات المصدر",
    "instruction": "إضافة خدمات الترميز الجغرافي أو طبقات المعالم وتكوينها كمصادر بحث. تُحدد المصادر المُحددة القابل للبحث ضمن مربع البحث.",
    ...
    "locatorError": "يجب على محدد المواقع دعم تحديد خط فردي."
  }
});