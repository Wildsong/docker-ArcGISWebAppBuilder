...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Επιτρέπει στους χρήστες να επανεξετάσουν την τελική επιλογή στο επιλεγμένο θεματικό επίπεδο αποδέκτη."
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Προσθήκη τίτλου στήλης (μόνο για CSV)",
    "zoomScale": "Εστίαση κλίμακας",
    "reviewCheckboxLabel": "Εμφάνιση κουμπιού ανασκόπησης στο widget"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Τιμές διαχωρισμένες με κόμματα (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Παραμετροποιήστε τουλάχιστον μία πηγή αναζήτησης.",
    "noSearchSourceFeaureLayerConfigured": "Παραμετροποιήστε τουλάχιστον ένα feature layer ως πηγή αναζήτησης για τη χρήση των εργαλείων σχεδίασης επιλογής."
  },
  "querySourceSetting": {
