...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Gebruikers toestaan om de uiteindelijke selectie te bekijken op de geselecteerde geadresseerdelaag"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Kolomtitel toevoegen (alleen voor CSV)",
    "zoomScale": "Schaal voor voor in-/uitzoomen",
    "reviewCheckboxLabel": "Controleknop weergeven in de widget"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Door komma's gescheiden waarden (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Configureer minimaal één zoekbron",
    "noSearchSourceFeaureLayerConfigured": "Configureer ten minste één objectlaag als zoekbron voor het gebruik van selectietekeninghulpmiddelen"
  },
  "querySourceSetting": {
    "sourceSetting": "Broninstellingen zoeken",
    "instruction": "Voeg geocodeerservices of objectlagen toe en configureer deze als zoekbronnen. Deze opgegeven bronnen bepalen wat doorzoekbaar is in het zoekvak.",
    ...
    "locatorError": "De locator moet de lokalisatie van één regel ondersteunen."
  }
});