...
define([
  ...
  return declare([BaseWidget, Evented, _WidgetsInTemplateMixin], {
    ...
    postCreate: function () {
      ...
      this._projectLayer = this.projectLayer || this.config.projectSettings.projectLayer || "";
    ...
    _addValidFields: function () {
      array.forEach(this.featureLayer.fields, lang.hitch(this, function (field) {
        ...
        if (field.type === "esriFieldTypeGUID") {
    ...
    _createAttributeSettingsFieldsTable: function () {
      var args, fields = [{
        ...
        name: 'Delete',
        title: this.nls.layerSettings.deleteColumnLabel,
        type: 'actions',
        actions: ['delete'],
        width: '20%'
      }];
