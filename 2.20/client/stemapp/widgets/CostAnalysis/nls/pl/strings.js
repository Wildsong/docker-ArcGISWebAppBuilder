...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Wystąpił błąd podczas pobierania punktu etykiety. Spróbuj ponownie",
    "errorAddingPointLabel": "Wystąpił błąd podczas dodawania punktu etykiety. Spróbuj ponownie"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Pole wyboru warstwy"
  },
  "statisticsType": {
    "countLabel": "Liczba",
    ...
    "lengthLabel": "Długość",
    "expandCollapseAriaLabel": "'${displayTitle}' z następującą liczbą obiektów: '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Tryb tworzenia obiektów",
    "sketchToolTitle": "Naszkicuj nowe zasoby.",
    "selectToolTitle": "Skopiuj zasoby z istniejącego obiektu na mapie.",
    "downloadCSVBtnTitle": "Eksportuj raport",
    "templatePickerTitle": "Wybierz szablon, aby utworzyć nowe zasoby:"
  },
  "assetDetails": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Aktualizuj równania projektu",
    "updateProjectCostSelectProjectTitle": "Wybierz wszystkie projekty",
    "updateButtonTextForm": "Aktualizuj",
    "updateProjectCostSuccess": "Równania kosztów wybranych projektów zostały zaktualizowane",
    "updateProjectCostError": "Nie można zaktualizować równań kosztów wybranych projektów",
    "updateProjectNoProject": "Nie znaleziono żadnego projektu"
  }
});