...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Erro ao buscar o ponto do rótulo. Tente novamente",
    "errorAddingPointLabel": "Erro ao adicionar o ponto do rótulo. Tente novamente"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Caixa de Seleção da Camada"
  },
  "statisticsType": {
    "countLabel": "Contagem",
    "averageLabel": "Média",
  ...
  "workBench": {
    ...
    "featureModeText": "Modo de Criação de Feição",
    "sketchToolTitle": "Esboce novos recursos.",
    "selectToolTitle": "Copie recursos da feição existente no mapa.",
    "downloadCSVBtnTitle": "Exportar Relatório",
    "templatePickerTitle": "Selecione um modelo para criar novos recursos:"
  },
  "assetDetails": {
  ...
  "updateCostEquationPanel": {
    ...
    "updateProjectCostSuccess": "Equações de custo dos projetos selecionados são atualizadas",
    "updateProjectCostError": "Não foi possível atualizar a equação de custo dos projetos selecionados",
    "updateProjectNoProject": "Nenhum projeto localizado"
  }
});