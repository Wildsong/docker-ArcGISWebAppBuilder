...
define({
  ...
  "createLoadProject": {
    ...
    "viewInMapLabel": "Vorschau",
    "loadLabel": "Laden",
    "createLabel": "Erstellen",
    "deleteProjectConfirmationMsg": "Möchten Sie das Projekt wirklich löschen?",
    "noAssetsToViewOnMap": "Das ausgewählte Projekt enthält keine in der Karte anzuzeigenden Assets.",
    ...
    "errorFetchingPointLabel": "Fehler beim Abrufen eines Label-Punktes. Versuchen Sie es erneut.",
    "errorAddingPointLabel": "Fehler beim Hinzufügen eines Label-Punktes. Versuchen Sie es erneut."
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Layer-Kontrollkästchen"
  },
  "statisticsType": {
    "countLabel": "Anzahl",
    ...
    "areaLabel": "Fläche",
    "lengthLabel": "Länge",
    "expandCollapseAriaLabel": "'${displayTitle}' - Anzahl '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Feature-Erstellungsmodus",
    "sketchToolTitle": "Neue Assets skizzieren.",
    "selectToolTitle": "Assets aus vorhandenem Feature in der Karte kopieren.",
    "downloadCSVBtnTitle": "Bericht exportieren",
    "templatePickerTitle": "Wählen Sie eine Vorlage zum Erstellen neuer Assets aus:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Hinzufügen"
  },
  "copyFeatures": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Projektgleichungen aktualisieren",
    "updateProjectCostSelectProjectTitle": "Alle Projekte auswählen",
    "updateButtonTextForm": "Aktualisieren",
    "updateProjectCostSuccess": "Kostengleichungen der ausgewählten Projekte sind aktualisiert.",
    "updateProjectCostError": "Kostengleichungen der ausgewählten Projekte können nicht aktualisiert werden.",
    "updateProjectNoProject": "Kein Projekt gefunden"
  }
});