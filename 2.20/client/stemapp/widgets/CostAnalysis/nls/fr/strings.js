...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Une erreur s’est produite lors de la récupération du point d’étiquette. Réessayez",
    "errorAddingPointLabel": "Une erreur s’est produite lors de l’ajout du point d’étiquette. Réessayez"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Case à cocher de la couche"
  },
  "statisticsType": {
    "countLabel": "Total",
    ...
    "expandCollapseAriaLabel": "'${displayTitle}' : nombre '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Mode Création d’entités",
    "sketchToolTitle": "Concevez de nouvelles ressources.",
    "selectToolTitle": "Copiez des ressources depuis une entité existante de la carte.",
    "downloadCSVBtnTitle": "Exporter le rapport",
    "templatePickerTitle": "Sélectionnez un modèle pour créer des ressources."
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Ajouter"
  },
  "copyFeatures": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Mettre à jour les équations du projet",
    "updateProjectCostSelectProjectTitle": "Sélectionner tous les projets",
    "updateButtonTextForm": "Mettre à jour",
    "updateProjectCostSuccess": "Les équations de coût des projets sélectionnés sont mises à jour",
    "updateProjectCostError": "Impossible de mettre à jour l’équation de coût des projets sélectionnés",
    "updateProjectNoProject": "Aucun projet trouvé"
  }
});