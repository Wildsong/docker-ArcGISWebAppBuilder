...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Pogreška prilikom dohvaćanja točke oznake. Pokušajte ponovno",
    "errorAddingPointLabel": "Pogreška prilikom dodavanja točke oznake. Pokušajte ponovno"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Potvrdni okvir sloja"
  },
  "statisticsType": {
    "countLabel": "Broj",
    ...
    "areaLabel": "Poligon",
    "lengthLabel": "Duljina",
    "expandCollapseAriaLabel": "'${displayTitle}' Broj '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Način stvaranja značajki",
    "sketchToolTitle": "Skicirajte nova sredstva.",
    "selectToolTitle": "Kopirajte sredstva s postojeće značajke na mapi.",
    "downloadCSVBtnTitle": "Izvezi izvješće",
    "templatePickerTitle": "Odaberite predložak kako bi kreirali nova sredstva:"
  },
  "assetDetails": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Ažuriraj jednadžbe projekta",
    "updateProjectCostSelectProjectTitle": "Odaberi sve projekte",
    "updateButtonTextForm": "Ažuriraj",
    "updateProjectCostSuccess": "Ažuriraju se jednadžbe troškova odabranih projekata",
    "updateProjectCostError": "Nije moguće ažurirati jednadžbu troškova odabranih projekata",
    "updateProjectNoProject": "Nema pronađenih projekata"
  }
});