define({
  ...
  "projectSetting": {
    "title": "專案設定",
    "note": "附註: 專案設定是選用的，一旦配置的使用者可以在所需的 Web 地圖圖層 (具有網路中斷區域和輸入參數) 中儲存專案。 使用者可從「輸出」頁籤中儲存其他輸出參數。",
  ...
  "inputOutputTab": {
    ...
    "summaryTextTitle": "提供要針對輸入頁籤顯示的文字"
  },
  "summaryTab": {
    "title": "輸出",
    ...
    "summaryTextTitle": "提供要在輸出頁籤上顯示的摘要文字",
    "addSummaryItemsTitle": "新增摘要項目"
  },
  ...
  "hintText": {
    ...
    "inputTextHint": "提示: 使用「新增摘要項目」按鈕，在下方建立您的表達式。",
