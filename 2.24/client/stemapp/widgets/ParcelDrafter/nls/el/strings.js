...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "Κάντε κλικ για ενημέρωση του σημείου περιστροφής",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "Ενημέρωση σημείου περιστροφής"
  },
  "traverseSettings": {
    ...
    "compassRuleAppliedHint": "Η υπολογισμένη απόσταση σφάλματος κλεισίματος είναι μικρότερη από την απόσταση που έχει οριστεί,\n το γεωτεμάχιο θα προσαρμοστεί αυτόματα χρησιμοποιώντας τον κανόνα πυξίδας"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "Το αγροτεμάχιο διαγράφτηκε με επιτυχία.",
    "parcelDeleteErrorMessage": "Προέκυψε σφάλμα κατά τη διαγραφή του αγροτεμαχίου.",
    ...
    "showAttributeList": "Εμφάνιση λίστας γνωρισμάτων",
    "hideAttributeList": "Απόκρυψη λίστας γνωρισμάτων"
  },
  "xyInput": {
    "explanation": "Καταχωρίστε τις συντεταγμένες με την ίδια χωρική αναφορά όπως στο θεματικό επίπεδο."
  }
});