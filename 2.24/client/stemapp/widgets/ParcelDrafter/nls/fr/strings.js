...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "Cliquer pour mettre à jour le point de rotation",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "Mettre à jour le point de rotation"
  },
  "traverseSettings": {
    ...
    "compassRuleAppliedHint": "La distance d’écart de fermeture calculée est inférieure à la distance d’écart de fermeture configurée,\n la parcelle sera ajustée automatiquement à l’aide de la correction Compass"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "Parcelle supprimée avec succès.",
    "parcelDeleteErrorMessage": "Erreur lors de la suppression de la parcelle.",
    ...
    "showAttributeList": "Afficher la liste des attributs",
    "hideAttributeList": "Masquer la liste des attributs"
  },
  "xyInput": {
    "explanation": "Entrez les coordonnées dans la même référence spatiale que celle utilisée pour la couche"
  }
});