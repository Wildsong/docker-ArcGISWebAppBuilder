...
define({
  ...
  "traverseSettings": {
    ...
    "compassRuleAppliedHint": "Обчислена відстань нев’язки менша за налаштовану відстань нев’язки,\n ділянка буде автоматично скоригована з використанням правила компасу"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "showAttributeList": "Показати список атрибутів",
    "hideAttributeList": "Приховати список атрибутів"
  },
  "xyInput": {
