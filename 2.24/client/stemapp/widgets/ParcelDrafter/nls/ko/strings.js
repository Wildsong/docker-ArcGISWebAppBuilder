...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "회전 포인트를 업데이트하려면 클릭",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "회전 포인트 업데이트"
  },
  "traverseSettings": {
    "bearingLabel": "방위각",
    "lengthLabel": "길이",
    ...
    "compassRuleAppliedHint": "계산된 폐합 거리가 구성된 폐합 거리보다 작습니다.\n 필지가 컴퍼스 법칙을 통해 자동 조정됩니다."
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "필지가 삭제되었습니다.",
    "parcelDeleteErrorMessage": "필지를 삭제하는 중 오류가 발생했습니다.",
    ...
    "showAttributeList": "속성 목록 표시",
    "hideAttributeList": "속성 목록 숨기기"
  },
  "xyInput": {
    "explanation": "레이어와 동일한 공간 참조로 좌표 입력"
  }
});