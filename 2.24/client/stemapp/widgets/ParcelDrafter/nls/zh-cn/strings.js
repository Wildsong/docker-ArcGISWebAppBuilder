...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "单击以更新旋转点",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "更新旋转点"
  },
  "traverseSettings": {
    "bearingLabel": "方位角",
    "lengthLabel": "长度",
    ...
    "compassRuleAppliedHint": "计算的未闭合距离小于配置的未闭合距离，\n宗地将使用罗盘规则自动调整"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "宗地已成功删除。",
    "parcelDeleteErrorMessage": "删除宗地时出现错误。",
    ...
    "showAttributeList": "显示属性列表",
    "hideAttributeList": "隐藏属性列表"
  },
  "xyInput": {
    "explanation": "在与图层相同的空间参考中输入坐标"
  }
});