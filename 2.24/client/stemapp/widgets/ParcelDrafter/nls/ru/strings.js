...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "Щелкните, чтобы обновить точку поворота",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "Обновить точку поворота"
  },
  "traverseSettings": {
    ...
    "compassRuleAppliedHint": "Расчетная линейная невязка меньше настроенной линейной невязки, участок будет автоматически скорректирован с использованием правила компаса"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "Участок успешно удален.",
    "parcelDeleteErrorMessage": "Ошибка удаления участка.",
    ...
    "showAttributeList": "Показать список атрибутов",
    "hideAttributeList": "Спрятать список атрибутов"
  },
  "xyInput": {
    "explanation": "Введите координаты в пространственной привязке слоя"
  }
});