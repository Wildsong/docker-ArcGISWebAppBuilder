...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "按一下以更新旋轉點",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "更新旋轉點"
  },
  "traverseSettings": {
    "bearingLabel": "方位",
    "lengthLabel": "長度",
    ...
    "compassRuleAppliedHint": "計算的錯開距離小於配置的錯開距離，\n將使用羅盤儀規則自動調整宗地"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "已成功刪除宗地。",
    "parcelDeleteErrorMessage": "刪除宗地時出錯。",
    ...
    "showAttributeList": "顯示屬性清單",
    "hideAttributeList": "隱藏屬性清單"
  },
  "xyInput": {
    "explanation": "在與圖層相同的空間參考中輸入座標"
  }
});