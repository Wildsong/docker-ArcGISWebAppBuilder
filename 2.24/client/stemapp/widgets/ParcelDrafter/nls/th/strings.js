...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "คลิกเพื่ออัพเดตจุดหมุน",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "อัพเดตจุดหมุน"
  },
  "traverseSettings": {
    "bearingLabel": "แบริ่ง",
    "lengthLabel": "ความยาว",
    ...
    "compassRuleAppliedHint": "ระยะห่างความคลาดเคลื่อนบรรจบที่คำนวณ น้อยกว่าระยะห่างความคลาดเคลื่อนบรรจบที่กำหนดค่าไว้\n แปลงจะถูกปรับโดยอัตโนมัติโดยใช้กฎของเข็มทิศ"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "ลบแปลงที่ดินเรียบร้อยแล้ว",
    "parcelDeleteErrorMessage": "เกิดข้อผิดพลาดในการลบแปลงที่ดิน",
    ...
    "showAttributeList": "แสดงรายการแอตทริบิวต์",
    "hideAttributeList": "ซ่อนรายการแอตทริบิวต์"
  },
  "xyInput": {
    "explanation": "ป้อนพิกัดในการอ้างอิงเชิงพื้นที่ในรูปแบบชั้นข้อมูล"
  }
});