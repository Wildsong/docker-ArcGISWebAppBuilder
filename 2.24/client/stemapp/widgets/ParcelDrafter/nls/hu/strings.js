...
define({
  ...
  "traverseSettings": {
    ...
    "compassRuleAppliedHint": "A számított eltérési távolság kisebb, mint a konfigurált eltérési távolság,\n a parcella automatikusan az iránytűszabály használatával lesz beállítva."
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "showAttributeList": "Attribútumlista megjelenítése",
    "hideAttributeList": "Attribútumlista elrejtése"
  },
  "xyInput": {
    "explanation": "Adja meg a koordinátákat a réteggel megegyező térbeli vonatkoztatási rendszerben"
  }
});