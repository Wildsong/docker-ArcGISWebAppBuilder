...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "Fare clic per aggiornare il punto di rotazione",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "Aggiorna punto di rotazione"
  },
  "traverseSettings": {
    ...
    "compassRuleAppliedHint": "La distanza errore di chiusura calcolata è inferiore alla distanza configurata,\n il foglio verrà corretto automaticamente utilizzando la bussola"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "Particella correttamente eliminata.",
    "parcelDeleteErrorMessage": "Errore nell’eliminazione di particella.",
    ...
    "showAttributeList": "Mostra elenco attributi",
    "hideAttributeList": "Nascondi elenco attributi"
  },
  "xyInput": {
    "explanation": "Inserire le coordinate nello stesso riferimento spaziale come il layer"
  }
});