...
define({
  root: ({
    ...
    "traverseSettings": {
      ...
      "compassRuleAppliedHint": "Calculated misclose distance is smaller than configured misclose distance,\n the parcel will be auto adjusted using compass rule" // Shown as hint in the misclose information section
    },
    ...
    "planInfo": {
      ...
      "showAttributeList": "Show attribute list", // Shown as a tooltip on attribute list toggle button
      "hideAttributeList": "Hide attribute list" // Shown as a tooltip on attribute list toggle button
    },

    "xyInput": {
      "explanation": "Enter coordinates in same spatial reference as the layer"  // Shown as tooltip over type-in boxes for X and Y coordinates
    }
  }),
  "ar": 1,
  "bg": 1,
