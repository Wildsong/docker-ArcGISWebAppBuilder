...
define({
  ...
  "mapTooltipForUpdatingRotaionPoint": "Bấm để cập nhật điểm xoay",
  ...
  "planSettings": {
    ...
    "updateRotationPointTooltipText": "Cập nhật điểm xoay"
  },
  "traverseSettings": {
    "bearingLabel": "Hướng",
    "lengthLabel": "Độ dài",
    ...
    "compassRuleAppliedHint": "Khoảng cách sai số đã tính toán nhỏ hơn khoảng cách sai số đã cấu hình,\n thửa đất sẽ được tự động điều chỉnh theo nguyên tắc la bàn"
  },
  "parcelTools": {
  ...
  "planInfo": {
    ...
    "parcelDeletedSuccessMessage": "Đã xóa thửa đất thành công.",
    "parcelDeleteErrorMessage": "Xảy ra lỗi trong khi xóa thửa đất.",
    ...
    "showAttributeList": "Hiển thị danh sách thuộc tính",
    "hideAttributeList": "Ẩn danh sách thuộc tính"
  },
  "xyInput": {
    "explanation": "Nhập tọa độ trong cùng tham chiếu không gian làm lớp"
  }
});