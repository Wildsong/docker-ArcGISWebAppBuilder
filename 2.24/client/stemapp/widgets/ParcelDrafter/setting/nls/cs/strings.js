...
define({
  ...
  "parcelLineLayer": {
    "selectLayerLabel": "Vyberte související liniovou vrstvu",
    "layerSettingTabLabel": "Vrstvy parcely",
    "attributeSettingTabLabel": "Nastavení atributu",
    ...
    "startOrRotationSymbolLabel": "Spustit a otočit bodový symbol",
    "startOrRotationSymbolHintText": "Nápověda: Používá se pro zobrazení spuštění a otočení bodového symbolu.",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "Vyberte pole k uložení informací o geometrii souřadnic",
    ...
    "honorSettingRbLabel": "Nastavení vyskakovacích oken webové mapy",
    "customSettingsRbLabel": "Vlastní nastavení",
    "display": "Zobrazit",
    "edit": "Upravit",
    "editpageName": "Název",
    "actions": "Akce",
    "editpageAlias": "Alternativní jméno",
    "titleLabel": "Nadpis části"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "Vyberte jedinečné pole pro každou informaci o geometrii souřadnic."
  }
});