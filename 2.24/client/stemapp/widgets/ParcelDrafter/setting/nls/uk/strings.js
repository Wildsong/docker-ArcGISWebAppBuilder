...
define({
  ...
  "parcelLineLayer": {
    ...
    "attributeSettingTabLabel": "Настройки атрибутів",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "Виберіть поля для зберігання інформації щодо координатної геометрії",
    ...
    "selectPolygonLayerLabelPopUp": "Вибрати полігональний шар",
    "honorSettingRbLabel": "Налаштування спливаючих вікон веб-карти",
    "customSettingsRbLabel": "Налаштування користувача",
    "display": "Відображати",
    "edit": "Редагування",
    "editpageName": "Назва",
    "actions": "Дії",
    "editpageAlias": "Псевдонім",
    "titleLabel": "Заголовок розділу"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "Виберіть різне поле для кожного елементу інформації щодо координатної геометрії."
  }
});