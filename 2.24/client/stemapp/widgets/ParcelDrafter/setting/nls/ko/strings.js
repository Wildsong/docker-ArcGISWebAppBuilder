...
define({
  ...
  "parcelLineLayer": {
    ...
    "attributeSettingTabLabel": "속성 설정",
    ...
    "startOrRotationSymbolLabel": "시작 및 회전 포인트 심볼",
    "startOrRotationSymbolHintText": "힌트: 시작 및 회전 포인트 심볼을 표시하는 데 사용됩니다.",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "좌표 지오메트리 정보를 저장할 필드 선택",
    ...
    "honorSettingRbLabel": "웹맵 팝업 설정",
    "customSettingsRbLabel": "사용자 정의 설정",
    "display": "디스플레이",
    "edit": "편집",
    "editpageName": "이름",
    "actions": "동작",
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "각 좌표 지오메트리 정보에 대한 고유 필드를 선택하세요."
  }
});