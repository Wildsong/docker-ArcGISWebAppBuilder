...
define({
  ...
  "selectLayerLabel": "Seleccioneu capes de parcel·la",
  ...
  "parcelLineLayer": {
    ...
    "attributeSettingTabLabel": "Configuració d'atributs",
  ...
  "parcelPolygonLayer": {
    "selectPolygonLayerLabel": "Seleccioneu una capa de polígon",
    "selectPolygonLayerHintText": "Suggeriment: feu servir la capa de polígons de parcel·les seleccionada",
    "selectFieldLegendLabel": "Seleccioneu camps per emmagatzemar-hi informació de geometria de les coordinades",
    ...
    "selectPolygonLayerLabelPopUp": "Seleccioneu la capa de polígon",
    "honorSettingRbLabel": "Configuració de la finestra emergent del mapa web",
    "customSettingsRbLabel": "Configuració personalitzada",
    "display": "Mostra",
    "edit": "Edita",
    "editpageName": "Nom",
    "actions": "Accions",
    "editpageAlias": "Àlies",
    "titleLabel": "Títol de la secció"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "Seleccioneu un camp diferent per a cada informació de geometria de les coordinades."
  }
});