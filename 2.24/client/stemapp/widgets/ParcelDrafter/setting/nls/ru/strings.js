...
define({
  ...
  "parcelLineLayer": {
    ...
    "attributeSettingTabLabel": "Настройки атрибутов",
    ...
    "startOrRotationSymbolLabel": "Символ точки Начала и Поворота",
    "startOrRotationSymbolHintText": "Подсказка: используется для отображения символа точки начала и поворота.",
  ...
  "parcelPolygonLayer": {
    ...
    "selectFieldLegendLabel": "Выбрать поля для хранения информации о геометрии координат",
    ...
    "honorSettingRbLabel": "Настройки всплывающих окон веб-карты",
    "customSettingsRbLabel": "Пользовательские настройки",
    "display": "Отображение",
    "edit": "Редактирование",
    "editpageName": "Имя",
    "actions": "Действия",
    "editpageAlias": "Псевдоним",
    "titleLabel": "Название раздела"
  },
  "lineTypesTable": {
  ...
  "errorMsg": {
    ...
    "selectDistinctPolygonFields": "Пожалуйста выберите отдельное поле для информации о каждой геометрии координат."
  }
});