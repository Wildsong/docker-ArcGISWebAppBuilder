  ...
  function (
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
      ...
      postCreate: function () {
        ...
        this.own(on(this.screenDigitizationNode, "keydown", lang.hitch(this, function (evt) {
        ...
        //code for accessibility
        this.own(on(this.updateRotationPointNode, "keydown", lang.hitch(this, function (evt) {
          if (evt.keyCode === keys.ENTER || evt.keyCode === keys.SPACE) {
            //prevent default so that scrollbar should not get scrolled
            evt.preventDefault();
            this._onUpdateRotationPointButtonClicked();
      ...
      _bearingValueEntered: function (evt) {
        ...
        if (charOrCode === keys.ENTER || charOrCode === keys.TAB) {
          ...
          if (charOrCode === keys.ENTER && this.bearingNode.isValid()) {
            focusUtil.focus(this.lengthNode.focusNode);
          } else {
      ...
      _lengthValueEntered: function (evt) {
        ...
        if (charOrCode === keys.ENTER || charOrCode === keys.TAB) {
          ...
          if (charOrCode === keys.ENTER && this.lengthNode.isValid()) {
            focusUtil.focus(this.radiusNode.focusNode);
          } else {
        ...
        if (charOrCode === keys.ENTER) {
          ...
          if (radiusValue === "" || this.radiusNode.isValid()) {
            if (!this.bearingNode.isValid()) {
              this.bearingNode.validate(false);
              focusUtil.focus(this.bearingNode.focusNode);
      ...
      **/
      _validateLength: function (length, units) {
        ...
        switch (units) {
          case "feet":
            lengthData = utils.categorizeLengthFormat(length, "feet");
            break;
          case "meters":
      ...
      **/
      setRotation: function (endPoint) {
        ...
        geometryUtils.getProjectedGeometry(
          endPoint, defaultStartPointSpatialRef, this.geometryService).then(
            lang.hitch(this, function (projectedEndPoint) {
              angle = geometryUtils.getRotationAngleBetweenPoints(startPoint, projectedEndPoint);
      ...
      **/
      _addNewItem: function (isAddedFromScreenDigitization) {
        ...
        if (values) {
          ...
          values.rowIndex = this._itemList.length;
      ...
      **/
      _onDigitizationButtonClicked: function () {
        ...
        if (domClass.contains(this.screenDigitizationNode, "esriCTEnableButton")) {
          domAttr.set(this.screenDigitizationNode, "aria-pressed", "true");
          this.emit("activateDigitizationTool");
          this.deActivateUpdateRotationPointTool();
        } else {
          domAttr.set(this.screenDigitizationNode, "aria-pressed", "false");
      ...
      **/
      _onUpdateRotationPointButtonClicked: function () {
        ...
        // else disables the digitization tool
        if (domClass.contains(this.updateRotationPointNode, "esriCTEnableButton")) {
          domAttr.set(this.updateRotationPointNode, "aria-pressed", "true");
          this.emit("activateUpdateRotationPointTool");
          this.deActivateDigitizationTool();
        } else {
          domAttr.set(this.updateRotationPointNode, "aria-pressed", "false");
      ...
      **/
      _createParcelTools: function () {
        this._parcelToolInstance = new ParcelTools({
          nls: this.nls,
          config: this.config,
          canProjectLocally: geometryUtils.canProjectLocally(this.map.spatialReference)
      ...
      **/
      _createPlanInfo: function () {
        ...
        //code for accessibility
        //Handle show message event of parcelInfo
        this.own(this._planInfoInstance.on("showParcelSavedAndDeleteMsg",
          lang.hitch(this, function (msg) {
            this._showParcelSavedAndDeleteMsg(msg);
          })));
        ...
        this.own(this._planInfoInstance.on("saveTraversedParcel",
          lang.hitch(this, function () {
            ...
            if (this._itemList && this._itemList.length > 0) {
              ...
              } else if (parcelValidationDetails.message) {
      ...
      **/
      _createFieldInputs: function (nodeContainer, value, className, isPopup) {
        ...
        if (className === "esriCTBearingRow") {
          //code for accessibility
          domAttr.set(inputTextBox, "aria-label", this.nls.traverseSettings.bearingLabel);
          ...
          domAttr.set(inputTextBox, "aria-label", this.nls.traverseSettings.lengthLabel);
          ...
          domAttr.set(inputTextBox, "aria-label", this.nls.traverseSettings.radiusLabel);
      ...
      **/
      _createLineSelector: function (node, symbol, index) {
        ...
        symbolSelectorPopup = new SymbolSelector({
          ...
          "tabindex": "0",
          "aria-label": this.nls.newTraverse.lineTypeLabel, //code for accessibility
          "role": "button",
          "aria-haspopup": "true"
        }, node);
      ...
      **/
      _createDeleteButton: function (row, index) {
        ...
        deleteButton = domConstruct.create("div", {
          "class": "esriCTDeleteRow"
        }, row);
        deleteIcon = domConstruct.create("div", {
          ...
          "tabindex": "0",
          "role": "button",
          "aria-label": this.nls.traverseSettings.deleteButtonTitle //code for accessibility
        }, deleteButton);
      ...
      **/
      _updateRowIndexes: function () {
        ...
        array.forEach(allRows, lang.hitch(this, function (row, index) {
          ...
          //update row index
          this._itemList[index].rowIndex = index;
      ...
      **/
      _onDndDrop: function () {
        ...
        allNodes.forEach(lang.hitch(this, function (currentNode, index) {
          var item, rowIndex;
      ...
      * @memberOf widgets/ParcelDrafter/NewTraverse
      **/
      setStartPoint: function (startPoint, resetRotationPoint, updatingStartPoint, startNewTraverseBtnClick) {
        var defaultStartPointSpatialRef = new SpatialReference(4326);
          ...
          this.geometryService).then(
            lang.hitch(this, function (projectedGeometry) {
              ...
              if (this._itemList.length > 0) {
                ...
                this._drawPoint(startPoint, startNewTraverseBtnClick);
              }
            }));
      },
      ...
      * @memberOf widgets/ParcelDrafter/NewTraverse
      **/
      _addProjectedGraphic: function (layer, graphic, info, values) {
        var newGraphic, attributes = {};
        var setExtentToLayer = info.setExtentToLayer;
        var setParcelClosure = info.setParcelClosure;
        var startNewTraverseBtnClick = info.startNewTraverseBtnClick;
        if (values) {
          attributes.rowIndex = values.rowIndex;
        } else {
          ...
          geometryUtils.getProjectedGeometry(graphic.geometry, this.map.spatialReference,
            this.geometryService).then(lang.hitch(this, function (projectedGeometry) {
              if (projectedGeometry) {
                ...
                if (values) {
                  values.graphic = newGraphic;
                }
                //add pan to the location after it finds location based on the xy provided.
                if (startNewTraverseBtnClick) {
                  if (layer.graphics && layer.graphics.length > 0) {
                    this.map.centerAt(layer.graphics[0].geometry);
                  }
                }
                //set map extent to lines graphic layer
                if (setExtentToLayer) {
      ...
      * @memberOf widgets/ParcelDrafter/NewTraverse
      **/
      _drawPoint: function (point, startNewTraverseBtnClick) {
        var graphic = new Graphic(point, jsonUtils.fromJson(this.config.pointSymbol));
        var info = {
          setExtentToLayer: false,
          setParcelClosure: false,
          startNewTraverseBtnClick: startNewTraverseBtnClick
        };
        this._addProjectedGraphic(this.parcelPointsGraphicsLayer, graphic, info);
      },
      ...
      _drawLineAndEndPoint: function (endpoint, linesPathArray, values, setExtentToLayer) {
        ...
        if (endpoint) {
          ...
          if (polyLine) {
            ...
            var info = {
              setExtentToLayer: setExtentToLayer,
              setParcelClosure: setParcelClosure,
              startNewTraverseBtnClick: false
            };
            //draw line
            this._addProjectedGraphic(this.parcelLinesGraphicsLayer, graphic, info, values);
        ...
        geometryUtils.getProjectedGeometry(mapPoint, defaultStartPointSpatialRef,
          this.geometryService).then(
            lang.hitch(this, function (projectedGeometry) {
              ...
              } else if (this._planSettings.distanceAndLengthUnits === "feet") {
                distance = utils.metersToFeet(distance);
              }
      ...
      getParcelCloseDetails: function () {
        ...
        array.forEach(this._itemList, lang.hitch(this, function (item, index) {
          ...
          if (item.LineSymbol.type === this.config.BoundaryLineType) {
            var itemLengthInMeters = item.ChordLengthConversions ?
              item.ChordLengthConversions.meters : item.LengthConversions.meters;
      ...
      **/
      initEditing: function (startPoint, featureSet, lineLayerSpatialReference) {
        ...
        for (i = 0; i < featureSet.features.length; i++) {
          ...
          //when editing parcel and if bearing is not available code was breaking
          if (obj.Bearing !== null && obj.Bearing !== undefined && obj.Bearing !== "") {
            ...
            obj.rowIndex = editBearingDataArr.length;
      ...
      **/
      ...
      /**
      * this function used to call function which will update last focus node in traversePage
      * code for accessibility
      * @memberOf widgets/ParcelDrafter/NewTraverse
      **/
      updateLastNodeInTraversePanel: function () {
        this._planInfoInstance.setPlanInfoCancelBtnAsLastNode();
      },

      /**
      * Emits the showParcelSavedAndDeleteMsg event
      * code for accessibility
      * @memberOf widgets/ParcelDrafter/NewTraverse
      **/
