  ...
  var clz = dojoDeclare([drawFeedBack], {
    ...
    */
    ...
    _onMouseMoveHandler: function (evt) {
      ...
      var circleGeometry = this.setCircleGeometry(this.startPoint, current);
    ...
    _onDoubleClickHandler: function () {
      ...
      if (this.circleGraphic) {
        ...
        var circleGeometry = this.setCircleGeometry(this.startPoint, this.endPoint);
        this._drawEnd(circleGeometry);
      }
    },
    ...
    setCircleGeometry: function (stPt, endPt) {
      var geom = new esriPolyline(stPt.spatialReference);
