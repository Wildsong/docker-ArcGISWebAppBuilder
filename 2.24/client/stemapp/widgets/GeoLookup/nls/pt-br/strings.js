define({
  ...
  "description": "Procure por ou Arraste um <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Baixe uma planilha de exemplo' target='_blank'> planilha</a> aqui para visualizar e anexar dados do mapa a ela.",
  ...
  "projectionChoice": "CSV em",
  "projectionLat": "Lat/Long",
  "projectionMap": "Projeções do Mapa",
  "messages": "Mensagens",
  "error": {
    ...
    "invalidCoord": "Os campos de localização são inválidos. Marque o arquivo CSV.",
    "tooManyRecords": "Não mais que ${0} registros neste momento.",
    "CSVNoRecords": "O arquivo não contém quaisquer registros.",
    "CSVEmptyFile": "Nenhum conteúdo no arquivo."
  },
  "results": {
