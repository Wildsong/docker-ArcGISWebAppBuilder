define({
  "_widgetLabel": "Geosökning",
  "description": "Bläddra till eller dra en <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Hämta ett exempelblad' target='_blank'> kalkylblad </a> hit för att visualisera, och bifoga data till det.",
