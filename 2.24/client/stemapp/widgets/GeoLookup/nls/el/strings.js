define({
  ...
  "description": "Περιηγηθείτε σε ένα <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'>υπολογιστικό φύλλο</a> ή σύρετέ το εδώ για να το οπτικοποιήσετε και να του προσαρτήσετε δεδομένα χάρτη.",
  ...
  "projectionLat": "Γεωγρ. πλάτος/μήκος",
  "projectionMap": "Προβολή χάρτη",
  "messages": "Μηνύματα",
  "error": {
    ...
    "CSVNoRecords": "Το αρχείο δεν περιέχει εγγραφές.",
    "CSVEmptyFile": "Κανένα περιεχόμενο στο αρχείο."
  },
  "results": {
