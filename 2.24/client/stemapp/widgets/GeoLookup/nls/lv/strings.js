define({
  ...
  "projectionLat": "Plat./gar.",
  "projectionMap": "Kartes projekcija",
  "messages": "Ziņojumi",
  "error": {
    "fetchingCSV": "Kļūda, ienesot vienības no CSV krātuves: ${0}",
    "fileIssue": "Failu nevarēja apstrādāt.",
    "notCSVFile": "Pašlaik tiek atbalstīti tikai ar komatiem atdalīti faili (.csv).",
    "invalidCoord": "Izvietojumu lauki nav derīgi. Pārbaudiet CSV failu.",
    "tooManyRecords": "Diemžēl pašlaik var izmantot ne vairāk kā ${0} ierakstus.",
    "CSVNoRecords": "Failā nav neviena ieraksta.",
    "CSVEmptyFile": "Failā nav satura."
  },
  "results": {
