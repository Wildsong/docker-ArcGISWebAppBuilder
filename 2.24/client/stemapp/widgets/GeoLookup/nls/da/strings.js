define({
  ...
  "description": "Browse til, eller træk en <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download et eksempel' target='_blank'> regneark </a> hertil for at visualisere og knytte kortdata til det.",
  ...
  "error": {
    ...
    "invalidCoord": "Stedfelter er ugyldige. Kontrollér CSV-filen.",
