define({
  ...
  "description": "Examine o arrastre una <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'>hoja de cálculo</a> aquí para visualizarla e incorporarle datos de mapa.",
  ...
  "error": {
    ...
    "invalidCoord": "Los campos de ubicación no son válidos. Compruebe el archivo CSV.",
