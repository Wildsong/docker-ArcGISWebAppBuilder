...
define([
  ...
  function (Evented, declare, lang, html, /*focusUtils, keys, */a11yclick,// array,
    BaseWidget, _WidgetsInTemplateMixin, a11y,
    ...
    In = declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
      ...
      postCreate: function () {
        ...
        this.own(on(this.selectedBtn, a11yclick, lang.hitch(this, this.onSelected)));
        this.own(on(this.deleteBtn, a11yclick, lang.hitch(this, this.onDelete)));
        this.own(on(this.editBtn, a11yclick, lang.hitch(this, this.onEdit)));
        this.own(on(this.changeImgBtn, a11yclick, lang.hitch(this, this.onChangeImg)));
        this.own(on(this.renameBtn, a11yclick, lang.hitch(this, this.onRenameClick)));

        this.own(on(this.nodeBox, a11yclick, lang.hitch(this, this.onNodeBoxClick)));
        this.own(on(this.dragMasker, 'click', lang.hitch(this, this.onNodeBoxClick)));

        if (true === this.display.enableEditLabel) {
          this.own(on(this.nodeLabel, a11yclick, lang.hitch(this, this.onLabelClick)));
      ...
      _updateLabelTooltips: function (tips) {
        ...
        this.a11y_updateItemLabel(tips);
      }
    });
    ...
    In.focusLabel = function (bookmark) {
      if (bookmark.itemNode && bookmark.itemNode.nodeLabel) {
        ...
        if (bookmark.itemNode.domNode) {
          html.addClass(bookmark.itemNode.domNode, "a11y_hover");//show oper btns, when edit label
        }
    ...
    In.focusItem = function (bookmark) {
      if (bookmark && bookmark.itemNode && bookmark.itemNode.domNode) {
        bookmark.itemNode.domNode.focus();
      }
    };
