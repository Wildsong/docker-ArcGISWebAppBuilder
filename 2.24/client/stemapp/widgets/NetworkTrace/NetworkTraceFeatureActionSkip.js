...
define([
  ...
  var clazz = declare(BaseFeatureAction, {
    ...
    iconClass: 'esriCT-feature-action-skip-icon',
    iconFormat: 'PNG',
    ...
    isFeatureSupported: function (featureSet, layerParam) {
      ...
      if (currentLayerId && this._config && this._config.skipableLayers &&
        ...
        //if feature is not skipped then only show skip feature action in infowindow
    ...
    onExecute: function (featureSet, layerParam) {
      ...
      this._widgetInstance.skipFromTrace(featureSet.features, layer);
    }
  });
  return clazz;
});