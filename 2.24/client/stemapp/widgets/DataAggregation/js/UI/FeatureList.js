  ...
  function (declare,
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      postCreate: function () {
        ...
        this.pageTitle.innerHTML = this._title;
        domAttr.set(this.pageTitle, "aria-label", this._title+" "+ this.hint)
      },
      ...
      _updateAltIndexes: function () {
        if (this.pageContainer && !this._reviewView) {
          ...
          if (this._reviewView) {
            ...
            this.altHomeIndex = this._reviewView.index;
          }
        }
      ...
      _initFeatureView: function (feature, label) {
        var feat = new Feature({
          ...
          pageHint: this.nls.review.reviewFeatureHint,
          pageTitle: feature.label
        });
      ...
      _initRow: function (f, x) {
        var tr = domConstruct.create('tr', {
          ...
          onkeydown: lang.hitch(this, function (evt) {
