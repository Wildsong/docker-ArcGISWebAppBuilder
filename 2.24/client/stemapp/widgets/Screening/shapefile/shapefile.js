...
define([
  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
    ...
    _attachEventsToUploadShapefileButton: function () {
      this.own(on(this.uploadShapefileButton, "click", lang.hitch(this, function (evt) {
        Event.stop(evt);
        this.shapefileInput.click();
      })));
      this.own(on(this.uploadShapefileButton, "keydown", lang.hitch(this, function (evt) {
    ...
    /**
     * This function is used to set the focus on first node
     */
    focusFirstNodeOfSelectedTab: function () {
      this._focusOutCurrentNode();
      focusUtil.focus(this.uploadShapefileButton);
    },
    ...
    setFirstFocusNode: function (domNodeObj) {
      jimuUtils.initFirstFocusNode(domNodeObj, this.uploadShapefileButton);
    },
     ...
     */
    setLastFocusNode: function (domNodeObj) {
      jimuUtils.initLastFocusNode(domNodeObj, this.uploadShapefileButton);
    }
  });
});