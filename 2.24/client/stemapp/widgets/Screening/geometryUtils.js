...
define([
  ...
  function (
    ...
    mo.getDestinationPoint = function (startPoint, initialBearing, distance) {
      ...
      if (iterations >= 200) {
        console.error('Formula failed to converge'); // not possible?
        return null;
      }
    ...
    mo.getLengthOfGeometry = function (geometry) {
      var lengthConversions, simplifiedGeometry;
      lengthConversions = {};
      ...
      if (simplifiedGeometry) {
        ...
        if (geometry.spatialReference.isWebMercator() || geometry.spatialReference
          .wkid === 4326) {
          lengthConversions.meters = geometryEngine.geodesicLength(simplifiedGeometry, "meters");
          lengthConversions.miles = geometryEngine.geodesicLength(simplifiedGeometry, "miles");
          lengthConversions.kilometers =
            geometryEngine.geodesicLength(simplifiedGeometry, "kilometers");
          lengthConversions.feet = geometryEngine.geodesicLength(simplifiedGeometry, "feet");
        } else {
          lengthConversions.meters = geometryEngine.planarLength(simplifiedGeometry, "meters");
          lengthConversions.miles = geometryEngine.planarLength(simplifiedGeometry, "miles");
          lengthConversions.kilometers =
            geometryEngine.planarLength(simplifiedGeometry, "kilometers");
          lengthConversions.feet =
            geometryEngine.planarLength(simplifiedGeometry, "feet");
        }
      } else {
        lengthConversions.meters = 0;
        lengthConversions.miles = 0;
        lengthConversions.kilometers = 0;
        lengthConversions.feet = 0;
      }
      return lengthConversions;
    };
    ...
    mo.getAreaOfGeometry = function (geometry) {
      ...
      if (simplifiedGeometry) {
        ...
        if (geometry.spatialReference.isWebMercator() || geometry.spatialReference
          .wkid === 4326) {
          areaConversions.acres = geometryEngine.geodesicArea(simplifiedGeometry, "acres");
          areaConversions.squareMeters =
            geometryEngine.geodesicArea(simplifiedGeometry, "square-meters");
          areaConversions.squareFeet =
            geometryEngine.geodesicArea(simplifiedGeometry, "square-feet");
          areaConversions.squareUsFeet = geometryEngine.geodesicArea(simplifiedGeometry, 109406);
          areaConversions.squareKilometer =
            geometryEngine.geodesicArea(simplifiedGeometry, "square-kilometers");
          areaConversions.hectares =
            geometryEngine.geodesicArea(simplifiedGeometry, "hectares");
          areaConversions.squareMiles =
            geometryEngine.geodesicArea(simplifiedGeometry, "square-miles");
        } else {
          areaConversions.acres = geometryEngine.planarArea(simplifiedGeometry, "acres");
          areaConversions.squareMeters =
            geometryEngine.planarArea(simplifiedGeometry, "square-meters");
          areaConversions.squareFeet = geometryEngine.planarArea(simplifiedGeometry, "square-feet");
          areaConversions.squareUsFeet = geometryEngine.planarArea(simplifiedGeometry, 109406);
          areaConversions.squareKilometer =
            geometryEngine.planarArea(simplifiedGeometry, "square-kilometers");
          areaConversions.hectares =
            geometryEngine.planarArea(simplifiedGeometry, "hectares");
          areaConversions.squareMiles =
            geometryEngine.planarArea(simplifiedGeometry, "square-miles");
        }
      } else {
        ...
        areaConversions.squareKilometer = 0;
        areaConversions.hectares = 0;
        areaConversions.squareMiles = 0;
      }
