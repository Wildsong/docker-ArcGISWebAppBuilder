    ...
    return declare([BaseWidgetSetting, _TemplatedMixin], {
      ...
      popupEditDescription: function () {
        ...
        if (this._configInfo.editDescription && this._configInfo.editDescription !== null) {
          this._editorObj.set("value", this.editorXssFilter.sanitize(this._configInfo.editDescription));
        }
        ...
        var editDescPopup = new Popup({
          ...
          buttons: [{
            ...
            onClick: lang.hitch(this, function () {
              this._configInfo.editDescription = this.editorXssFilter.sanitize(this._getText());
