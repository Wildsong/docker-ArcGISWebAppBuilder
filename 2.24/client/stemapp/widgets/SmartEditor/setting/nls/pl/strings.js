define({
  ...
  "smartActionsPage": {
    ...
    "layerForExpressionNote": "Uwaga: Pola tej warstwy są używane do definiowania kryteriów wyrażenia. Opcja 'Warstwy i pola zastosowania' umożliwia wyświetlanie warstw i tabel, która mają zdefiniowane pola w wyrażeniu.",
  ...
  "relativeDomains": {
    ...
    "selectedDomainFieldsHint": "Wybierz pola domen: ${domainFields}",
