define({
  ...
  "findCentroids": "Localizar Centróides",
  "findCentroidsUsage": "Localiza o centro representativo (centróide) para cada feição de múltiplos pontos, linha ou área de entrada.",
  ...
  "findPointClusters": "Localizar Agrupamentos de Pontos",
  "findPointClustersUsage": "Esta ferramenta detecta áreas onde os pontos são concentrados e onde eles são separados por áreas que estão vazias ou escassas.",
  ...
  "geocodeLocations": "Geocodificar Locais da Tabela",
  "geocodeLocationsUsage": "Um modo conveniente para geocodificar tabelas grandes e arquivos de endereços em pontos.",
  ...
  "summarizeCenterAndDispersionUsage": "Utilize feições de ponto para calcular a feição central, centro médio, centro mediano ou elipse (distribuição).",
  ...
  "joinFeatures": "Ligar Feições",
  "joinFeaturesUsage": "A ferramenta Ligar Feições irá transerir atributos de uma camada ou tabela para outra baseada em relacionamentos de atributos e espaciais. Opcionalmente, as estatísticas podem ser calculadas para as feições de ligação.",
  "includeRouteLayer": "Incluir camadas de rota",
  "findOutliers": "Localizar Valores Atípicos",
  "findOutliersUsage": "A ferramenta Localizar Valores Atípicos determinará se há quaisquer valores atípicos significantes por meio de estatísticas no padrão espacial dos seus dados."
});