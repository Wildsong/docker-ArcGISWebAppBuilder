...
define([
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    baseClass: "jimu-widget-RelatedTableCharts-locator-source-setting",
    tr: null,
    nls: null,
    config: null,
    ...
    setConfig: function (config) {
      ...
      this.shelter.show(this.loading);
    ...
    _openServiceChooser: function () {
      ...
      this.shelterObj = new LoadingShelter({
        hidden: true
      });
      ...
      this.shelterObj.placeAt(this.geocoderPopup.domNode);
    ...
    /**
     * This function is used to validate all number inputs
     */
    validateAllNumberInputs: function () {
      var inputValidationObject;
      inputValidationObject = {};
      inputValidationObject.isInputValid = true;
      if ((this.maxSuggestions) && (!this.maxSuggestions.isInRange()) || (!this.maxSuggestions.isValid())) {
        inputValidationObject.isInputValid = false;
        inputValidationObject.validationMessage = this.nls.maxSuggestionErrorMessage;
        return inputValidationObject;
      }
      if ((this.maxResults) && (!this.maxResults.isInRange()) || (!this.maxResults.isValid())) {
        inputValidationObject.isInputValid = false;
        inputValidationObject.validationMessage = this.nls.maxResultsErrorMessage;
        return inputValidationObject;
      }
      if ((this.zoomScale) && (!this.zoomScale.isInRange()) || (!this.zoomScale.isValid())) {
        inputValidationObject.isInputValid = false;
        inputValidationObject.validationMessage = this.nls.zoomScaleErrorMessage;
        return inputValidationObject;
      }
      if ((this.localSearchMinScale) &&
        (!this.localSearchMinScale.isInRange()) || (!this.localSearchMinScale.isValid())) {
        inputValidationObject.isInputValid = false;
        inputValidationObject.validationMessage = this.nls.minScaleErrorMessage;
        return inputValidationObject;
      }
      if ((this.localSearchDistance) &&
        (!this.localSearchDistance.isInRange()) || (!this.localSearchDistance.isValid())) {
        inputValidationObject.isInputValid = false;
        inputValidationObject.validationMessage = this.nls.radiusErrorMessage;
        return inputValidationObject;
      }
      return inputValidationObject;
    }
