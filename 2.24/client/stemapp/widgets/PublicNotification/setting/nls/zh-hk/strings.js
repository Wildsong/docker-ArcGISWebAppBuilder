...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "允許使用者檢閱所選地址圖層上的最終選擇"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "新增欄標題 (僅適用於 CSV)",
    "zoomScale": "縮放比例",
    "reviewCheckboxLabel": "在 widget 中顯示檢閱按鈕"
  },
  "buttons": {
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "請至少配置一種搜尋來源",
    "noSearchSourceFeaureLayerConfigured": "請至少將一個圖徵圖層配置為一個搜尋來源，以使用選擇繪製工具"
  },
  "querySourceSetting": {
    "sourceSetting": "搜尋來源設定",
    "instruction": "將地理編碼服務或圖徵圖層新增和配置為搜尋來源。 這些指定的來源決定了搜尋方塊中的可搜尋內容。",
    "add": "新增搜尋來源",
    "addGeocoder": "新增地理編碼器",
    "geocoder": "地理編碼器",
