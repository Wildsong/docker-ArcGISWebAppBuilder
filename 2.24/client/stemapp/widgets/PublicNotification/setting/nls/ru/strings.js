...
define({
  ...
  "hints": {
    ...
    "reviewButtonHint": "Позволяет пользователям просматривать финальную выборку в выбранном слое адреса"
  },
  "propertyLabels": {
    ...
    "addCSVHeader": "Добавить заголовок столбца (только для CSV)",
    "zoomScale": "Масштаб",
    "reviewCheckboxLabel": "Показать кнопку Просмотр в виджете"
  },
  "buttons": {
  ...
  "placeholders": {
    ...
    "descriptionCSV": "Значения, разделенные запятыми (CSV)",
  ...
  "problems": {
    ...
    "noSearchSourcesConfigured": "Настройте хотя бы один источник поиска",
    "noSearchSourceFeaureLayerConfigured": "Настройте хотя бы один векторный слой как источник поиска для использования инструментов рисования выборки"
  },
  "querySourceSetting": {
    ...
    "locatorError": "Локатор должен поддерживать поиск по одной строке."
  }
});