    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(config) {
        ...
        this._processConfig(config).then(lang.hitch(this, function(configJson) {
          ...
          if (configJson.isOperationalLayer) {
            this.cbxOperationalLayer.setValue(true);
          }else{
            this.cbxOperationalLayer.setValue(false);
          }
        }));
      },
      ...
      getConfig: function() {
        ...
        this.config.isOperationalLayer = this.cbxOperationalLayer.checked;
