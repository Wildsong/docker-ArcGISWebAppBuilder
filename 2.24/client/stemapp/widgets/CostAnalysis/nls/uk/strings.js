...
define({
  ...
  "createLoadProject": {
    ...
    "viewInMapLabel": "Попередній перегляд",
  ...
  "statisticsType": {
    ...
    "areaLabel": "Площа",
    "lengthLabel": "Довжина",
    "expandCollapseAriaLabel": "'${displayTitle}' Кількість'${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Режим створення об'єкта",
    "sketchToolTitle": "Скетч нових активів.",
    "selectToolTitle": "Копіювати активи з існуючого об'єкта на карті.",
    "downloadCSVBtnTitle": "Експорт звіту",
    "templatePickerTitle": "Виьрати шаблон для створення нових активів:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Додати"
  },
  "copyFeatures": {
