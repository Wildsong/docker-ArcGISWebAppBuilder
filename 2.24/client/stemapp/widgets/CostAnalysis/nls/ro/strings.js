...
///////////////////////////////////////////////////////////////////////////
define({
  "_widgetLabel": "Analiza costurilor",
  "unableToFetchInfoErrMessage": "Nu se poate prelua serviciul de geometrie/detaliile stratului tematic configurat",
  "invalidCostingGeometryLayer": "Nu se poate obține 'esriFieldTypeGlobalID' în evaluarea geometriei stratului tematic.",
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Eroare la obținere punct etichetă Încercaţi din nou",
    "errorAddingPointLabel": "Eroare la adăugare punct etichetă. Încercaţi din nou"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Caseta de selectare Strat tematic"
  },
  "statisticsType": {
    "countLabel": "Număr",
    "averageLabel": "Medie",
    ...
    "areaLabel": "Suprafaţă",
    "lengthLabel": "Lungime",
    "expandCollapseAriaLabel": "'${displayTitle}' Număr '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Modul de creare a obiectului spațial",
    "sketchToolTitle": "Schitați active noi.",
    "selectToolTitle": "Copiați active dintr-un obiect spațial existent pe hartă.",
    "downloadCSVBtnTitle": "Export raport",
    "templatePickerTitle": "Selectați un șablon pentru a crea active noi:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Adăugare"
  },
  "copyFeatures": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Actualizare ecuații proiect",
    "updateProjectCostSelectProjectTitle": "Selectați toate proiectele",
    "updateButtonTextForm": "Actualizați",
    "updateProjectCostSuccess": "Ecuațiile de cost ale proiectelor selectate sunt actualizate",
    "updateProjectCostError": "Nu s-a putut actualiza ecuația de cost a proiectelor selectate",
    "updateProjectNoProject": "Niciun proiect găsit"
  }
});