...
///////////////////////////////////////////////////////////////////////////
define({
  "_widgetLabel": "Phân tích chi phí",
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Lỗi xảy ra khi lấy điểm nhãn. Vui lòng thử lại",
    "errorAddingPointLabel": "Lỗi xảy ra khi thêm điểm nhãn. Vui lòng thử lại"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Ô đánh dấu của Lớp"
  },
  "statisticsType": {
    "countLabel": "Số lượng",
    ...
    "areaLabel": "Khu vực",
    "lengthLabel": "Độ dài",
    "expandCollapseAriaLabel": "'${displayTitle}' số lượng '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Chế độ Tạo Đối tượng",
    "sketchToolTitle": "Phác họa tài sản mới",
    "selectToolTitle": "Sao chép tài sản từ đối tượng hiện có trong bản đồ.",
    "downloadCSVBtnTitle": "Xuất Báo cáo",
    "templatePickerTitle": "Chọn một mẫu để tạo tài sản mới:"
  },
  "assetDetails": {
  ...
  "copyFeatures": {
    ...
    "copyFeatureUpdateGeometryError": "Không thể cập nhật hình học của các đối tượng được chọn"
  },
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Cập nhật các phương trình của dự án",
    "updateProjectCostSelectProjectTitle": "Chọn tất cả dự án",
    "updateButtonTextForm": "Cập nhật",
    "updateProjectCostSuccess": "Phương trình chi phí của các dự án được chọn đã được cập nhật",
    "updateProjectCostError": "Không thể cập nhật phương trình chi phí của các dự án đã chọn",
    "updateProjectNoProject": "Không tìm thấy dự án nào"
  }
});