...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "Gaunant užrašo tašką įvyko klaida. Pabandykite dar kartą",
    "errorAddingPointLabel": "Pridedant užrašo tašką įvyko klaida. Pabandykite dar kartą"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "Sluoksnio žymės langelis"
  },
  "statisticsType": {
    ...
    "areaLabel": "Plotas",
    "lengthLabel": "Ilgis",
    "expandCollapseAriaLabel": "„${displayTitle}“ skaičius: „${featureCount}“"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "Elemento kūrimo režimas",
    "sketchToolTitle": "Apibrėžkite naujus išteklius.",
    "selectToolTitle": "Nukopijuokite išteklius iš esamo žemėlapio elemento.",
    "downloadCSVBtnTitle": "Eksportuoti ataskaitą",
    "templatePickerTitle": "Pasirinkite šabloną naujiems ištekliams kurti:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "Pridėti"
  },
  "copyFeatures": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "Atnaujinti projekto lygtis",
    "updateProjectCostSelectProjectTitle": "Pasirinkti visus projektus",
    "updateButtonTextForm": "Atnaujinti",
    "updateProjectCostSuccess": "Pasirinktų projektų išlaidų lygtys atnaujintos",
    "updateProjectCostError": "Nepavyksta atnaujinti pasirinktų projektų išlaidų lygčių",
    "updateProjectNoProject": "Projektų nerasta"
  }
});