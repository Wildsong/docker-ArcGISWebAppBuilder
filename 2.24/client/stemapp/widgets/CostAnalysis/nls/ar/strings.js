...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "حدث خطأ أثناء إحضار نقطة التسمية. الرجاء إعادة المحاولة مرة أخرى",
    "errorAddingPointLabel": "حدث خطأ أثناء إضافة نقطة التسمية. الرجاء إعادة المحاولة مرة أخرى"
  },
  "statisticsSettings": {
    ...
    "layerCheckbox": "مربع اختيار الطبقة"
  },
  "statisticsType": {
    "countLabel": "العدد",
    ...
    "areaLabel": "المنطقة",
    "lengthLabel": "الطول",
    "expandCollapseAriaLabel": "\"${displayTitle}\" عدد \"${featureCount}\""
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "وضع إنشاء المعالم",
    "sketchToolTitle": "خطط أصولًا جديدة.",
    "selectToolTitle": "انسخ الأصول من المعلم الموجود في الخريطة.",
    "downloadCSVBtnTitle": "تصدير التقرير",
    "templatePickerTitle": "حدد قالبًا لإنشاء أصول جديدة:"
  },
  "assetDetails": {
  ...
  "detailStatistics": {
    ...
    "addStatisticsButtonLabel": "إضافة"
  },
  "copyFeatures": {
    "title": "نسخ المعالم",
    ...
    "copyFeatureUpdateGeometryError": "يتعذر تحديث الأشكال الهندسية للمعالم المحددة"
  },
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "تحديث معدلات المشروع",
    "updateProjectCostSelectProjectTitle": "تحديد جميع المشاريع",
    "updateButtonTextForm": "تحديث",
    "updateProjectCostSuccess": "معدلات التكلفة للمشاريع المحددة محدثة",
    "updateProjectCostError": "تعذر تحديث معدل تكلفة المشروعات المحددة",
    "updateProjectNoProject": "لم يتم العثور على مشروعات"
  }
});