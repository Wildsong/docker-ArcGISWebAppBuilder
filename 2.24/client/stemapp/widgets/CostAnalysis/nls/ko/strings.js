...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "레이블 포인트를 가져오는 중 오류가 발생했습니다. 다시 시도하세요.",
    "errorAddingPointLabel": "레이블 포인트를 추가하는 중 오류가 발생했습니다. 다시 시도하세요."
  },
  "statisticsSettings": {
    "tabTitle": "통계 설정",
  ...
  "statisticsType": {
    ...
    "areaLabel": "영역",
    "lengthLabel": "길이",
    "expandCollapseAriaLabel": "'${displayTitle}' 개수 '${featureCount}'"
  },
  "costingInfo": {
  ...
  "workBench": {
    ...
    "featureModeText": "피처 생성 모드",
    "sketchToolTitle": "새 자산을 스케치합니다.",
    "selectToolTitle": "맵에서 기존 피처의 자산을 복사합니다.",
    "downloadCSVBtnTitle": "보고서 내보내기",
    "templatePickerTitle": "새 자산을 생성할 템플릿을 선택합니다:"
  },
  "assetDetails": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "프로젝트 방정식 업데이트",
    "updateProjectCostSelectProjectTitle": "모든 프로젝트 선택",
    "updateButtonTextForm": "업데이트",
    "updateProjectCostSuccess": "선택한 프로젝트의 비용 방정식이 업데이트되었음",
    "updateProjectCostError": "선택한 프로젝트의 비용 방정식을 업데이트할 수 없음",
    "updateProjectNoProject": "프로젝트를 찾을 수 없음"
  }
});