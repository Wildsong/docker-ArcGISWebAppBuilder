...
define([
  ...
  function(declare, BaseWidget, Map, ObliqueViewer,
    lang, dom, Button, ImageServiceMeasure,
    ...
    var clazz = declare([BaseWidget], {
      ...
      _addObliqueViewerWidget: function() {
        ...
        this.oblique = new ObliqueViewer({
          ...
          rasterInfoFields: this.config.ObliqueViewer.rasterInfoFields,
      ...
      _showNoImageNotification: function() {
        this.ovMap.graphics.clear();
      ...
      _addPoint: function (point) {
        ...
        if (this.config.ObliqueViewer.searchRadius > 0) {
          var polygon = geometryEngine.buffer(point,
            this.config.ObliqueViewer.searchRadius,
            this.config.ObliqueViewer.searchUnit);
          geometry = polygon;
        } else {
          geometry = point;
        }
