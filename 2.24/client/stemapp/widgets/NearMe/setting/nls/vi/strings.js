...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Gợi ý: Các ký hiệu cho lớp vùng được định cấu hình để sử dụng trong tìm kiếm lân cận.",
    "popupTitleForPolygon": "Chọn vùng cho vị trí địa chỉ đã chọn",
    "popupTitleForPolyline": "Chọn đường thẳng cho vị trí địa chỉ",
    "addressLocationPolylineHintText": "Gợi ý: Các ký hiệu cho lớp vùng được định cấu hình để sử dụng trong tìm kiếm lân cận.",
    "fontColorLabel": "Chọn màu phông chữ cho kết quả tìm kiếm",
    "fontColorHintText": "Mẹo: Màu phông chữ của kết quả tìm kiếm",
    "highlightColorLabel": "Đặt màu lựa chọn",
    "highlightColorHintText": "Gợi ý: Màu sắc cho vùng lựa chọn",
    ...
    "showImageGalleryLabel": "Hiển thị thư viện hình ảnh",
    "showImageGalleryHint": "Gợi ý: Hiển thị thư viện hình ảnh trong bảng tiện ích nếu hộp kiểm được đánh dấu chọn, nếu không nó sẽ ẩn đi",
    "showResultCountOfLayerLabel": "Hiển thị số lượng kết quả tìm kiếm cho mỗi lớp",
    "showAllLayers": "Hiển thị kết quả cho tất cả các lớp được cấu hình bất kể trạng thái hiển thị của chúng",
    "showAllLayersHint": "Gợi ý: Tùy chọn này sẽ cho phép hiển thị tất cả các lớp được cấu hình và trả về kết quả tìm kiếm khi chúng bị tắt trong bản đồ web hoặc trong thời gian chạy bằng tiện ích Danh sách Lớp.",
    "showResultCountOfLayerHint": "Gợi ý: Hiển thị số lượng kết quả tìm kiếm sau mỗi tên lớp",
    "editDescription": "Văn bản giới thiệu",
    "editDescriptionTip": "Văn bản hiển thị trong tiện ích phía trên hộp tìm kiếm.",
    "noResultsFound": "Thông báo khi không tìm thấy kết quả",
    "noResultFoundHint": "Gợi ý: Đặt thông báo để hiển thị khi không tìm thấy kết quả trong khu vực tìm kiếm",
    "noFeatureFoundText": "Không tìm thấy kết quả ",
    "searchHeaderText": "Tìm kiếm địa chỉ hoặc xác định vị trí trên bản đồ",
    "setCurrentLocationLabel": "Thiết lập nút vị trí hiện tại",
    "setCurrentLocationHintText": "Gợi ý: Cung cấp một nút để sử dụng vị trí hiện tại của người dùng",
    "bufferDistanceSliderLabel": "Thanh trượt Khoảng cách Đệm",
    "bufferDistanceTextboxLabel": "Hộp Văn bản Đệm",
    "bufferDistanceSliderandTextboxLabel": "Thanh trượt Khoảng cách Đệm và Hộp Văn bản Đệm",
    "bufferItemOptionLegend": "Tùy chọn Đầu vào Đệm"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Thông tin",
    "expressionsTab": "Biểu thức",
    "optionsTab": "Tùy chọn",
    "autoApplyWhenWidgetOpen": "Áp dụng bộ lọc này khi tiện ích được mở.",
    "expandFiltersOnLoad": "Mở rộng bộ lọc trên phần tải tiện ích"
  },
