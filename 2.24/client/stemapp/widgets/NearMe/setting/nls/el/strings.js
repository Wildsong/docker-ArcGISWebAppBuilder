...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Υπόδειξη: Σύμβολο για θεματικό επίπεδο πολυγώνου παραμετροποιημένο για χρήση κατά την αναζήτηση γειτνίασης.",
    ...
    "addressLocationPolylineHintText": "Υπόδειξη: Σύμβολο για θεματικό επίπεδο γραμμής παραμετροποιημένο για χρήση κατά την αναζήτηση γειτνίασης.",
    ...
    "highlightColorLabel": "Καθορισμός χρώματος επιλογής",
    "highlightColorHintText": "Υπόδειξη: Χρώμα επιλογής",
    ...
    "showImageGalleryLabel": "Εμφάνιση συλλογής εικόνων",
    "showImageGalleryHint": "Υπόδειξη: Η συλλογή εικόνων θα εμφανίζεται στον πίνακα του widget αν είναι επιλεγμένο το πλαίσιο ελέγχου, ενώ αλλιώς θα είναι κρυμμένη.",
    "showResultCountOfLayerLabel": "Εμφάνιση αριθμού αποτελεσμάτων αναζήτησης για κάθε θεματικό επίπεδο",
    "showAllLayers": "Εμφάνιση αποτελεσμάτων για όλα τα παραμετροποιημένα θεματικά επίπεδα, ανεξάρτητα από την κατάσταση ορατότητάς τους",
    "showAllLayersHint": "Υπόδειξη: Αυτή η επιλογή θα ενεργοποιήσει την ορατότητα όλων των παραμετροποιημένων θεματικών επιπέδων και θα επιστρέψει αποτελέσματα αναζήτησης όταν αυτά είναι απενεργοποιημένα στον web χάρτη ή κατά τoν χρόνο εκτέλεσης, χρησιμοποιώντας το widget Layer List.",
    "showResultCountOfLayerHint": "Υπόδειξη: Καθορίστε να εμφανίζεται ο αριθμός των αποτελεσμάτων της αναζήτησης μετά το όνομα κάθε θεματικού επιπέδου.",
    "editDescription": "Εισαγωγικό κείμενο",
    "editDescriptionTip": "Το κείμενο που εμφανίζεται στο widget πάνω από το πλαίσιο αναζήτησης.",
    "noResultsFound": "Μήνυμα όποτε δεν έχουν βρεθεί αποτελέσματα",
    "noResultFoundHint": "Υπόδειξη: Καθορίστε να εμφανίζεται το μήνυμα όποτε δεν έχουν βρεθεί αποτελέσματα εντός της περιοχής της αναζήτησης.",
    "noFeatureFoundText": "Δεν βρέθηκαν αποτελέσματα ",
    "searchHeaderText": "Εκτέλεση αναζήτησης για μια διεύθυνση ή εντοπισμός σε χάρτη",
    "setCurrentLocationLabel": "Καθορισμός κουμπιού τρέχουσας τοποθεσίας",
    "setCurrentLocationHintText": "Υπόδειξη: Καθορίστε ένα κουμπί για χρήση της τρέχουσας τοποθεσίας του χρήστη.",
    "bufferDistanceSliderLabel": "Ρυθμιστικό απόστασης ζώνης",
    "bufferDistanceTextboxLabel": "Πλαίσιο κειμένου ζώνης",
    "bufferDistanceSliderandTextboxLabel": "Ρυθμιστικό απόστασης ζώνης και πλαίσιο κειμένου",
    "bufferItemOptionLegend": "Επιλογές καταχώρισης ζώνης"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Πληροφορίες",
    "expressionsTab": "Εκφράσεις",
    "optionsTab": "Επιλογές",
    "autoApplyWhenWidgetOpen": "Εφαρμόστε αυτό το φίλτρο κατά το άνοιγμα του widget",
    "expandFiltersOnLoad": "Ανάπτυξη φίλτρων κατά τη φόρτωση του widget"
  },
