...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Sugestão: Símbolo da camada de polígono configurado para utilizar na pesquisa de proximidade.",
    ...
    "addressLocationPolylineHintText": "Sugestão: Símbolo da camada de polilinha configurado para utilizar na pesquisa de proximidade.",
    ...
    "highlightColorLabel": "Configurar cor de seleção",
    "highlightColorHintText": "Sugestão: Cor de seleção",
    ...
    "showImageGalleryHint": "Dica: Mostrar galeria de imagens no painel do widget, se a caixa de seleção estiver marcada, caso contrário, ela ocultará",
    "showResultCountOfLayerLabel": "Mostrar contagem de resultados da pesquisa para cada camada",
    "showAllLayers": "Mostrar resultados para todas as camadas configuradas, independentemente do status de visibilidade",
    "showAllLayersHint": "Dica: Esta opção habilitará a visibilidade de todas as camadas configuradas e retornará os resultados da pesquisa quando estiverem desativadas no mapa da web ou durante o tempo de execução usando o widget Lista de Camada.",
    "showResultCountOfLayerHint": "Dica: Exibir o número de resultados da pesquisa após o nome de cada camada",
    "editDescription": "Texto introdutório",
    "editDescriptionTip": "Texto exibido no widget acima da caixa de pesquisa.",
    "noResultsFound": "Mensagem quando nenhum resultado é encontrado",
    "noResultFoundHint": "Dica: Defina a mensagem a ser exibida quando nenhum resultado for encontrado na área de pesquisa",
    "noFeatureFoundText": "Nenhum resultado encontrado ",
    "searchHeaderText": "Procurar por um endereço ou localizar no mapa",
    "setCurrentLocationLabel": "Configurar botão de localização atual",
    "setCurrentLocationHintText": "Dica: Forneça um botão para utilizar a localização atual do usuário",
    "bufferDistanceSliderLabel": "Controle Deslizante de Distância do Buffer",
    "bufferDistanceTextboxLabel": "Caixa de Texto do Buffer",
    "bufferDistanceSliderandTextboxLabel": "Caixa de Texto e Controle Deslizante de Distância do Buffer",
