...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "ヒント: 近接検索で使用するように構成されたポリゴン レイヤーのシンボルです。",
    "popupTitleForPolygon": "選択した住所位置のポリゴンを選択",
    "popupTitleForPolyline": "住所位置のラインを選択",
    "addressLocationPolylineHintText": "ヒント: 近接検索で使用するように構成されたポリライン レイヤーのシンボルです。",
    "fontColorLabel": "検索結果のフォントの色の選択",
    "fontColorHintText": "ヒント: 検索結果のフォントの色",
    "highlightColorLabel": "選択色の設定",
    "highlightColorHintText": "ヒント: 選択色",
    ...
    "showImageGalleryLabel": "画像ギャラリーの表示",
    "showImageGalleryHint": "ヒント: チェックボックスがオンの場合、ウィジェット パネル内に画像ギャラリーが表示されます。オフの場合、非表示になります。",
    "showResultCountOfLayerLabel": "各レイヤーの検索結果の数を表示",
    "showAllLayers": "表示ステータスに関係なく、すべての構成されたレイヤーの結果を表示",
    "showAllLayersHint": "ヒント: このオプションは、Web マップでオフになっている場合またはレイヤー リスト ウィジェットを使用したランタイム時に、すべての構成されたレイヤーを表示して検索結果を返します。",
    "showResultCountOfLayerHint": "ヒント: 各レイヤー名の後に検索結果の数を表示します",
    "editDescription": "概要を示すテキスト",
    "editDescriptionTip": "ウィジェット内で検索ボックスの上に表示されるテキストです。",
    "noResultsFound": "結果が見つからない場合のメッセージ",
    "noResultFoundHint": "ヒント: 検索エリア内に結果が見つからない場合に表示するメッセージを設定します",
    "noFeatureFoundText": "結果が見つかりませんでした ",
    "searchHeaderText": "住所を検索するか、マップ上で位置を特定します",
    "setCurrentLocationLabel": "[現在位置の設定] ボタン",
    "setCurrentLocationHintText": "ヒント: ユーザーの現在位置を使用するボタンを提供します",
    "bufferDistanceSliderLabel": "バッファー距離スライダー",
    "bufferDistanceTextboxLabel": "バッファー テキスト ボックス",
    "bufferDistanceSliderandTextboxLabel": "バッファー距離スライダーおよびテキスト ボックス",
    "bufferItemOptionLegend": "バッファーの入力オプション"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "expandFiltersOnLoad": "ウィジェットの読み込み時にフィルターを展開"
  },
