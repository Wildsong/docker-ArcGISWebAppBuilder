...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Hint: Symbool voor polygoonlaag is geconfigureerd voor zoeken in de buurt.",
    ...
    "addressLocationPolylineHintText": "Hint: Symbool voor polylijnlaag is geconfigureerd voor zoeken in de buurt.",
    "fontColorLabel": "Selecteer fontkleur voor zoekresultaten",
    "fontColorHintText": "Tip: fontkleur van zoekresultaten",
    "highlightColorLabel": "Stel selectiekleur in",
    "highlightColorHintText": "Hint: Selectiekleur",
    ...
    "showImageGalleryLabel": "Afbeeldingengalerij weergeven",
    "showImageGalleryHint": "Hint: geef afbeeldingengalerij weer in het widget-deelvenster. Als er elders een vinkje is gezet, wordt de galerij verborgen",
    "showResultCountOfLayerLabel": "Telling van zoekresultaten weergeven voor elke laag",
    "showAllLayers": "Resultaten weergeven voor alle geconfigureerde lagen, ongeacht de zichtbaarheidsstatus ervan",
    "showAllLayersHint": "Tip: Met deze optie wordt de zichtbaarheid van alle geconfigureerde lagen ingeschakeld en worden zoekresultaten geretourneerd wanneer ze zijn uitgeschakeld in de webkaart of tijdens de runtime met behulp van de Laaglijst-widget.",
    "showResultCountOfLayerHint": "Hint: Geeft het aantal zoekresultaten weer na elke laagnaam",
    "editDescription": "Inleidende tekst",
    "editDescriptionTip": "Tekst weergegeven in de widget boven het zoekvak.",
    "noResultsFound": "Bericht wanneer er geen resultaten worden gevonden",
    "noResultFoundHint": "Hint: Stelt het bericht in dat wordt weergegeven wanneer er geen resultaten worden gevonden binnen het zoekgebied",
    "noFeatureFoundText": "Geen resultaten gevonden ",
    "searchHeaderText": "Zoek een adres of zoek op kaart",
    "setCurrentLocationLabel": "Knop huidige locatie instellen",
    "setCurrentLocationHintText": "Hint: Verschaft een knop om de huidige locatie van de gebruiker te gebruiken",
    "bufferDistanceSliderLabel": "Bufferafstandschuifbalk",
    "bufferDistanceTextboxLabel": "Buffertekstvak",
    "bufferDistanceSliderandTextboxLabel": "Bufferafstandschuifbalk en tekstvak",
    "bufferItemOptionLegend": "Bufferinvoeropties"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Info",
    "expressionsTab": "Expressies",
    "optionsTab": "Opties",
    "autoApplyWhenWidgetOpen": "Pas dit filter toe wanneer de widget wordt geopend",
    "expandFiltersOnLoad": "Filters op widgetbelasting uitbreiden"
  },
