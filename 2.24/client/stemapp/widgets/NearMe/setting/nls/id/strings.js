...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Petunjuk: Simbol untuk layer poligon yang dikonfigurasi untuk menggunakan pencarian kedekatan jarak.",
    "popupTitleForPolygon": "Pilih poligon untuk lokasi alamat yang dipilih",
    "popupTitleForPolyline": "Pilih garis untuk lokasi alamat",
    "addressLocationPolylineHintText": "Petunjuk: Simbol untuk layer polyline yang dikonfigurasi untuk menggunakan pencarian kedekatan jarak.",
    "fontColorLabel": "Pilih warna font untuk hasil pencarian",
    "fontColorHintText": "Petunjuk: Warna font hasil pencarian",
    "highlightColorLabel": "Atur warna pilihan",
    "highlightColorHintText": "Petunjuk: Warna pilihan",
    ...
    "showImageGalleryLabel": "Tampilkan galeri gambar",
    "showImageGalleryHint": "Petunjuk: Menampilkan galeri gambar dalam panel widget jika kotak centang dicentang, jika tidak, maka akan disembunyikan",
    "showResultCountOfLayerLabel": "Tampilkan jumlah hasil pencarian untuk setiap layer",
    "showAllLayers": "Tampilkan hasil untuk semua layer yang dikonfigurasi terlepas dari status visibilitasnya",
    "showAllLayersHint": "Petunjuk: Opsi ini akan mengaktifkan visibilitas semua layer yang dikonfigurasi dan menampilkan hasil pencarian saat dinonaktifkan di web map atau selama runtime menggunakan widget Daftar Layer.",
    "showResultCountOfLayerHint": "Petunjuk: Tampilkan jumlah hasil pencarian setelah setiap nama layer",
    "editDescription": "Teks pengantar",
    "editDescriptionTip": "Teks ditampilkan di widget di atas kotak pencarian.",
    "noResultsFound": "Pesan saat tidak ada hasil yang ditemukan",
    "noResultFoundHint": "Petunjuk: Atur pesan untuk ditampilkan saat tidak ada hasil ditemukan dalam area pencarian",
    "noFeatureFoundText": "Tidak ada hasil yang ditemukan ",
    "searchHeaderText": "Cari alamat atau temukan lokasinya di peta",
    "setCurrentLocationLabel": "Tetapkan tombol lokasi saat ini",
    "setCurrentLocationHintText": "Petunjuk: Sediakan tombol untuk menggunakan lokasi pengguna saat ini",
    "bufferDistanceSliderLabel": "Panel Geser Jarak Buffer",
    "bufferDistanceTextboxLabel": "Kotak Teks Buffer",
    "bufferDistanceSliderandTextboxLabel": "Panel Geser Jarak Buffer dan Kotak Teks",
    "bufferItemOptionLegend": "Opsi Input Buffer"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Info",
    "expressionsTab": "Ekspresi",
    "optionsTab": "Opsi",
    "autoApplyWhenWidgetOpen": "Terapkan filter ini ketika widget terbuka",
    "expandFiltersOnLoad": "Perluas filter pada pemuatan widget"
  },
