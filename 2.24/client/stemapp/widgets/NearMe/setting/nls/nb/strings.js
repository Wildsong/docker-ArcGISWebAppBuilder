...
define({
  ...
  "searchSourceSetting": {
    ...
    "searchSourceSettingTitleHintText": "Legg til og konfigurer geokodingstjenester eller geoobjektlag som søkekilder. Disse angitte kildene avgjør hva som er søkbart i søkeboksen.",
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Tips: Symbol for polygonlag konfigurert for bruk i nærhetssøk.",
    "popupTitleForPolygon": "Velg polygon for valgt adresselokasjon",
    "popupTitleForPolyline": "Velg linje for adresselokasjon",
    "addressLocationPolylineHintText": "Tips: Symbol for polylinjelag konfigurert for bruk i nærhetssøk.",
    "fontColorLabel": "Velg skriftfarge for søkeresultater",
    "fontColorHintText": "Hint: Skriftfarge for søkeresultater",
    "highlightColorLabel": "Angi farge på utvalg",
    "highlightColorHintText": "Tips: Markeringsfarge",
    ...
    "showImageGalleryLabel": "Vis bildegalleri",
    "showImageGalleryHint": "Hint: Vis bildegalleriet i miniprogrampanelet hvis det er merket av i avmerkingsboksen. Hvis ikke skjules det.",
    "showResultCountOfLayerLabel": "Vis antall søkeresultater for hvert lag",
    "showAllLayers": "Vis resultater for alle konfigurerte lag uavhengig av status for synlighet",
    "showAllLayersHint": "Tips: Dette alternativet aktiverer synlighet for alle konfigurerte lag og returnerer søkeresultater når de deaktiveres i webkartet eller under kjøretid ved hjelp av miniprogrammet Lagliste.",
    "showResultCountOfLayerHint": "Tips: Vis antall søkeresultater etter navnet på hvert lag",
    "editDescription": "Innledningstekst",
    "editDescriptionTip": "Tekst som vises i miniprogrammet over søkefeltet.",
    "noResultsFound": "Melding når ingen resultater blir funnet",
    "noResultFoundHint": "Tips: Sett meldingen til å vises når det ikke blir funnet noen resultater i søkeområdet",
    "noFeatureFoundText": "Finner ingen resultater ",
    "searchHeaderText": "Søk etter en adresse eller finn på kartet",
    "setCurrentLocationLabel": "Angi knapp for gjeldende lokasjon",
    "setCurrentLocationHintText": "Tips: Angi en knapp for å bruke brukerens gjeldende lokasjon",
    "bufferDistanceSliderLabel": "Bufferavstandsglidebryter",
    "bufferDistanceTextboxLabel": "Buffertekstboks",
    "bufferDistanceSliderandTextboxLabel": "Bufferavstandsglidebryter og -tekstboks",
    "bufferItemOptionLegend": "Alternativer for bufferinndata"
  },
  "layerSelector": {
