...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Napomena: simbol za sloj poligona koji je konfigurisan za korišćenje u pretrazi bliskosti.",
    ...
    "addressLocationPolylineHintText": "Napomena: simbol za sloj polilinija koji je konfigurisan za korišćenje u pretrazi bliskosti.",
    "fontColorLabel": "Izaberite boju fonta za rezultate pretrage",
    "fontColorHintText": "Napomena: boja fonta za rezultate pretrage",
    "highlightColorLabel": "Podesi boju izbora",
    "highlightColorHintText": "Napomena: boja selekcije",
    ...
    "showImageGalleryLabel": "Prikaži galeriju snimaka",
    "showImageGalleryHint": "Savet: galerija snimaka u panelu vidžeta je prikazana ako je potvrđen izbor u polju za potvrdu, u suprotnom biće sakrivena",
    "showResultCountOfLayerLabel": "Prikaži broj rezultata pretrage za svaki sloj",
    "showAllLayers": "Prikažite rezultate za sve konfigurisane slojeve bez obzira na njihov status vidljivosti",
    "showAllLayersHint": "Napomena: ova opcija će omogućiti vidljivost svih konfigurisanih slojeva i dati rezultate pretrage kada se oni isključe na veb mapi ili tokom vremena izvršavanja uz pomoć vidžeta Lista slojeva.",
    "showResultCountOfLayerHint": "Savet: prikažite broj rezultata pretrage nakon svakog naziva sloja",
    "editDescription": "Uvodni tekst",
    "editDescriptionTip": "Tekst koji je prikazan u vidžetu iznad polja za pretragu.",
    "noResultsFound": "Poruka kada nije pronađen nijedan rezultat",
    "noResultFoundHint": "Savet: podesite poruku da se prikaže kada se ne pronađe nijedan rezultat u oblasti pretrage",
    "noFeatureFoundText": "Nema pronađenih rezultata ",
    "searchHeaderText": "Pretraži adresu ili lociraj na mapi",
    "setCurrentLocationLabel": "Dugme za podešavanje trenutne lokacije",
    "setCurrentLocationHintText": "Savet: obezbedite dugme za korišćenje trenutne lokacije korisnika",
    "bufferDistanceSliderLabel": "Klizač rastojanja zone bliskosti",
    "bufferDistanceTextboxLabel": "Okvir za tekst zone bliskosti",
    "bufferDistanceSliderandTextboxLabel": "Klizač rastojanja i okvir za tekst zone bliskosti",
    "bufferItemOptionLegend": "Opcije ulazne zone bliskosti"
  },
  "layerSelector": {
  ...
  "routeSetting": {
    ...
    "buttonSet": "Postavi",
    "routeServiceUrlHintText": "Napomena: kliknite na „Postavi“ da biste potražili i izabrali servis za rutiranje",
  ...
  "filterSetting": {
    ...
    "infoTab": "Informacije",
    "expressionsTab": "Izrazi",
    "optionsTab": "Opcije",
    "autoApplyWhenWidgetOpen": "Primeni ovaj filter kada je vidžet otvoren",
    "expandFiltersOnLoad": "Proširi filtere prilikom učitavanja vidžeta"
  },
