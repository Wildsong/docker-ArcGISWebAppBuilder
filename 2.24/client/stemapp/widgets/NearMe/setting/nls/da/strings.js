...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Tip: Symbol for polygonlag, der er konfigureret til brug i søgning i nærheden.",
    ...
    "addressLocationPolylineHintText": "Tip: Symbol for polylinjelag, der er konfigureret til brug i søgning i nærheden.",
    "fontColorLabel": "Vælg skrifttypefarve for søgeresultater",
    "fontColorHintText": "Tip: Skrifttypefarve for søgeresultater",
    "highlightColorLabel": "Indstil markeringsfarve",
    "highlightColorHintText": "Tip: Markeringsfarve",
    ...
    "showImageGalleryLabel": "Vis billedgalleri",
    "showImageGalleryHint": "Tip: Vis billedgalleri i widget-panelet, hvis afkrydsningsfeltet er afkrydset, ellers skjules det",
    "showResultCountOfLayerLabel": "Vis antal søgeresultater for hvert lag",
    "showAllLayers": "Vis resultater for alle konfigurerede lag uanset deres synlighedsstatus",
    "showAllLayersHint": "Tip: Denne indstilling vil aktivere synligheden for alle konfigurerede lag og returnere søgeresultater, når de deaktiveres i webkortet eller i løbet af runtime ved brug af Lagliste-widget'en.",
    "showResultCountOfLayerHint": "Tip: Vis antallet af søgeresultater efter hvert lagnavn",
    "editDescription": "Indledningstekst",
    "editDescriptionTip": "Tekst, der vises i widget'en over søgefeltet.",
    "noResultsFound": "Meddelelse, når der ikke er nogen søgeresultater",
    "noResultFoundHint": "Tip: Angiv den meddelelse, der skal vises, når der ikke findes nogen resultater inden for søgeområdet",
    "noFeatureFoundText": "Ingen resultater ",
    "searchHeaderText": "Søg efter en adresse eller position på kortet",
    "setCurrentLocationLabel": "Knap til angivelse af aktuel placering",
    "setCurrentLocationHintText": "Tip: Opret en knap, der anvender brugerens aktuelle placering",
    "bufferDistanceSliderLabel": "Skydekontrol for bufferafstand",
    "bufferDistanceTextboxLabel": "Buffer-tekstboks",
    "bufferDistanceSliderandTextboxLabel": "Skydekontrol og tekstboks for bufferafstand",
    "bufferItemOptionLegend": "Inputindstillinger for buffer"
  },
  "layerSelector": {
