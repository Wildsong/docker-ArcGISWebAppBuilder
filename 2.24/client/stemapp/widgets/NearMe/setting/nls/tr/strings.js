...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "İpucu: Yakınlık aramada kullanım için yapılandırılmış çokgen katmanı sembolü.",
    "popupTitleForPolygon": "Seçili adres konumu için alan seçin",
    "popupTitleForPolyline": "Adres konumu için çizgi seçin",
    "addressLocationPolylineHintText": "İpucu: Yakınlık aramada kullanım için yapılandırılmış çoklu çizgi katmanı sembolü.",
    "fontColorLabel": "Arama sonuçları için yazı tipi rengini belirle",
    "fontColorHintText": "İpucu: Arama sonuçlarının yazı tipi rengi",
    "highlightColorLabel": "Seçim rengini ayarla",
    "highlightColorHintText": "İpucu: Seçim rengi",
    ...
    "showImageGalleryLabel": "Görüntü galerisini göster",
    "showImageGalleryHint": "İpucu: Onay kutusu işaretliyse görüntü galerisi araç panelinde gösterilir, aksi halde gizlenir",
    "showResultCountOfLayerLabel": "Her bir katman için arama sonuçları sayısını göster",
    "showAllLayers": "Görünürlük durumlarından bağımsız olarak tüm yapılandırılmış katmanlar için sonuçları göster",
    "showAllLayersHint": "İpucu: Bu seçenek, yapılandırılmış tüm katmanların görünürlüğünü etkinleştirir ve web haritasında kapatıldıklarında veya Katman Listesi aracı kullanılarak runtime sırasında arama sonuçlarını döndürür.",
    "showResultCountOfLayerHint": "İpucu: Arama sonuçları sayısını her bir katman adından sonra görüntüler",
    "editDescription": "Tanıtım metni",
    "editDescriptionTip": "Arama kutusunun üzerinde araç içinde görüntülenen metin.",
    "noResultsFound": "Hiç sonuç bulunmadığında mesaj",
    "noResultFoundHint": "İpucu: Arama alanında hiç sonuç bulunmadığında görüntülenecek mesajı ayarlar",
    "noFeatureFoundText": "Sonuç bulunamadı ",
    "searchHeaderText": "Adres arayın veya haritada bulun",
    "setCurrentLocationLabel": "Geçerli konum düğmesini ayarla",
    "setCurrentLocationHintText": "İpucu: Kullanıcının geçerli konumu için kullanılacak bir düğme sağlar",
    "bufferDistanceSliderLabel": "Tampon Mesafesi Kaydırıcısı",
    "bufferDistanceTextboxLabel": "Tampon Metin Kutusu",
    "bufferDistanceSliderandTextboxLabel": "Tampon Mesafesi Kaydırıcısı ve Metin Kutusu",
    "bufferItemOptionLegend": "Tampon Girdisi Seçenekleri"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Bilgi",
    "expressionsTab": "İfadeler",
    "optionsTab": "Seçenekler",
    "autoApplyWhenWidgetOpen": "Araç açıldığında bu filtreyi uygula",
    "expandFiltersOnLoad": "Yüklenen araçtaki filtreleri genişlet"
  },
