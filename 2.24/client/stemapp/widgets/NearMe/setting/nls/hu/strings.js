...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Tipp: A közelség alapú kereséshez konfigurált polygonréteg szimbóluma.",
    ...
    "addressLocationPolylineHintText": "Tipp: A közelség alapú kereséshez konfigurált vonallánc szimbóluma.",
    "fontColorLabel": "Betűszín kiválasztása a keresési eredményekhez",
    "fontColorHintText": "Tipp: A keresési eredmények betűszíne",
    "highlightColorLabel": "Kijelölési szín beállítása",
    "highlightColorHintText": "Tipp: Kijelölési szín",
    ...
    "showImageGalleryLabel": "Képgaléria megjelenítése",
    "showImageGalleryHint": "Tipp: A képgaléria a widget paneljén jelenik meg, ha a négyzet be van jelölve – ha nincs, a galéria rejtve marad",
    "showResultCountOfLayerLabel": "Keresési eredmények számának megjelenítése mindegyik rétegnél",
    "showAllLayers": "Az összes konfigurált réteg eredményeinek megjelenítése a láthatósági státuszuktól függetlenül.",
    "showAllLayersHint": "Tipp: Ez az opció lehetővé teszi az összes konfigurált réteg láthatóságát és a keresési eredmények visszaadását, ha azok ki vannak kapcsolva a webes térképen vagy futás közben a Layer List widget használatával.",
    "showResultCountOfLayerHint": "Tipp: A keresési eredmények számát az egyes rétegnevek után jelenítse meg",
    "editDescription": "Bevezető szöveg",
    "editDescriptionTip": "A widgetben megjelenített szöveg, a keresőmező felett.",
    "noResultsFound": "Szöveg arra az esetre, ha nincs találat",
    "noResultFoundHint": "Tipp: Állítsa be azt a szöveget, amely akkor jelenjen meg a keresési területen, ha eredménytelen a keresés",
    "noFeatureFoundText": "Nincs találat ",
    "searchHeaderText": "Cím keresése vagy megadása a térképen",
    "setCurrentLocationLabel": "Aktuális hely megjelenítésére szolgáló gomb beállítása",
    "setCurrentLocationHintText": "Tipp: Gondoskodjon olyan gombról, amely a felhasználó aktuális tartózkodási helyét használja",
    "bufferDistanceSliderLabel": "Buffertávolság csúszkája",
    "bufferDistanceTextboxLabel": "Buffer szöveges mezője",
    "bufferDistanceSliderandTextboxLabel": "Buffertávolság csúszkája és szöveges mezője",
    "bufferItemOptionLegend": "Buffer bemeneti opciói"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "expandFiltersOnLoad": "Szűrők kibontása a widget betöltésekor"
  },
