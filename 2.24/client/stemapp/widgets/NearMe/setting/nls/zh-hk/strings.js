...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "提示: 配置在鄰域搜索中使用的多邊形圖層的符號。",
    "popupTitleForPolygon": "為選擇的地址位置選擇多邊形",
    "popupTitleForPolyline": "為地址位置選擇線條",
    "addressLocationPolylineHintText": "提示: 配置在鄰域搜索中使用的折線圖層的符號。",
    "fontColorLabel": "選擇搜尋結果的字型顏色",
    "fontColorHintText": "提示: 搜尋結果的字型顏色",
    "highlightColorLabel": "設定選擇顏色",
    "highlightColorHintText": "提示: 選項顏色",
    ...
    "showImageGalleryLabel": "顯示圖片圖庫",
    "showImageGalleryHint": "提示: 若勾選核取方塊，則在 widget 面板中顯示圖片圖庫，否則將隱藏圖片圖庫",
    "showResultCountOfLayerLabel": "顯示每個圖層的搜尋結果計數",
    "showAllLayers": "顯示所有配置圖層的結果，無論其可見性狀態為何",
    "showAllLayersHint": "提示: 此選項將啟用所有配置圖層的可見性，並且在 Web 地圖中關閉圖層或在執行階段使用圖層清單 Widget 時，傳回搜尋結果。",
    "showResultCountOfLayerHint": "提示: 在每個圖層名稱後面顯示搜尋結果數目",
    "editDescription": "簡介文字",
    "editDescriptionTip": "搜尋方塊上方的 widget 中所顯示的文字。",
    "noResultsFound": "找不到任何結果時所出現的訊息",
    "noResultFoundHint": "提示: 設定在搜尋區域中找不到任何結果時所顯示的訊息",
    "noFeatureFoundText": "找不到任何結果 ",
    "searchHeaderText": "搜尋地圖上的地址或位置",
    "setCurrentLocationLabel": "設定目前位置按鈕",
    "setCurrentLocationHintText": "提示: 提供按鈕以使用使用者的目前位置",
    "bufferDistanceSliderLabel": "緩衝區距離滑桿",
    "bufferDistanceTextboxLabel": "緩衝區文字方塊",
    "bufferDistanceSliderandTextboxLabel": "緩衝區距離滑桿和文字方塊",
    "bufferItemOptionLegend": "緩衝區輸入選項"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "expandFiltersOnLoad": "載入 widget 時展開篩選器"
  },
