...
define({
  ...
  "searchSetting": {
    ...
    "showAllLayers": "Näytä kaikkien määritettyjen karttatasojen tulokset niiden näkyvyystilasta huolimatta",
    "showAllLayersHint": "Vinkki: tällä asetuksella otetaan käyttöön kaikkien määritettyjen karttatasojen näkyvyys ja palautetaan hakutulokset, kun ne ovat pois käytöstä web-kartassa, tai käytön aikana karttatasoluettelon pienoisohjelmaa käyttämällä.",
