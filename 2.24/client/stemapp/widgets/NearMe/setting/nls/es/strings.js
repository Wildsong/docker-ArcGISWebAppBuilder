...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Sugerencia: símbolo de capa de polígonos configurada para su uso en la búsqueda de proximidad.",
    ...
    "addressLocationPolylineHintText": "Sugerencia: símbolo de capa de polilíneas configurada para su uso en la búsqueda de proximidad.",
    ...
    "highlightColorLabel": "Definir color de selección",
    "highlightColorHintText": "Sugerencia: color de selección",
    ...
    "showImageGalleryLabel": "Mostrar galería de imágenes",
    "showImageGalleryHint": "Sugerencia: Mostrar la galería de imágenes en el panel del widget si la casilla de verificación está activada; de lo contrario, se oculta",
    "showResultCountOfLayerLabel": "Mostrar recuento de resultados de búsqueda para cada capa",
    "showAllLayers": "Mostrar resultados para todas las capas configuradas con independencia de su estado de visibilidad",
    "showAllLayersHint": "Sugerencia: esta opción habilitará la visibilidad de todas las capas configuradas y devolverá resultados de búsqueda cuando estén desactivadas en el mapa web o durante el tiempo de ejecución usando el widget Lista de capas.",
    "showResultCountOfLayerHint": "Sugerencia: Muestre el número de resultados de búsqueda después del nombre de cada capa",
    "editDescription": "Texto introductorio",
    "editDescriptionTip": "Texto que aparece en el widget sobre el cuadro de búsqueda.",
    "noResultsFound": "Mensaje cuando no se encuentra ningún resultado",
    "noResultFoundHint": "Sugerencia: Configure el mensaje que se mostrará si no se encuentra ningún resultado dentro del área de búsqueda",
    "noFeatureFoundText": "No se ha encontrado ningún resultado ",
    "searchHeaderText": "Buscar una dirección o localizar en el mapa",
    "setCurrentLocationLabel": "Configurar botón de ubicación actual",
    "setCurrentLocationHintText": "Sugerencia: Proporcione un botón para usar la ubicación actual del usuario",
    "bufferDistanceSliderLabel": "Control deslizante de distancia de zona de influencia",
    "bufferDistanceTextboxLabel": "Cuadro de texto de zona de influencia",
    "bufferDistanceSliderandTextboxLabel": "Control deslizante de distancia y cuadro de texto de zona de influencia",
    "bufferItemOptionLegend": "Opciones de entrada de zona de influencia"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Información",
    "expressionsTab": "Expresiones",
    "optionsTab": "Opciones",
    "autoApplyWhenWidgetOpen": "Aplicar este filtro al abrir el widget",
    "expandFiltersOnLoad": "Expandir filtros en la carga de widget"
  },
