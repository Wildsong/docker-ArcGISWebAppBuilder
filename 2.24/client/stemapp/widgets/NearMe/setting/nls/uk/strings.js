...
define({
  ...
  "searchSetting": {
    ...
    "showAllLayers": "Показати результати для всіх налаштованих шарів незалежно від їх стану видимості",
    "showAllLayersHint": "Підказка: Ця опція активує видимість усіх налаштованих шарів та повертає результати пошуку, якщо вони вимкнені у веб-карті або під час роботи з використанням віджета «Список шарів».",
