...
define({
  ...
  "searchSetting": {
    ...
    "showAllLayers": "Mostrar resultados para todas as camadas configuradas, independentemente do estado de visibilidade",
    "showAllLayersHint": "Dica: esta opção irá ativar a visibilidade de todas as camadas configuradas e devolver os resultados de pesquisa quando estiverem desativadas no mapa web ou durante o tempo de execução ao usar o widget Lista de Camadas.",
  ...
  "routeSetting": {
    ...
    "buttonSet": "Definir",
    "routeServiceUrlHintText": "Sugestão: Clique 'Definir' para navegar e seleccionar um serviço de roteamento",
