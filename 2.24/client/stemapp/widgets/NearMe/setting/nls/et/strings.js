...
define({
  ...
  "searchSetting": {
    ...
    "showAllLayers": "Kuva tulemid kõigi konfigureeritud kihtide kohta olenemata nende nähtavuse olekust",
    "showAllLayersHint": "Vihje: see suvand lülitab sisse kõigi konfigureeritud kihtide nähtavuse ja tagastab otsingutulemid, kui need on veebikaardil või käitusaja jooksul kihiloendi vidina abil välja lülitatud.",
