...
define({
  root: ({
    ...
    searchSetting: {
      ...
      addressLocationPolygonHintText: "Hint: Symbol for polygon layer configured to use in proximity search.", // shown as a label in config UI for polygon layer
      ...
      addressLocationPolylineHintText: "Hint: Symbol for polyline layer configured to use in proximity search.", // shown as a label in cofig UI for polyline
      ...
      highlightColorLabel: "Set selection color", //Show as label in config UI to set the selected highlight color in widget panel.
      highlightColorHintText: "Hint: Selection color", //Show as label in config UI to set the selected highlight color in widget panel.
      ...
      showImageGalleryLabel: "Show image gallery", // Shown as a label in config UI of image gallery checkbox
      showImageGalleryHint: "Hint: Show image gallery in widget panel if checkbox is checked else it will hide", // Shown as hint in config UI of image gallery
      showResultCountOfLayerLabel: "Show count of search results for each layer", // Shown as a label in config UI of result count layer checkbox
      showAllLayers: "Show results for all configured layers regardless of their visibility status", 
      showAllLayersHint: "Hint: This option will enable the visibility of all configured layers and return search results when they are turned off in the web map or during runtime using Layer List widget.",
      showResultCountOfLayerHint: "Hint: Display the number of search results after each layer name", // Shown as a hint in config UI of result count of layer
      editDescription: "Introductory text", // Shown as a label in config UI for edit panel
      editDescriptionTip: "Text displayed in the widget above the search box.",
      noResultsFound :"Message when no results are found", // Shown as a label in config UI for no result found
      noResultFoundHint: "Hint: Set the message to display when no results are found within the search area", // Shown as a hint in config UI for no result found
      noFeatureFoundText: "No results found ", // Shown as message if no features available in current buffer area
      searchHeaderText: "Search for an address or locate on map", // Shown as a label in config panel for search an address.
      setCurrentLocationLabel: "Set current location button", // Shown as lable in config UI
      setCurrentLocationHintText: "Hint: Provide a button to use user's current location", // Shown as a hint text in config UI
      bufferDistanceSliderLabel: "Buffer Distance Slider", // Shown as a label in config UI
      bufferDistanceTextboxLabel: "Buffer Text Box", // Shown as a label in config UI
      bufferDistanceSliderandTextboxLabel: "Buffer Distance Slider and Text Box", // Shown as a label in config UI
      bufferItemOptionLegend: "Buffer Input Options" // Shown as a legend in configuration
    ...
    filterSetting: {
      ...
      infoTab: "Info", // shown as a label in config UI for info tab
      expressionsTab: "Expressions", // shown as a label in config UI for expressions tab
      optionsTab: "Options", // shown as a label in config UI for options tab
      autoApplyWhenWidgetOpen: "Apply this filter when the widget is opened", // Shown as label in options tab for checkbox when the widget is opened
      expandFiltersOnLoad: "Expand filters on widget load" // Shown as label in options tab for checkbox to expand filters on widget load
      },
