...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "เคล็ดลับ: สัญลักษณ์สำหรับชั้นข้อมูลโพลีกอน ที่กำหนดค่าให้ใช้ในการค้นหาบริเวณใกล้เคียง",
    "popupTitleForPolygon": "เลือกพื้นที่สำหรับเลือกตำแหน่งที่อยู่",
    "popupTitleForPolyline": "เลือกเส้นสำหรับตำแหน่งที่อยู่",
    "addressLocationPolylineHintText": "เคล็ดลับ: สัญลักษณ์สำหรับชั้นข้อมูลโพลีไลน์ ที่กำหนดค่าให้ใช้ในการค้นหาบริเวณใกล้เคียง",
    "fontColorLabel": "เลือกสีข้อความสำหรับผลลัพท์การค้นหา",
    "fontColorHintText": "คำแนะนำ : สีข้อความของผลลัพท์การค้นหา",
    "highlightColorLabel": "ตั้งค่าสีการเลือก",
    "highlightColorHintText": "เคล็ดลับ: สีการเลือก",
    ...
    "showImageGalleryLabel": "แสดงแกลเลอรีภาพ",
    "showImageGalleryHint": "เคล็ดลับ: แสดงแกลเลอรีรูปภาพในหน้าต่างวิดเจ็ต หากทำเครื่องหมายถูกในช่อง หากไม่ จะถูกซ่อนไว้",
    "showResultCountOfLayerLabel": "แสดงจำนวนผลการค้นหาสำหรับแต่ละชั้นข้อมูล",
    "showAllLayers": "แสดงผลสำหรับชั้นข้อมูลที่กำหนดค่าทั้งหมดโดยไม่คำนึงถึงสถานะการมองเห็น",
    "showAllLayersHint": "เคล็ดลับ: ตัวเลือกนี้จะเปิดใช้งานการมองเห็นของชั้นข้อมูลที่กำหนดค่าทั้งหมดและส่งคืนผลการค้นหา เมื่อปิดในแผนที่เว็บหรือระหว่างรันไทม์โดยใช้วิดเจ็ตรายการชั้นข้อมูล",
    "showResultCountOfLayerHint": "เคล็ดลับ: แสดงจำนวนผลการค้นหาไว้ถัดจากแต่ละชื่อชั้นข้อมูล",
    "editDescription": "ข้อความแนะนำ",
    "editDescriptionTip": "ข้อความที่ปรากฏในวิดเจ็ตด้านบนของช่องค้นหา",
    "noResultsFound": "ข้อความเมื่อไม่พบผลลัพธ์",
    "noResultFoundHint": "เคล็ดลับ: ตั้งค่าข้อความให้ปรากฏขึ้นเมื่อไม่พบผลลัพธ์ภายในพื้นที่ค้นหา",
    "noFeatureFoundText": "ไม่พบผลลัพธ์ ",
    "searchHeaderText": "ค้นหาที่อยู่หรือค้นหาบนแผนที่",
    "setCurrentLocationLabel": "ตั้งค่าปุ่มตำแหน่งปัจจุบัน",
    "setCurrentLocationHintText": "เคล็ดลับ: แสดงปุ่มสำหรับใช้ตำแหน่งปัจจุบันของผู้ใช้",
    "bufferDistanceSliderLabel": "ตัวเลื่อนระยะทางบัฟเฟอร์",
    "bufferDistanceTextboxLabel": "กล่องข้อความบัฟเฟอร์",
    "bufferDistanceSliderandTextboxLabel": "ตัวเลื่อนและกล่องข้อความระยะทางบัฟเฟอร์",
    "bufferItemOptionLegend": "ตัวเลือกอินพุทบัฟเฟอร์"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "ข้อมูล",
    "expressionsTab": "ข้อความสูตร",
    "optionsTab": "ตัวเลือก",
    "autoApplyWhenWidgetOpen": "ใช้ตัวกรองนี้เมื่อเปิดวิดเจ็ต",
    "expandFiltersOnLoad": "ขยายตัวกรองในการโหลดวิดเจ็ต"
  },
