...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Подсказка: Символ для полигонального слоя настроен для использования поиска в ближайшей окрестности.",
    ...
    "addressLocationPolylineHintText": "Подсказка: Символ для полилинейного слоя настроен для использования поиска в ближайшей окрестности.",
    "fontColorLabel": "Выбрать цвет шрифта для результатов поиска",
    "fontColorHintText": "Подсказка: Цвет шрифта результатов поиска",
    "highlightColorLabel": "Задать цвет выборки",
    "highlightColorHintText": "Подсказка: цвет выборки",
    ...
    "showImageGalleryLabel": "Показать галерею изображений",
    "showImageGalleryHint": "Подсказка: галерея изображений на панели виджетов отображается, если установлен флажок, иначе она будет скрыта",
    "showResultCountOfLayerLabel": "Показать количество результатов поиска для каждого слоя",
    "showAllLayers": "Показать результаты для всех настроенных слоев независимо от их статуса видимости",
    "showAllLayersHint": "Подсказка: Эта опция включает видимость всех настроенных слоев и возвращает результаты поиска, когда они отключены на веб-карте или во время запуска с помощью виджета Список слоев.",
    "showResultCountOfLayerHint": "Подсказка: отображение количества результатов поиска после каждого имени слоя",
    "editDescription": "Вводный текст",
    "editDescriptionTip": "Текст отображается в виджете над окном поиска.",
    "noResultsFound": "Сообщение, когда ничего не найдено",
    "noResultFoundHint": "Подсказка: настроить отображение сообщения, если в области поиска не найдено результатов.",
    "noFeatureFoundText": "Результаты не найдены ",
    "searchHeaderText": "Поиск адресов или мест на карте",
    "setCurrentLocationLabel": "Кнопка установки текущего местоположения",
    "setCurrentLocationHintText": "Подсказка: добавьте кнопку для использования текущего местоположения пользователя",
    "bufferDistanceSliderLabel": "Бегунок буферного расстояния",
    "bufferDistanceTextboxLabel": "Поле текста буфера",
    "bufferDistanceSliderandTextboxLabel": "Бегунок буферного расстояния и текста",
    "bufferItemOptionLegend": "Входные опции буфера"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Сообщение",
    "expressionsTab": "Выражение",
    "optionsTab": "Опции",
    "autoApplyWhenWidgetOpen": "Применить этот фильтр, когда виджет открыт",
    "expandFiltersOnLoad": "Развернуть фильтры при загрузке виджета"
  },
