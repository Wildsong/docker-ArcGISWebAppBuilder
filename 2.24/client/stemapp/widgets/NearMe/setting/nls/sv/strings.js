...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Tips: Symbol för polygonlager som konfigurerats för användning vid sökning i närheten.",
    "popupTitleForPolygon": "Välj polygon för vald adress",
    "popupTitleForPolyline": "Välj linje för vald adress",
    "addressLocationPolylineHintText": "Tips: Symbol för polylinjelager som konfigurerats för användning vid sökning i närheten.",
    "fontColorLabel": "Välj teckensnittsfärg i sökresultaten",
    "fontColorHintText": "Tips: Teckensnittsfärg i sökresultaten",
    "highlightColorLabel": "Ange urvalsfärg",
    "highlightColorHintText": "Tips: Markeringsfärg",
    ...
    "showImageGalleryLabel": "Visa bildgalleri",
    "showImageGalleryHint": "Tips! Bildgalleriet visas i widgetpanelen om kryssrutan är markerad, annars döljs det",
    "showResultCountOfLayerLabel": "Visa antal sökresultat för varje lager",
    "showAllLayers": "Visa resultat för alla konfigurerade lager oavsett deras synlighetsstatus",
    "showAllLayersHint": "Tips: Det här alternativet aktiverar synlighet för alla konfigurerade lager och returnerar sökresultat när de inaktiveras i webbkartan eller under körtid med lagerlistewidgeten.",
    "showResultCountOfLayerHint": "Tips! visa antalet sökresultat efter varje lagernamn",
    "editDescription": "Inledande text",
    "editDescriptionTip": "Texten visas i widgeten ovanför sökrutan.",
    "noResultsFound": "Meddelande när inga resultat hittas",
    "noResultFoundHint": "Tips! Ställ in meddelandet så att det visar när inga resultat hittas inom sökområdet",
    "noFeatureFoundText": "Inga resultat hittades ",
    "searchHeaderText": "Sök efter en adress eller leta upp en plats på kartan",
    "setCurrentLocationLabel": "Ange aktuell plats-knapp",
    "setCurrentLocationHintText": "Tips! Ange en knapp för att använda användarens aktuella plats",
    "bufferDistanceSliderLabel": "Skjutreglage för buffertavstånd",
    "bufferDistanceTextboxLabel": "Buffertetxtruta",
    "bufferDistanceSliderandTextboxLabel": "Skjutreglage för buffertavstånd och textruta",
    "bufferItemOptionLegend": "Alternativ för buffertindata"
  },
  "layerSelector": {
