...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Namig: simbol za poligonski sloj, konfiguriran za uporabo pri približevalnem iskanju",
    ...
    "addressLocationPolylineHintText": "Namig: simbol za polilinijski sloj, konfiguriran za uporabo pri približevalnem iskanju",
    "fontColorLabel": "Izberite barvo pisave za rezultate iskanja",
    "fontColorHintText": "Namig: Barva pisave rezultatov iskanja",
    "highlightColorLabel": "Nastavite barvo izbire",
    "highlightColorHintText": "Namig: barva izbire",
    ...
    "showImageGalleryLabel": "Prikaži galerijo slik",
    "showImageGalleryHint": "Namig: prikaži galerijo slik na plošči s pripomočki v primeru označenega izbirnega polja, v nasprotnem primeru bo skrita",
    "showResultCountOfLayerLabel": "Prikaži število rezultatov iskanja za vsak sloj",
    "showAllLayers": "Prikaži rezultate za vse konfigurirane sloje, ne glede na njihovo stanje vidnosti",
    "showAllLayersHint": "Namig: ta možnost bo omogočila vidnost vseh konfiguriranih slojev in vrnitev rezultatov iskanja, ko so izklopljeni v spletni karti ali med izvajanjem s pomočjo pripomočka Seznam slojev.",
    "showResultCountOfLayerHint": "Namig: prikaži število rezultatov iskanja za vsako ime sloja",
    "editDescription": "Uvodno besedilo",
    "editDescriptionTip": "Besedilo, prikazano v pripomočku nad poljem iskanja",
    "noResultsFound": "Sporočilo, ko ni najden noben rezultat",
    "noResultFoundHint": "Namig: nastavite sporočilo, ki se bo prikazalo, ko v območju iskanja ni najden noben rezultat.",
    "noFeatureFoundText": "Ni najdenih rezultatov ",
    "searchHeaderText": "Išči naslov ali lociraj na karti",
    "setCurrentLocationLabel": "Nastavi gumb trenutne lokacije",
    "setCurrentLocationHintText": "Namig: zagotovite gumb za uporabo uporabnikove trenutne lokacije",
    "bufferDistanceSliderLabel": "Drsnik razdalje medpomnilnika",
    "bufferDistanceTextboxLabel": "Polje z besedilom medpomnilnika",
    "bufferDistanceSliderandTextboxLabel": "Drsnik razdalje in polje besedila medpomnilnika",
    "bufferItemOptionLegend": "Možnosti vnosa medpomnilnika"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "expandFiltersOnLoad": "Razširite filtre na nalaganju pripomočkov"
  },
