...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Savjet: simbol za poligonalni sloj konfiguriran je za upotrebu u pretraživanju prema blizini.",
    ...
    "addressLocationPolylineHintText": "Savjet: simbol za polilinijski sloj konfiguriran je za upotrebu u pretraživanju prema blizini.",
    ...
    "highlightColorLabel": "Postavi boju odabira",
    "highlightColorHintText": "Savjet: boja odabira",
    ...
    "showImageGalleryLabel": "Prikaži galeriju slika",
    "showImageGalleryHint": "Savjet: galerija slika prikazuje se u ploči widgeta ako je potvrdni okvir označen, a inače će se sakriti",
    "showResultCountOfLayerLabel": "Prikaži broj rezultata pretraživanja za svaki sloj",
    "showAllLayers": "Prikaži rezultate za sve konfigurirane slojeve bez obzira na njihov status vidljivosti",
    "showAllLayersHint": "Savjet: Ova opcija će omogućiti vidljivost svih konfiguriranih slojeva i vratiti rezultate pretraživanja kada su isključeni na web karti ili tijekom rada pomoću widgeta Popis slojeva.",
    "showResultCountOfLayerHint": "Savjet: prikažite broj rezultata pretraživanja nakon svakog naziva sloja",
    "editDescription": "Uvodni tekst",
    "editDescriptionTip": "Tekst prikazan u widgetu iznad okvira za pretraživanje.",
    "noResultsFound": "Poruka kada nema rezultata",
    "noResultFoundHint": "Savjet: postavite poruku za prikaz kada nema rezultata u području pretraživanja",
    "noFeatureFoundText": "Nema rezultata ",
    "searchHeaderText": "Pretraži adresu ili pronađi na karti",
    "setCurrentLocationLabel": "Postavi gumb trenutačne lokacije",
    "setCurrentLocationHintText": "Savjet: stavite gumb za upotrebu trenutačne lokacije korisnika",
    "bufferDistanceSliderLabel": "Klizač za udaljenost pojasa",
    "bufferDistanceTextboxLabel": "Tekstni okvir za pojas",
    "bufferDistanceSliderandTextboxLabel": "Klizač za udaljenost pojasa i tekstni okvir",
    "bufferItemOptionLegend": "Opcije unosa za pojas"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "expandFiltersOnLoad": "Proširi filtre prilikom učitavanja widgeta"
  },
