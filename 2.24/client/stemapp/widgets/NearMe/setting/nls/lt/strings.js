...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Pastaba: poligonų sluoksnio simbolis sukonfigūruotas naudojimui artumo paieškoje.",
    ...
    "addressLocationPolylineHintText": "Pastaba: polilinijos sluoksnio simbolis sukonfigūruotas naudojimui artumo paieškoje.",
    "fontColorLabel": "Pasirinkti paieškos rezultatų šrifto spalvą",
    "fontColorHintText": "Patarimas: paieškos rezultatų šrifto spalva",
    "highlightColorLabel": "Nustatyti žymėjimo spalvą",
    "highlightColorHintText": "Pastaba: žymėjimo spalva",
    ...
    "showImageGalleryLabel": "Rodyti vaizdų galeriją",
    "showImageGalleryHint": "Patarimas: jei pažymėtas žymės langelis, rodoma vaizdų galerija, kitu atveju ji bus paslėpta",
    "showResultCountOfLayerLabel": "Rodyti kiekvieno sluoksnio paieškos rezultatų skaičių",
    "showAllLayers": "Rodyti visų sukonfigūruotų sluoksnių rezultatus nepriklausomai nuo jų matomumo būsenos",
    "showAllLayersHint": "Patarimas: ši parinktis įjungs visų sukonfigūruotų sluoksnių matomumą ir pateiks paieškos rezultatus tada, kai jie išjungti internetiniame žemėlapyje arba vykdymo metu, naudojant sluoksnių sąrašo valdiklį.",
    "showResultCountOfLayerHint": "Pastaba: po kiekvieno sluoksnio pavadinimo rodomas paieškos rezultatų skaičius",
    "editDescription": "Įžanginis tekstas",
    "editDescriptionTip": "Tekstas rodomas valdiklyje virš paieškos lauko.",
    "noResultsFound": "Pranešimas, kai rezultatų nerandama",
    "noResultFoundHint": "Pastaba: nustatykite pranešimą, kuris bus rodomas, kai paieškos teritorijoje nebus rasta rezultatų",
    "noFeatureFoundText": "Nieko nerasta ",
    "searchHeaderText": "Ieškoti adreso arba rasti žemėlapyje",
    "setCurrentLocationLabel": "Dabartinės vietos nustatymo mygtukas",
    "setCurrentLocationHintText": "Pastaba: pateikiamas mygtukas, kad būtų galima naudoti dabartinę naudotojo vietą",
    "bufferDistanceSliderLabel": "Buferio atstumo slankiklis",
    "bufferDistanceTextboxLabel": "Buferio teksto laukas",
    "bufferDistanceSliderandTextboxLabel": "Buferio atstumo slankiklis ir teksto laukas",
    "bufferItemOptionLegend": "Buferio įvesties parinktys"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Informacija",
    "expressionsTab": "Išraiškos",
    "optionsTab": "Parinktys",
    "autoApplyWhenWidgetOpen": "Taikyti šį filtrą, kai valdiklis atidarytas",
    "expandFiltersOnLoad": "Išplėsti filtrus valdiklio įkeltyje"
  },
