...
define({
  ...
  "searchSetting": {
    ...
    "showAllLayers": "הצג תוצאות עבור כל השכבות שהוגדרו, ללא תלות בסטטוס הנראות שלכם",
    "showAllLayersHint": "עצה: אפשרות זו תפעיל את הנראות של כל השכבות שהוגדרו ותחזיר תוצאות כאשר הן כבויות במפת האינטרנט או במהלך זמן ריצה תוך שימוש בווידג'ט 'רשימת שכבות'.",
