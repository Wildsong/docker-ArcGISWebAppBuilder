...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "تلميح: رمز طبقة المضلع المكونة للاستخدام في بحث التقريب.",
    "popupTitleForPolygon": "حدد المضلع لموقع العنوان المحدد",
    "popupTitleForPolyline": "حدد خطًا لموقع العنوان",
    "addressLocationPolylineHintText": "تلميح: رمز طبقة الخط المتصل المكونة للاستخدام في بحث التقريب.",
    "fontColorLabel": "حدد لون خط نتائج البحث",
    "fontColorHintText": "تلميح: لون خط نتائج البحث",
    "highlightColorLabel": "تعيين لون التحديد",
    "highlightColorHintText": "تلميح: لون التحديد",
    ...
    "showImageGalleryLabel": "عرض معرض الصور",
    "showImageGalleryHint": "تلميح: أظهر معرض الصور في لوحة عنصر واجهة المستخدم بتأشير خانة الاختيار وإلا سوف تختفي",
    "showResultCountOfLayerLabel": "إظهار عدد نتائج البحث لكل طبقة",
    "showAllLayers": "إظهار النتائج لجميع الطبقات المكونة بغض النظر عن حالة رؤيتها",
    "showAllLayersHint": "تلميح: سيمكن هذا الخيار رؤية جميع الطبقات التي تم تكوينها ويعيد نتائج البحث عند إيقاف تشغيلها في خريطة الويب أو أثناء وقت التشغيل باستخدام عنصر واجهة المستخدم قائمة الطبقات.",
    "showResultCountOfLayerHint": "تلميح: عرض عدد نتائج البحث بعد كل اسم طبقة",
    "editDescription": "النص التمهيدي",
    "editDescriptionTip": "يتم عرض النص في عنصر واجهة المستخدم فوق مربع البحث.",
    "noResultsFound": "رسالة عند عدم العثور على نتائج",
    "noResultFoundHint": "تلميح: عين الرسالة التي تظهر عند عدم العثور على نتائج ضمن منطقة البحث",
    "noFeatureFoundText": "لم يتم العثور على أية نتائج ",
    "searchHeaderText": "بحث عن عنوان أو تحديد موقعه على الخريطة",
    "setCurrentLocationLabel": "تعيين زر الموقع الحالي",
    "setCurrentLocationHintText": "تلميح: ضع زرًا لاستخدام الموقع الحالي للمستخدم",
    "bufferDistanceSliderLabel": "شريط تمرير مسافة النطاق",
    "bufferDistanceTextboxLabel": "مربع نص نطاق",
    "bufferDistanceSliderandTextboxLabel": "شريط تمرير مسافة النطاق ومربع النص",
    "bufferItemOptionLegend": "خيارات إدخال النطاق"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "معلومات",
    "expressionsTab": "التعبيرات",
    "optionsTab": "خيارات",
    "autoApplyWhenWidgetOpen": "تطبيق عامل التصفية عند فتح عنصر واجهة المستخدم",
    "expandFiltersOnLoad": "توسعة عوامل التصفية عند تحميل عنصر واجهة المستخدم"
  },
