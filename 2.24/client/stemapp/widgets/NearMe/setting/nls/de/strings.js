...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Hinweis: Symbol für Polygon-Layer wurde für die Verwendung in der Umkreissuche konfiguriert.",
    ...
    "addressLocationPolylineHintText": "Hinweis: Symbol für Polylinien-Layer wurde für die Verwendung in der Umkreissuche konfiguriert.",
    "fontColorLabel": "Schriftfarbe für Suchergebnisse auswählen",
    "fontColorHintText": "Hinweis: Schriftfarbe für Suchergebnisse",
    "highlightColorLabel": "Auswahlfarbe festlegen",
    "highlightColorHintText": "Hinweis: Auswahlfarbe",
    ...
    "showImageGalleryLabel": "Bildergalerie anzeigen",
    "showImageGalleryHint": "Hinweis: Die Bildergalerie wird im Widget-Fenster angezeigt, wenn das Kontrollkästchen aktiviert ist, andernfalls wird sie ausgeblendet.",
    "showResultCountOfLayerLabel": "Anzahl an Suchergebnissen für jeden Layer anzeigen",
    "showAllLayers": "Ergebnisse für alle konfigurierten Layer unabhängig vom jeweiligen Sichtbarkeitsstatus anzeigen",
    "showAllLayersHint": "Hinweis: Mit dieser Option wird die Sichtbarkeit für alle konfigurierten Layer aktiviert, und es werden Suchergebnisse zurückgegeben, wenn diese in der Webkarte deaktiviert werden bzw. wenn während der Laufzeit das Widget \"Layer-Liste\" verwendet wird.",
    "showResultCountOfLayerHint": "Hinweis: Die Anzahl an Suchergebnissen wird nach dem Namen der einzelnen Layer angezeigt.",
    "editDescription": "Einführungstext",
    "editDescriptionTip": "Text, der im Widget oberhalb des Suchfeldes angezeigt wird.",
    "noResultsFound": "Meldung, wenn keine Ergebnisse gefunden werden",
    "noResultFoundHint": "Hinweis: Legen Sie die Meldung fest, die angezeigt wird, wenn keine Ergebnisse im Suchbereich gefunden werden.",
    "noFeatureFoundText": "Keine Ergebnisse gefunden ",
    "searchHeaderText": "Eine Adresse suchen oder auf der Karte verorten",
    "setCurrentLocationLabel": "Schaltfläche für die aktuelle Position festlegen",
    "setCurrentLocationHintText": "Hinweis: Stellen Sie eine Schaltfläche bereit, mit der die aktuelle Position des Benutzers verwendet werden kann.",
    "bufferDistanceSliderLabel": "Pufferabstand-Schieberegler",
    "bufferDistanceTextboxLabel": "Puffer-Textfeld",
    "bufferDistanceSliderandTextboxLabel": "Pufferabstand-Schieberegler und Textfeld",
    "bufferItemOptionLegend": "Puffer-Eingabeoptionen"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Info",
    "expressionsTab": "Ausdrücke",
    "optionsTab": "Optionen",
    "autoApplyWhenWidgetOpen": "Diesen Filter bei geöffnetem Widget anwenden",
    "expandFiltersOnLoad": "Filter beim Laden des Widgets einblenden"
  },
