...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "힌트: 인접성 검색에 사용하도록 구성된 폴리곤 레이어의 심볼입니다.",
    "popupTitleForPolygon": "선택한 주소 위치에 대해 폴리곤을 선택합니다.",
    "popupTitleForPolyline": "주소 위치에 대해 라인을 선택합니다.",
    "addressLocationPolylineHintText": "힌트: 인접성 검색에 사용하도록 구성된 폴리라인 레이어의 심볼입니다.",
    "fontColorLabel": "검색 결과의 글꼴 색상 선택",
    "fontColorHintText": "힌트: 검색 결과의 글꼴 색상",
    "highlightColorLabel": "선택 색상 설정",
    "highlightColorHintText": "힌트: 선택 색상",
    ...
    "showImageGalleryLabel": "이미지 갤러리 표시",
    "showImageGalleryHint": "힌트: 체크 박스를 선택한 경우 위젯 패널에 이미지 갤러리를 표시하고 그렇지 않으면 숨깁니다.",
    "showResultCountOfLayerLabel": "각 레이어의 검색 결과 수 표시",
    "showAllLayers": "가시성 상태에 관계없이 구성된 모든 레이어에 대한 결과 표시",
    "showAllLayersHint": "힌트: 이 옵션은 구성된 모든 레이어의 가시성을 활성화하고 웹 맵에서 또는 레이어 목록 위젯을 사용하는 런타임 중에 꺼져 있을 때 검색 결과를 반환합니다.",
    "showResultCountOfLayerHint": "힌트: 각 레이어 이름 다음에 검색 결과 수를 표시합니다.",
    "editDescription": "소개 텍스트",
    "editDescriptionTip": "위젯의 검색 상자 위에 표시되는 텍스트입니다.",
    "noResultsFound": "결과를 찾을 수 없는 경우의 메시지",
    "noResultFoundHint": "힌트: 검색 영역 내에 결과가 없는 경우에 표시되는 메시지를 설정합니다.",
    "noFeatureFoundText": "결과를 찾을 수 없음 ",
    "searchHeaderText": "맵의 주소 또는 위치 검색",
    "setCurrentLocationLabel": "현재 위치 버튼 설정",
    "setCurrentLocationHintText": "힌트: 사용자의 현재 위치를 사용할 수 있는 버튼을 제공합니다.",
    "bufferDistanceSliderLabel": "버퍼 거리 슬라이더",
    "bufferDistanceTextboxLabel": "버퍼 텍스트 상자",
    "bufferDistanceSliderandTextboxLabel": "버퍼 거리 슬라이더 및 텍스트 상자",
    "bufferItemOptionLegend": "버퍼 입력 옵션"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "expandFiltersOnLoad": "위젯을 불러올 때 필터 확장"
  },
