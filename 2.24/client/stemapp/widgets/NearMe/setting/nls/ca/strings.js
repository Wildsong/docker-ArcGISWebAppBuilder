...
define({
  ...
  "searchSetting": {
    ...
    "showAllLayers": "Mostra els resultats de totes les capes configurades, independentment del seu estat de visibilitat",
    "showAllLayersHint": "Suggeriment: aquesta opció habilitarà la visibilitat de totes les capes configurades i retornarà resultats de la cerca si estan desactivades al mapa web o durant l'execució amb el widget Llista de capes.",
