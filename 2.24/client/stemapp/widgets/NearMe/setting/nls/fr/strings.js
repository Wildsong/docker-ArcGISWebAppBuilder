...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Astuce : symbole de la couche surfacique dont la configuration est adaptée aux recherches de proximité.",
    ...
    "addressLocationPolylineHintText": "Astuce : symbole de la couche de polylignes dont la configuration est adaptée aux recherches de proximité.",
    ...
    "highlightColorLabel": "Définir la couleur de sélection",
    "highlightColorHintText": "Astuce : couleur de sélection",
    ...
    "showImageGalleryLabel": "Afficher la bibliothèque d’images",
    "showImageGalleryHint": "Astuce : afficher la galerie d’images dans le volet du widget si la case est cochée. Sinon, elle est masquée.",
    "showResultCountOfLayerLabel": "Afficher le nombre de résultats de recherche pour chaque couche",
    "showAllLayers": "Afficher les résultats de toutes les couches configurées, quel que soit leur statut de visibilité",
    "showAllLayersHint": "Astuce : cette option active la visibilité de toutes les couches configurées et renvoie les résultats de recherche lorsqu’ils sont désactivés dans la carte Web ou lors de l’exécution à l’aide du widget Liste des couches.",
    "showResultCountOfLayerHint": "Astuce : affichez le nombre de résultats de recherche après chaque nom de couche",
    "editDescription": "Texte d’introduction",
    "editDescriptionTip": "Texte qui apparaît dans le widget au-dessus de la zone de recherche.",
    "noResultsFound": "Message lorsqu’aucun résultat n’est trouvé",
    "noResultFoundHint": "Astuce : déclenchez l’affichage du message lorsqu’aucun résultat n’est trouvé dans la zone de recherche",
    "noFeatureFoundText": "Aucun résultat trouvé ",
    "searchHeaderText": "Rechercher une adresse ou situer sur la carte",
    "setCurrentLocationLabel": "Bouton Définir l’emplacement actuel",
    "setCurrentLocationHintText": "Astuce : fournissez un bouton pour utiliser l’emplacement actuel de l’utilisateur",
    "bufferDistanceSliderLabel": "Curseur de distance de zone tampon",
    "bufferDistanceTextboxLabel": "Zone de texte de zone tampon",
    "bufferDistanceSliderandTextboxLabel": "Curseur de distance et zone de texte de zone tampon",
    "bufferItemOptionLegend": "Options d’entrée de zone tampon"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "expandFiltersOnLoad": "Développer les filtres au chargement du widget"
  },
