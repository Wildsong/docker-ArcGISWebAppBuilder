...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "Wskazówka: symbol warstwy poligonowej skonfigurowanej do korzystania z wyszukiwania w pobliżu.",
    ...
    "addressLocationPolylineHintText": "Wskazówka: symbol warstwy poliliniowej skonfigurowanej do korzystania z wyszukiwania w pobliżu.",
    ...
    "highlightColorLabel": "Skonfiguruj kolor wyboru",
    "highlightColorHintText": "Wskazówka: kolor selekcji",
    ...
    "showImageGalleryLabel": "Pokaż galerię obrazów",
    "showImageGalleryHint": "Wskazówka: pokaż galerię obrazów na panelu widżetu, jeśli pole wyboru jest zaznaczone. W przeciwnym razie będzie ona ukryta",
    "showResultCountOfLayerLabel": "Pokaż liczbę wyników wyszukiwania dla każdej warstwy",
    "showAllLayers": "Pokaż wyniki dla wszystkich skonfigurowanych warstw bez względu na ich status widoczności",
    "showAllLayersHint": "Wskazówka: Ta opcja włączy widoczność wszystkich skonfigurowanych warstw i zwróci wyniki wyszukiwania, gdy są one wyłączone na mapie internetowej lub w czasie wykonywania za pomocą widżetu Lista warstw.",
    "showResultCountOfLayerHint": "Wskazówka: Wyświetla liczbę wyników wyszukiwania za nazwą każdej warstwy",
    "editDescription": "Tekst wprowadzający",
    "editDescriptionTip": "Tekst wyświetlany na widżecie powyżej pola wyszukiwania.",
    "noResultsFound": "Komunikat, gdy nie znaleziono żadnych wyników",
    "noResultFoundHint": "Wskazówka: Konfiguruje komunikat wyświetlany w sytuacji, gdy w obszarze wyszukiwania nie znaleziono żadnych wyników",
    "noFeatureFoundText": "Nie znaleziono wyników ",
    "searchHeaderText": "Wyszukaj adres lub zlokalizuj na mapie",
    "setCurrentLocationLabel": "Ustaw przycisk bieżącej lokalizacji",
    "setCurrentLocationHintText": "Wskazówka: Udostępnia przycisk pozwalający użyć bieżącej lokalizacji użytkownika",
    "bufferDistanceSliderLabel": "Suwak odległości buforowania",
    "bufferDistanceTextboxLabel": "Pole tekstowe buforowania",
    "bufferDistanceSliderandTextboxLabel": "Pole tekstowe i suwak odległości buforowania",
    "bufferItemOptionLegend": "Opcje danych wejściowych buforowania"
  },
  "layerSelector": {
  ...
  "filterSetting": {
    ...
    "infoTab": "Informacje",
    "expressionsTab": "Wyrażenia",
    "optionsTab": "Opcje",
    "autoApplyWhenWidgetOpen": "Zastosuj ten filtr po otwarciu widżetu.",
    "expandFiltersOnLoad": "Rozwiń filtry podczas wczytywania widżetu"
  },
